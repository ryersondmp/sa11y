...
(function (global, factory) {
  ...
  var enUS = {
    ...
    strings: {
      ...
      SUS_ALT: 'Assistive technologies already indicate that this is an image, so &quot;<strong {R}>%(ERROR)</strong>&quot; may be redundant. <hr> {ALT} <strong {W}>%(ALT_TEXT)</strong>',
      ...
      LINK_IMAGE_ALT_AND_TEXT: 'Image link contains <strong>both alt text and surrounding link text.</strong> If this image is decorative and is being used as a functional link to another page, consider marking the image as decorative. The surrounding link text should suffice. <hr> {ALT} %(ALT_TEXT) <hr> <strong {B}>Label</strong> {L} <strong {W}>%(TEXT)</strong>',
