...
var da = {
  ...
  strings: {
    ...
    ACC_NAME: '<strong {B}>Link-etiket</strong> %(TEXT)',
    ...
    BTN_EMPTY: 'Knappen mangler et tilgængeligt navn, der beskriver dens formål. Lær, hvordan man laver en <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">tilgængelig knap.</a>',
    BTN_EMPTY_LABELLEDBY: 'Knappen har en <code>aria-labelledby</code> værdi, der er tom eller ikke matcher <code>id</code> værdien for et andet element på siden.',
    ...
    PAGE_LANG: 'Sidens sprog er ikke angivet! Venligst <a href="https://www.w3.org/International/questions/qa-html-language-declarations">deklarer sprog på HTML-tag.</a>',
