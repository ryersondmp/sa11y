...
var sv = {
  ...
  strings: {
    ...
    ACC_NAME: '<strong {B}>Länketikett</strong> %(TEXT)',
    ...
    // Buttons
    BTN_EMPTY: 'Knappen saknar ett tillgängligt namn som beskriver dess syfte. Lär dig hur du skapar en <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">tillgänglig knapp.</a>',
    BTN_EMPTY_LABELLEDBY: 'Knappen har ett <code>aria-labelledby</code>-värde som är tomt eller inte matchar <code>id</code>-värdet för ett annat element på sidan.',
    ...
    PAGE_LANG: 'Sidspråk är inte inställt! Vänligen <a href="https://www.w3.org/International/questions/qa-html-language-declarations">ställ in språk på HTML-taggen.</a>',
