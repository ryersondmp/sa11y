...
var sv = {
  ...
  strings: {
    ...
    LINK_ALT_HAS_FILE_EXTENSION: 'Filändelse hittades i alt-texten. Se till att alt-texten beskriver destinationen för länken, inte en bokstavlig beskrivning av bilden. Ta bort: <strong {r}>%(error)</strong>.<hr><strong>Alt-text:</strong> %(altText)',
    ...
    ALT_HAS_FILE_EXTENSION: 'Filändelse hittades i alt-texten. Om bilden förmedlar en historia, stämning eller viktig information – se till att beskriva bilden. Ta bort: <strong {r}>%(error)</strong>.<hr><strong>Alt-text:</strong> %(altText)',
    ...
    LINK_IMAGE_ALT_AND_TEXT_WARNING: 'Bildlänken innehåller <strong>både alt-text och omgivande länktext.</strong> Om den här bilden är dekorativ och används som en funktionell länk till en annan sida, överväg att markera bilden som dekorativ eller null - den omgivande länktexten bör räcka. <hr> <strong>Alt-text:</strong> %(altText) <hr> <strong>Länketikett:</strong> %(sanitizedText)',
    ...
    LABELS_ARIA_LABEL_INPUT_MESSAGE: 'Inmatningsfältet har ett tillgängligt namn, men se till att det även finns en synlig etikett. <hr> <strong>Inmatningsetikett:</strong> %(sanitizedText)',
