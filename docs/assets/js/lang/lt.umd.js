...
(function (global, factory) {
  ...
  var lt = {
    ...
    strings: {
      ...
      ACC_NAME: '<strong {B}>Etiketė su nuoroda</strong> %(TEXT)',
      ...
      BTN_EMPTY: 'Mygtukas neturi prieinamo pavadinimo, kuris apibūdintų jo paskirtį. Sužinokite, kaip padaryti <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">prieinamą mygtuką.</a>',
      BTN_EMPTY_LABELLEDBY: 'Mygtukas turi <code>aria-labelledby</code> reikšmę, kuri yra tuščia arba nesutampa su kito puslapio elemento <code>id</code> reikšme.',
      ...
      PAGE_LANG: 'Puslapio kalba nedeklaruota! Prašome <a href="https://www.w3.org/International/questions/qa-html-language-declarations">deklaruoti kalbą HTML žymėje.</a>',
