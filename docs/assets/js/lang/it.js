...
var it = {
  ...
  strings: {
    ...
    ACC_NAME: '<strong {B}>Etichetta del link</strong> %(TEXT)',
    ...
    BTN_EMPTY: 'Il pulsante non ha un nome accessibile che descriva il suo scopo. Scopri come creare un <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">pulsante accessibile.</a>',
    BTN_EMPTY_LABELLEDBY: 'Il pulsante ha un valore <code>aria-labelledby</code> che è vuoto o non corrisponde al valore <code>id</code> di un altro elemento nella pagina.',
    ...
    PAGE_LANG: 'Lingua della pagina non dichiarata! Si prega di <a href="https://www.w3.org/International/questions/qa-html-language-declarations">dichiarare la lingua nel tag HTML.</a>',
