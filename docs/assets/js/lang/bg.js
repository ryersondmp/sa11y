...
var bg = {
  ...
  strings: {
    ...
    // Contrast
    CONTRAST_OPACITY: 'Увеличете непрозрачността на текста за по-добра видимост:',
    CONTRAST_APCA: 'Това не е достатъчен контраст за никакъв размер текст. Помислете за използване на тази комбинация от цвят и размер на текста?',
    CONTRAST_COLOR: 'Помислете за използване на този цвят вместо?',
    CONTRAST_SIZE: 'Помислете за увеличаване на размера на текста за тази цветова комбинация?',
    ...
    CONTRAST_WARNING: 'Контрастът на този текст е неизвестен и трябва да бъде проверен ръчно. Уверете се, че текстът и фонът имат силно контрастиращи цветове. Съотношението на контраста трябва да бъде поне 4,5:1 за нормален текст и 3:1 за голям текст. <hr> <strong {B}>Контрастно съотношение</strong> <strong {B}>Непознато</strong> <strong {C}>%(TEXT)</strong>',
