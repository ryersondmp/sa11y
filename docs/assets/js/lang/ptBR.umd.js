...
(function (global, factory) {
  ...
  var ptBR = {
    ...
    strings: {
      ...
      ACC_NAME: '<strong {B}>Rótulo</strong> %(TEXT)',
      ...
      BTN_EMPTY: 'O botão está sem um nome acessível que descreva seu propósito. Saiba como criar um <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">botão acessível.</a>',
      BTN_EMPTY_LABELLEDBY: 'O botão possui um valor <code>aria-labelledby</code> que está vazio ou não corresponde ao valor <code>id</code> de outro elemento na página.',
      ...
      PAGE_LANG: 'O idioma da página não foi declarado! Por favor, <a href="https://www.w3.org/International/questions/qa-html-language-declarations">declare o idioma na tag HTML.</a>',
