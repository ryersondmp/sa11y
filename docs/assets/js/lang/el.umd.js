...
(function (global, factory) {
  ...
  var el = {
    ...
    strings: {
      ...
      LINK_IMAGE_ALT_AND_TEXT: 'Ο σύνδεσμος εικόνας περιέχει <strong>τόσο το κείμενο alt όσο και το περιβάλλον κείμενο συνδέσμου.</strong> Εάν αυτή η εικόνα είναι διακοσμητική και χρησιμοποιείται ως λειτουργικός σύνδεσμος προς μια άλλη σελίδα, σκεφτείτε να χαρακτηρίσετε την εικόνα ως διακοσμητική ή μηδενική - το περιβάλλον κείμενο συνδέσμου θα πρέπει να αρκεί. <hr> {ALT} <strong {C}>%(ALT_TEXT)</strong> <hr> <strong {B}>Ετικέτα συνδέσμου</strong> {L} <strong {C}>%(TEXT)</strong>',
      ...
      LABELS_ARIA_LABEL_INPUT: 'Η είσοδος έχει ένα προσβάσιμο όνομα, αν και παρακαλούμε βεβαιωθείτε ότι υπάρχει και μια ορατή ετικέτα. <hr> <strong {B}>Ετικέτα εισόδου</strong> <strong {C}>%(TEXT)</strong>',
      ...
      QA_DUPLICATE_ID: 'Βρέθηκε <strong>διπλό αναγνωριστικό</strong>. Τα σφάλματα διπλού αναγνωριστικού είναι γνωστό ότι προκαλούν προβλήματα στις υποστηρικτικές τεχνολογίες όταν αυτές προσπαθούν να αλληλεπιδράσουν με το περιεχόμενο. <hr> Παρακαλούμε αφαιρέστε ή αλλάξτε το ακόλουθο ID: <strong {C}>%(id)</strong>',
      ...
      QA_UNCONTAINED_LI: 'Όλα τα στοιχεία λίστας <code>&lt;li&gt;</code> πρέπει να τοποθετούνται μέσα σε στοιχεία <code>&lt;ul&gt;</code> μη διατεταγμένων ή <code>&lt;ol&gt;</code> διατεταγμένων. Αυτή η δομή βοηθά τους αναγνώστες οθόνης να αναγγείλουν τη λίστα και τα στοιχεία της με ακρίβεια.',
      QA_META_SCALABLE: 'Αφαιρέστε την παράμετρο <code>user-scalable="no"</code> στο στοιχείο <code>&lt;meta name="viewport"&gt;</code> για να επιτρέψετε την μεγέθυνση.',
      QA_META_MAX: 'Βεβαιωθείτε ότι η παράμετρος <code>maximum-scale</code> στο στοιχείο <code>&lt;meta name="viewport"&gt;</code> δεν είναι μικρότερη από 2.',
      QA_JUSTIFY: 'Αποφύγετε τη χρήση δικαιολογημένου κειμένου, το οποίο ευθυγραμμίζεται τόσο με την αριστερή όσο και με την δεξιά περιθώριο. Αυτό μπορεί να είναι δύσκολο για ορισμένα άτομα λόγω των άνισων κενών μεταξύ των λέξεων. Χρησιμοποιήστε αριστερό ευθυγραμμισμένο κείμενο για καλύτερη αναγνωσιμότητα.',
      ...
      CONTRAST_WARNING: 'Η αντίθεση αυτού του κειμένου είναι άγνωστη και πρέπει να επανεξεταστεί χειροκίνητα. Βεβαιωθείτε ότι το κείμενο και το φόντο έχουν έντονη χρωματική αντίθεση. Η αναλογία αντίθεσης πρέπει να είναι τουλάχιστον 4,5:1 για κανονικό κείμενο και 3:1 για μεγάλο κείμενο. <hr> Παρακαλούμε ελέγξτε: <strong {C}>%(TEXT)</strong>',
