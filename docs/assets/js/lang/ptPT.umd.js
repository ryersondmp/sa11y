...
(function (global, factory) {
  ...
  var ptPT = {
    ...
    strings: {
      ...
      LINK_ALT_HAS_FILE_EXTENSION: 'Extensão de ficheiro no texto alternativo encontrada. Certifique-se de que o texto alternativo descreve o destino da hiperligação e não uma descrição literal da imagem. Remover: <strong {r}>%(error)</strong>.<hr><strong>Texto alternativo:</strong> %(altText)',
      ...
      ALT_HAS_FILE_EXTENSION: 'Extensão do ficheiro no texto alternativo encontrado. Se a imagem transmitir uma história, um estado de espírito ou uma informação importante, não se esqueça de a descrever. Remover: <strong {r}>%(erro)</strong>.<hr><strong>Texto alternativo:</strong> %(altText)',
      ...
      LABELS_ARIA_LABEL_INPUT_MESSAGE: 'A entrada tem um nome acessível, mas certifique-se de que também existe uma etiqueta visível. <hr> <strong>Rótulo de entrada:</strong> %(sanitizedText)',
