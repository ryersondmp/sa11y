...
var ua = {
  ...
  strings: {
    ...
    FILE_TYPE_PHRASES: ['документ', 'електронна таблиця', 'робочий аркуш', 'встановити', 'відео', 'pdf', 'пдФ', 'doc', 'docx', 'word', 'mp3', 'ppt', 'текст', 'pptx', 'powerpoint', 'txt', 'exe', 'dmg', 'rtf', 'Віндовс', 'Мак', 'csv', 'xls', 'xlsx', 'mp4', 'mov', 'avi', 'zip'],
    ...
    LABELS_ARIA_LABEL_INPUT_MESSAGE: 'Введення має доступне ім\'я, проте, будь ласка, переконайтеся, що у нього є видимий підпис. <hr> Доступне ім\'я для цього введення: <strong>%(sanitizedText)</strong>',
