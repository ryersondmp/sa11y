...
(function (global, factory) {
  ...
  var et = {
    ...
    strings: {
      ...
      MOVE_LEFT: 'Liiguta paneeli vasakule',
      MOVE_RIGHT: 'Liiguta paneeli paremale',
      ...
      CONTRAST_COLOR: 'Kas kaaluksite selle värvi kasutamist?',
      CONTRAST_SIZE: 'Kas kaaluksite teksti suuruse suurendamist selle värvikombinatsiooni jaoks?',
      CONTRAST_PLACEHOLDER: 'Selle sisendi kohatäitetekst ei oma piisavat kontrasti taustaga, mistõttu on seda raske lugeda.',
      CONTRAST_INPUT: 'Selle sisendi tekst ei oma piisavat kontrasti taustaga, mistõttu on seda raske lugeda.',
