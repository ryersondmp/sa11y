...
(function (global, factory) {
  ...
  var fi = {
    ...
    strings: {
      ...
      CONTRAST_PLACEHOLDER: 'Tämän syöttökentän paikkamerkkitekstillä ei ole tarpeeksi kontrastia taustan kanssa, mikä tekee sen lukemisesta vaikeaa.',
      CONTRAST_INPUT: 'Tämän syöttökentän tekstillä ei ole tarpeeksi kontrastia taustan kanssa, mikä tekee sen lukemisesta vaikeaa.',
      CONTRAST: 'Kontrasti',
      UNKNOWN: 'Tuntematon',
      LARGE_TEXT: 'Suuri teksti',
      BODY_TEXT: 'Runoteksti',
      FG: 'Etualata',
      BG: 'Tausta',
      NON_TEXT: 'Ei-teksti',
    },
