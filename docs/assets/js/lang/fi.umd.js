...
(function (global, factory) {
  ...
  var fi = {
    ...
    strings: {
      ...
      LINK_ALT_HAS_FILE_EXTENSION: 'Alt-tekstissä oleva tiedostopääte löydetty. Varmista, että alt-teksti kuvaa linkin määränpäätä, ei kuvan kirjaimellista kuvausta. Poista: <strong {r}>%(error)</strong>.<hr><strong>Alt text:</strong> %(altText)',
      ...
      ALT_HAS_FILE_EXTENSION: 'Alt-tekstissä oleva tiedostopääte löydetty. Jos kuva välittää tarinan, tunnelman tai tärkeän tiedon - muista kuvata kuva. Poista: <strong {r}>%(error)</strong>.<hr><strong>Alt text:</strong> %(altText)',
      ...
      LINK_HIDDEN_FOCUSABLE: 'Linkillä on <code>aria-hidden=&quot;true&quot;</code>, mutta se on edelleen näppäimistöllä valittavissa. Jos aiot piilottaa tarpeettoman tai kaksoiskappaleen linkin, lisää myös <code>tabindex=&quot;-1&quot;</code>.',
      ...
      LABELS_ARIA_LABEL_INPUT_MESSAGE: 'Syötteellä on helppokäyttöinen nimi, mutta varmista, että myös merkintä on näkyvissä. <hr> <strong>Syötelabeli:</strong> %(sanitizedText)',
