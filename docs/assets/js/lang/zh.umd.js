...
(function (global, factory) {
  ...
  var zh = {
    ...
    strings: {
      ...
      LINK_STOPWORD: '链接文本可能没有足够的描述性, 脱离了上下文: <strong {C}>%(ERROR)</strong><hr><strong>提示！</strong>链接文本应始终清晰、独特和有意义。避免使用诸如&quot;点击这里&quot;或&quot;了解更多&quot等常见的词语；',
      LINK_BEST_PRACTICES: '考虑替换链接文本: <strong {C}>%(ERROR)</strong> <hr> <ul><li>&quot;Click here&quot;将重点放在鼠标操作上, 而许多人并不使用鼠标, 或者可能在移动设备上浏览本网站。考虑使用一个与任务相关的不同动词。</li><li>避免使用HTML符号作为行动呼吁, 除非它们对辅助技术是隐藏的。</li></ul>',
      ...
      // Contrast
      CONTRAST_OPACITY: '增加文本的不透明度以提高可见性：',
      CONTRAST_APCA: '这对于任何文本大小都没有足够的对比度。考虑使用此颜色和文本大小组合？',
