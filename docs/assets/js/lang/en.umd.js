...
(function (global, factory) {
  ...
  var en = {
    ...
    strings: {
      ...
      LINK_IMAGE_ALT_AND_TEXT_WARNING: 'Image link contains <strong>both alt text and surrounding link text.</strong> If this image is decorative and is being used as a functional link to another page, consider marking the image as decorative. The surrounding link text should suffice. <hr> <strong>Alt text:</strong> %(altText) <hr> <strong>Screen reader will say:</strong> %(accName)',
