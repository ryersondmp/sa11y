...
var et = {
  ...
  strings: {
    ...
    ACC_NAME: '<strong {B}>Linki silt</strong> %(TEXT)',
    ...
    BTN_EMPTY: 'Nupul puudub ligipääsetav nimi, mis kirjeldaks selle eesmärki. Õppige, kuidas teha <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">ligipääsetav nupp.</a>',
    BTN_EMPTY_LABELLEDBY: 'Nupul on <code>aria-labelledby</code> väärtus, mis on tühi või ei vasta mõne teise lehe elemendi <code>id</code> väärtusele.',
    ...
    PAGE_LANG: 'Lehekülje keel ei ole deklareeritud! Palun <a href="https://www.w3.org/International/questions/qa-html-language-declarations">deklareerige keel HTML-sildil.</a>',
