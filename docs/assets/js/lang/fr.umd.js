...
(function (global, factory) {
  ...
  var fr = {
    ...
    strings: {
      ...
      LINK_PLACEHOLDER_ALT: 'Texte de remplacement non-descriptif ou séparateur trouvé dans une image. Assurez-vous que le texte de remplacement décrit la destination du lien, pas une description compète de l’image. Remplacer le texte de remplacement suivant. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
      LINK_SUS_ALT: 'La technologie d’assistance indiquer déjà que c’est une image, donc &quot;<strong {C}>%(ERROR)</strong>&quot; pourrait être redondant. Assurez-vous que le texte de remplacement décrit la destination du lien, pas la des-cription complète de l’image. <hr> {L} {ALT} <strong {C}>%(ALT_TEXT)</strong>',
