...
var cs = {
  ...
  strings: {
    ...
    LINK_IMAGE_BAD_ALT_MESSAGE: 'Nalezená přípona souboru v textu alt. Ujistěte se, že text alt popisuje cíl odkazu, nikoli doslovný popis obrázku. Odstranit: <strong {r}>%(error)</strong>.<hr><strong>Text alt:</strong> %(altText)',
    ...
    LINK_ALT_HAS_BAD_WORD_MESSAGE: 'Nalezená přípona souboru v textu alt. Pokud obrázek vyjadřuje příběh, náladu nebo důležitou informaci, nezapomeňte ho popsat. Odstraňte: <strong {r}>%(error)</strong>.<hr><strong>Text altu:</strong> %(altText)',
    ...
    LINK_IMAGE_ARIA_HIDDEN: 'Odkaz kolem obrázku má <code>aria-hidden=&quot;true&quot;</code>, ale je stále zaostřitelný z klávesnice. Pokud máte v úmyslu skrýt nadbytečný nebo duplicitní odkaz, přidejte také <code>tabindex=&quot;-1&quot;</code>.',
    ...
    LABELS_ARIA_LABEL_INPUT_MESSAGE: 'Vstup má přístupný název, ale zajistěte, aby byl viditelný i štítek. <hr> Přístupný název tohoto vstupu je: <strong>%(sanitizedText)</strong>.',
    ...
    EMBED_MISSING_TITLE: 'Vložený obsah vyžaduje přístupný název, který popisuje jeho obsah. Uveďte jedinečný atribut <code>title</code> nebo <code>aria-label</code> na elementu <code>iframe</code>. Další informace o <a href="https://dequeuniversity.com/tips/provide-iframe-titles">iFrame.</a>.',
