...
(function (global, factory) {
  ...
  var de = {
    ...
    strings: {
      ...
      LINK_IDENTICAL_NAME: 'Der Link hat den gleichen Text wie ein anderer Link, obwohl er auf eine andere Seite verweist. Mehrere Links mit demselben Text können bei Personen, die Bildschirmlesegeräte verwenden, zu Verwirrung führen. <hr> Erwäge, den folgenden Link beschreibender zu gestalten, um ihn von anderen Links zu unterscheiden: <strong {C}>%(TEXT)</strong>',
      ...
      LABELS_ARIA_LABEL_INPUT: 'Die Eingabe hat einen zugänglichen Namen, stelle bitte trotzdem sicher, dass es auch ein sichtbares Label gibt. <hr> <strong {B}>Eingabelabel</strong> <strong {C}>%(TEXT)</strong>',
      ...
      QA_DUPLICATE_ID: '<strong>Doppelte ID</strong> gefunden. Doppelte ID-Fehler verursachen bekanntermaßen Probleme für Hilfstechnologien, wenn man versucht, mit Inhalten zu interagieren. <hr> Bitte entferne oder ändere die folgende ID: <strong {C}>%(id)</strong>',
