...
var el = {
  ...
  strings: {
    ...
    ACC_NAME: '<strong {B}>Ετικέτα συνδέσμου</strong> %(TEXT)',
    ...
    BTN_EMPTY: 'Το κουμπί δεν έχει προσβάσιμο όνομα που να περιγράφει τον σκοπό του. Μάθετε πώς να δημιουργήσετε ένα <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">προσβάσιμο κουμπί.</a>',
    BTN_EMPTY_LABELLEDBY: 'Το κουμπί έχει τιμή <code>aria-labelledby</code> που είναι κενή ή δεν ταιριάζει με την τιμή <code>id</code> άλλου στοιχείου στη σελίδα.',
    ...
    PAGE_LANG: 'Η γλώσσα της σελίδας δεν έχει δηλωθεί! Παρακαλούμε <a href="https://www.w3.org/International/questions/qa-html-language-declarations">δήλωσε τη γλώσσα στην ετικέτα HTML.</a>',
    ...
    DUPLICATE_ID: 'Βρέθηκε <strong>διπλό αναγνωριστικό</strong>. Τα σφάλματα διπλού αναγνωριστικού είναι γνωστό ότι προκαλούν προβλήματα στις υποστηρικτικές τεχνολογίες όταν αυτές προσπαθούν να αλληλεπιδράσουν με το περιεχόμενο. <hr> Παρακαλούμε αφαιρέστε ή αλλάξτε το ακόλουθο ID: <strong {C}>%(id)</strong>',
