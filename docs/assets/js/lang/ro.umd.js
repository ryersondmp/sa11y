...
(function (global, factory) {
  ...
  var ro = {
    ...
    strings: {
      ...
      ACC_NAME: '<strong {B}>Etichetă</strong> %(TEXT)',
      ...
      BTN_EMPTY: 'Butonul nu are un nume accesibil care să îi descrie scopul. Aflați cum să creați un <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">buton accesibil.</a>',
      BTN_EMPTY_LABELLEDBY: 'Butonul are o valoare <code>aria-labelledby</code> care este goală sau nu se potrivește cu valoarea <code>id</code> a unui alt element de pe pagină.',
      ...
      PAGE_LANG: 'Limba paginii nu este declarată! Vă rugăm <a href="https://www.w3.org/International/questions/qa-html-language-declarations">declarați limba în tag-ul HTML.</a>',
