(function(global, factory) {
  ...
  const enUS = {
    ...
    strings: {
      ...
      LINK_IDENTICAL_NAME: "Multiple links on this page use the same link text but point to different places. This may cause confusion for assistive technology users. To fix, make this link text more descriptive. <hr> <strong {B}>Link text</strong> <strong {C}>%(TEXT)</strong>",
