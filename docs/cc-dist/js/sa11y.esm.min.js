...
class xn extends HTMLElement {
  connectedCallback() {
    ...
    k.setAttribute("id", "container"), k.setAttribute("role", "region"), k.setAttribute("data-sa11y-version", "4.4.0"), k.setAttribute("lang", f._("LANG_CODE")), k.setAttribute("aria-label", f._("CONTAINER_LABEL")), k.setAttribute("dir", u.Global.langDirection), a === "top-left" || a === "top-right" ? k.innerHTML = `
        ${A}
