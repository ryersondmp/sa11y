...
function Lr(t, e) {
  ...
  return M.Found.Images.forEach((c) => {
    ...
    ), h = c.getAttribute("src") ? c.getAttribute("src").split("?")[0] : c.getAttribute("srcset"), A = m ? Xe(m, u.Exclusions.LinkSpan).textContent.replace(
      r,
      ""
    ) : "", y = be(A).length;
...
function Br(t, e) {
  if (e.checks.QA_BAD_LINK && M.Found.CustomErrorLinks.forEach((a) => {
    ...
    if (Be(a) === !1) {
      const l = a.querySelectorAll("th"), c = a.querySelectorAll("h1, h2, h3, h4, h5, h6"), p = a.querySelector("tr") ? a.querySelector("tr").innerHTML : a.innerHTML;
