...
function xr(t, e) {
  const n = e.linkStopWords ? e.linkStopWords.split(",").map((r) => r.toLowerCase().trim()) : [], s = /* @__PURE__ */ new Set([...f._("LINK_STOPWORDS"), ...n]), o = new Set(e.linkIgnoreStrings.map((r) => r.toLowerCase())), a = Re(f._("CLICK")), i = Re(f._("NEW_WINDOW_PHRASES")), l = Re(Er), c = Re(e.linkIgnoreStrings), p = {};
