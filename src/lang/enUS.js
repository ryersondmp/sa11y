export default {
  ...
  strings: {
    ...
    LINK_IDENTICAL_NAME:
      'Multiple links on this page use the same link text but point to different places. This may cause confusion for assistive technology users. To fix, make this link text more descriptive: <strong {C}>%(TEXT)</strong>',
