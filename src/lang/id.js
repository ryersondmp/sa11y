...
export default {
  ...
  strings: {
    ...
    CONSOLE_ERROR:
      'Maaf, ada masalah dengan pemeriksa aksesibilitas di halaman ini. Bisakah Anda <a href="https://forms.gle/sjzK9XykETaoqZv99">melaporkannya melalui formulir ini</a> atau di <a href="https://github.com/ryersondmp/sa11y/issues/new?title=Bug%20report">GitHub</a>?',
    APPEARANCE: 'Tampilan',
    ...
    TABLES_INVALID_HEADERS_REF: 'Atribut <code>headers</code> berisi referensi yang tidak valid: <strong {C}>%(VALUE)</strong>. Atribut ini harus merujuk ke ID sel tajuk yang valid dalam tabel yang sama. <hr> Pelajari lebih lanjut tentang <a href="https://www.w3.org/WAI/WCAG22/Techniques/html/H43">menggunakan atribut id dan headers untuk mengaitkan sel data dengan sel tajuk dalam tabel data.</a>',
