...
const ui = {
  ...
  CONSOLE_ERROR:
    'Lo siento, pero hay un problema con el comprobador de accesibilidad en esta página. Puedes por favor <a href="https://forms.gle/sjzK9XykETaoqZv99">reportarlo a través de este formulario</a> or on <a href="https://github.com/ryersondmp/sa11y/issues/new?title=Bug%20report">GitHub</a>?',
...
const tooltip = {
  ...
  EMBED_MISSING_TITLE:
    'El contenido incrustado requiere un nombre accesible que describa su contenido. Proporcione un atributo único <code>title</code> o <code>aria-label</code> en el elemento <code>&lt;%(ELEMENT)&gt;</code>. Más información sobre <a href="https://web.dev/learn/accessibility/more-html#iframes">iFrames.</a>',
  EMBED_GENERAL:
