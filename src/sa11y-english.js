...
const sa11yLang = {
    ...
    LINK_IMAGE_LONG_ALT: (altText, altLength) =>
        `Alt text description on a linked image is <span class='sa11y-bold'>too long</span>. The alt text on linked images should describe where the link takes you, not a literal description of the image. 
    ...
    LINK_IMAGE_ALT_WARNING: (altText) =>
        `Image link contains alt text, although please ensure alt text describes the destination page. <span class='sa11y-bold'>Consider using the title of the page it links to as the alt text.</span>
    ...
    IMAGE_FIGURE_DECORATIVE: 
        `Image is marked as <span class='sa11y-bold'>decorative</span> and will be ignored by assistive technology. Although a <span class='sa11y-bold'>caption</span> was provided, the image should also have alt text. The alt text should provide a concise description of what is in the image. The caption should usually provide context to relate the image back to the surrounding content, or give attention to a particular piece of information.`,
    ...
    IMAGE_ALT_TOO_LONG: (altText, altLength) =>
        `Alt text description is <span class='sa11y-bold'>too long</span>. Alt text should be concise, yet meaningful like a <em>tweet</em> (around 100 characters). If this is a complex image or a graph, consider putting the long description of the image in the text below or an accordion component. 
        ${sa11yHr} 
        The alt text is <span class='sa11y-red-text sa11y-bold'>${altLength}</span> characters: 
        <span class='sa11y-red-text sa11y-bold'>${altText}</span>`,
    ...
    LABELS_NO_FOR_ATTRIBUTE_MESSAGE: (id) =>
        ...
        ${sa11yHr} 
        The ID for this input is: <span class='sa11y-bold'>id=&#34;${id}&#34;</span>`,
    ...
    CONTRAST_ERROR: (cratio, nodetext) =>
        ...
        ${sa11yHr} 
        The contrast ratio is <span class='sa11y-red-text sa11y-bold'>${cratio}</span> for the following text: <span class='sa11y-bold sa11y-red-text'>${nodetext}</span>`,
    ...
    CONTRAST_WARNING: (nodetext) =>
        ...
        ${sa11yHr}
        Please review contrast of the following text:
        <br><span class='sa11y-bold'>${nodetext}</span>`,
    ...
    CONTRAST_INPUT_ERROR: (cratio) =>
        ...
        ${sa11yHr} 
        The contrast ratio is: <span class='sa11y-red-text sa11y-bold'>${cratio}</span>`,
