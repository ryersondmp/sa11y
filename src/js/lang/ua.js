export default {
  ...
  strings: {
    ...
    ACC_NAME: '<strong {B}>Назва посилання</strong> %(TEXT)',
    ...
    // Buttons
    BTN_EMPTY: 'Кнопка не має доступного імені, що описує її призначення. Дізнайтеся, як зробити <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">доступну кнопку.</a>',
    ...
    PAGE_LANG: 'Мова сторінки не вказана! Будь ласка, <a href="https://www.w3.org/International/questions/qa-html-language-declarations">вкажіть мову в тезі HTML.</a>',
    ...
    DUPLICATE_ID: 'Виявлено <strong>дублікат ID</strong>. Відомо, що помилки дублювання ID можуть викликати проблеми для допоміжних технологій, коли вони намагаються взаємодіяти із вмістом. <hr> Будь ласка, видаліть або змініть наступний ідентифікатор: <strong {C}>%(id)</strong>',
