export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Порада!</strong> Використовуйте чіткий і унікальний текст посилання, що описує призначення посилання, зазвичай заголовок сторінки або документа.',
    ...
    LINK_SYMBOLS: 'Уникайте використання символів як закликів до дії в тексті посилання, якщо вони не приховані від допоміжних технологій. Розгляньте можливість їх видалення: <strong {C}>%(ERROR)</strong>',
    ...
    CONTRAST_ERROR_GRAPHIC: 'Графіка має недостатній контраст з фоном, що ускладнює її сприйняття.',
