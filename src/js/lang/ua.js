export default {
  ...
  strings: {
    ...
    // Contrast
    CONTRAST_ERROR: 'Цей текст недостатньо контрастний щодо фону. Коефіцієнт контрастності має бути не менше 4,5:1 для звичайного тексту та 3:1 для великого тексту. <hr> Коефіцієнт контрастності становить <strong {r}>%(RATIO)</strong> для даного тексту: <strong {r}>%(TEXT)</strong>',
    ...
    CONTRAST_INPUT_ERROR: 'Текст у цьому введенні недостатньо контрастний щодо фону. Коефіцієнт контрастності має бути не менше 4,5:1 для звичайного тексту та 3:1 для великого. <hr> Коефіцієнт контрастності: <strong {r}>%(RATIO)</strong>',
  },
};
