export default {
  ...
  strings: {
    ...
    CONTRAST_WARNING: 'Контраст цього тексту невідомий і потребує ручного перегляду. Переконайтеся, що текст і фон мають сильний контраст. <hr> <strong {B}>Контраст</strong> <strong {B}>Невідомо</strong> <strong {C}>%(TEXT)</strong>',
    WCAG_ADVICE: 'Співвідношення контрастності повинно бути щонайменше 4,5:1 для звичайного тексту та 3:1 для великого тексту.',
    APCA_ADVICE: 'Значення контрасту повинно бути щонайменше 60 для основного тексту та 45 для великого тексту.',
