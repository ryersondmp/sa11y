...
export default {
  ...
  strings: {
    ...
    HEADING_LONG: 'Antraštė ilga! Antraštės turėtų būti naudojamos turiniui tvarkyti ir struktūrai perteikti. Jos turėtų būti trumpos, informatyvios ir unikalios. Prašome, kad antraštės būtų trumpesnės nei 160 ženklų (ne ilgesnės nei sakinys). <hr> <strong {wb}>%(HEADING_LENGTH) Ženklai</strong>',
    ...
    LINK_ALT_HAS_FILE_EXTENSION: 'Rastas failo plėtinys alt tekste. Užtikrinkite, kad alt tekstas apibūdintų nuorodos paskirties vietą, o ne pažodinį paveikslėlio aprašymą. Pašalinti: <strong {r}>%(ERROR)</strong>.<hr> <strong {eb}>ALT</strong> <strong {r}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_PLACEHOLDER_ALT_MESSAGE: 'Rastas ne aprašomasis arba pakaitinis alt tekstas susietame paveikslėlyje. Užtikrinkite, kad alt tekstas apibūdintų nuorodos paskirties vietą, o ne pažodinį paveikslėlio aprašymą. Pakeiskite šį alt tekstą: <strong {r}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_SUS_ALT_MESSAGE: 'Pagalbinėse technologijose jau nurodoma, kad tai yra paveikslėlis, todėl &quot;<strong {w}>%(ERROR)</strong>&quot; gali būti nereikalingas. Užtikrinkite, kad alt tekstas apibūdintų nuorodos paskirties vietą, o ne pažodinį paveikslėlio aprašymą. <hr> <strong {wb}>ALT</strong> <strong {w}>%(ALT_TEXT)</strong>',
    ALT_HAS_FILE_EXTENSION: 'Rastas failo plėtinys alt tekste. Jei vaizdas perteikia istoriją, nuotaiką ar svarbią informaciją, būtinai aprašykite vaizdą. Pašalinti: <strong {r}>%(ERROR)</strong>. <hr> <strong {eb}>ALT</strong> <strong {r}>%(ALT_TEXT)</strong>',
    ALT_PLACEHOLDER_MESSAGE: 'Rastas neaprašytas arba pakaitinis alt tekstas. Pakeiskite šį alt tekstą į prasmingesnį: <strong {r}>%(ALT_TEXT)</strong>',
    ALT_HAS_SUS_WORD: 'Pagalbinėse technologijose jau nurodoma, kad tai yra paveikslėlis, todėl &quot;<strong {w}>%(ERROR)</strong>&quot; gali būti nereikalingas. <hr> <strong {wb}>ALT</strong> <strong {w}>%(ALT_TEXT)</strong>',
    ...
    LINK_IMAGE_LONG_ALT: 'Susieto paveikslėlio Alt teksto aprašymas yra <strong>per ilgas</strong>. Susietų paveikslėlių alt tekstas turėtų apibūdinti, kur nukreipia nuoroda, o ne pažodinis paveikslėlio aprašymas. <strong>Svarstykite galimybę kaip alt tekstą naudoti puslapio, į kurį nukreipia nuoroda, pavadinimą.</strong> <hr> <strong {wb}>ALT</strong> <strong {wb}>%(altLength) Ženklai</strong> <strong {w}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_ALT_WARNING: 'Paveikslėlio nuorodoje yra teksto alt. <strong>Ar alt tekste aprašoma, kur nukreipia nuoroda?</strong> Apsvarstykite galimybę kaip alt tekstą naudoti puslapio, į kurį nukreipia nuoroda, pavadinimą. <hr> <strong {wb}>ALT</strong> <strong {w}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_ALT_AND_TEXT_WARNING: 'Paveikslėlio nuorodoje yra <strong>ir alt tekstas, ir aplink esantis nuorodos tekstas.</strong> Jei šis paveikslėlis yra dekoratyvinis ir naudojamas kaip funkcinė nuoroda į kitą puslapį, apsvarstykite galimybę pažymėti paveikslėlį kaip dekoratyvinį arba nulinį - aplink esančio nuorodos teksto turėtų pakakti. <hr> <strong {wb}>ALT</strong> <strong {w}>%(ALT_TEXT)</strong> <hr> <strong {wb}>Etiketė su nuoroda</strong> <strong {w}>%(TEXT)</strong>',
    ...
    IMAGE_ALT_TOO_LONG: 'Alt teksto aprašymas yra <strong>per ilgas</strong>. Alt tekstas turėtų būti glaustas, bet prasmingas, kaip <em>tweet</em> (apie 100 simbolių). Jei tai sudėtingas paveikslėlis arba grafikas, apsvarstykite galimybę ilgą paveikslėlio aprašymą pateikti žemiau esančiame tekste arba akordeono komponente. <hr> <strong {wb}>ALT</strong> <strong {wb}>%(altLength) Ženklai</strong> <strong {w}>%(ALT_TEXT)</strong>',
    ...
    LABELS_ARIA_LABEL_INPUT_MESSAGE: 'Įvestis turi prieinamą pavadinimą, tačiau užtikrinkite, kad būtų matoma ir etiketė. <hr> <strong {wb}>Įvesties žymė</strong> <strong {w}>%(TEXT)</strong>',
    ...
    CONTRAST_ERROR: 'Šis tekstas nepakankamai kontrastuoja su fonu. Įprasto teksto kontrasto santykis turėtų būti bent 4,5:1, o didelio teksto - 3:1. <hr> <strong {eb}>Kontrasto santykis</strong> <strong {eb}>%(RATIO)</strong> <strong {r}>%(TEXT)</strong>',
    ...
    CONTRAST_INPUT_ERROR: 'Šios įvesties tekstas nepakankamai kontrastuoja su fonu. Įprasto teksto kontrasto santykis turėtų būti bent 4,5:1, o didelio teksto - 3:1. <hr> <strong {eb}>Kontrasto santykis</strong> <strong {eb}>%(RATIO)</strong>',
  },
};
