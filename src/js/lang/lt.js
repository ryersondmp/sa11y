...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Patarimas!</strong> Naudokite aiškų ir unikalų nuorodos tekstą, kuris apibūdintų nuorodos tikslą, paprastai – puslapio ar dokumento pavadinimą.',
    ...
    LINK_SYMBOLS: 'Venkite naudoti simbolius kaip raginimus veikti nuorodų tekste, nebent jie yra paslėpti nuo pagalbinių technologijų. Apsvarstykite jų pašalinimą: <strong {C}>%(ERROR)</strong>',
