...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Tip!</strong> Gebruik duidelijke en unieke linkteksten die de bestemming van de link beschrijven, meestal de titel van de pagina of het document.',
    ...
    LINK_SYMBOLS: 'Vermijd het gebruik van symbolen als oproep tot actie in linkteksten, tenzij ze verborgen zijn voor ondersteunende technologieën. Overweeg deze te verwijderen: <strong {C}>%(ERROR)</strong>',
