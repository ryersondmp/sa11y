export default {
  ...
  strings: {
    ...
    HEADING_LONG: 'Koppen zijn lang! Koppen moeten worden gebruikt om inhoud te organiseren en structuur over te brengen. Ze moeten kort, informatief en uniek zijn. Houd koppen onder de 160 tekens (niet meer dan een zin). <hr> Aantal tekens: <strong {r}>%(headingLength)</strong>',
    ...
    LINK_IDENTICAL_NAME: 'Link heeft dezelfde tekst als een andere link, maar verwijst naar een andere pagina. Meerdere links met dezelfde tekst kunnen verwarring veroorzaken voor mensen die schermlezers gebruiken.<hr>Overweeg om de volgende link beschrijvender te maken om hem te helpen onderscheiden van andere links: <strong {r}>%(sanitizedText)</strong>',
    ...
    LINK_IMAGE_BAD_ALT_MESSAGE: 'Bestandsextensie in de alt-tekst gevonden. Zorg ervoor dat de alt-tekst de bestemming van de link beschrijft en niet een letterlijke beschrijving van de afbeelding. Verwijderen: <strong {r}>%(error)</strong>.<hr><strong>Alt-tekst:</strong> %(altText)',
    LINK_IMAGE_PLACEHOLDER_ALT_MESSAGE: 'Niet-beschrijvende of plaatsvervangende alt-tekst binnen een gekoppelde afbeelding gevonden. Zorg ervoor dat de alt-tekst de bestemming van de link beschrijft en niet een letterlijke beschrijving van de afbeelding. Vervang de volgende alt-tekst: <strong {r}>%(altText)</strong>',
    LINK_IMAGE_SUS_ALT_MESSAGE: 'Hulptechnologieën geven al aan dat het om een afbeelding gaat, dus &quot;<strong {r}>%(error)</strong>&quot; kan overbodig zijn. Zorg ervoor dat de alt-tekst de bestemming van de link beschrijft en niet een letterlijke beschrijving van de afbeelding. <hr> <strong>Alttekst:</strong> %(altText)',
    LINK_ALT_HAS_BAD_WORD_MESSAGE: 'Bestandsextensie in de gevonden alt-tekst. Als de afbeelding een verhaal, stemming of belangrijke informatie overbrengt, zorg er dan voor dat je de afbeelding beschrijft. Verwijderen: <strong {r}>%(error)</strong>.<hr><strong>Alt-tekst:</strong> %(altText)',
    ALT_PLACEHOLDER_MESSAGE: 'Niet-beschrijvende of plaatshouder alt-tekst gevonden. Vervang de volgende alt-tekst door iets dat meer betekenis heeft: <strong {r}>%(altText)</strong>',
    ALT_HAS_SUS_WORD: 'Hulptechnologieën geven al aan dat dit een afbeelding is, dus &quot;<strong {r}>%(error)</strong>&quot; kan overbodig zijn. <hr> <strong>Alt tekst:</strong> %(altText)',
    LINK_IMAGE_ARIA_HIDDEN: 'Link rond afbeelding heeft <code>aria-hidden=&quot;true&quot;</code> maar is nog steeds toetsenbordfocusbaar. Als je een overbodige of dubbele link wilt verbergen, voeg dan ook <code>tabindex=&quot;-1&quot;</code> toe.',
    ...
    LINK_IMAGE_LONG_ALT: 'Alt-tekstbeschrijving op een gekoppelde afbeelding is <strong>te lang</strong>. De alt-tekst op gelinkte afbeeldingen moet beschrijven waar de link je naartoe brengt, niet een letterlijke beschrijving van de afbeelding. <strong>Overweeg om de titel van de pagina waarnaar wordt gelinkt als alt-tekst te gebruiken.</strong> <hr> <strong>Alt-tekst (<span {r}>%(altLength)</span> tekens):</strong> %(altText)',
    LINK_IMAGE_ALT_WARNING: 'De link naar de afbeelding bevat alt-tekst. <strong>Beschrijft de alt-tekst waar de link je naartoe brengt?</strong> Overweeg om de titel van de pagina waarnaar wordt gelinkt als alt-tekst te gebruiken. <hr> <strong>Alttekst:</strong> %(altText)',
    LINK_IMAGE_ALT_AND_TEXT_WARNING: 'Als deze afbeelding decoratief is en wordt gebruikt als een functionele link naar een andere pagina, overweeg dan om de afbeelding als decoratief of null te markeren - de omringende linktekst zou moeten volstaan. <hr> <strong>Alttekst:</strong> %(altText)',
    ...
    LABELS_ARIA_LABEL_INPUT_MESSAGE: 'De invoer heeft een toegankelijke naam, maar zorg ervoor dat er ook een zichtbaar label is. <hr> De toegankelijke naam voor deze invoer is: <strong>%(sanitizedText)</strong>',
    ...
    QA_BLOCKQUOTE_MESSAGE: 'Is dit een koptekst? <strong {r}>%(sanitizedText)</strong> <hr> Blokcitaten moeten alleen worden gebruikt voor citaten. Als dit bedoeld is als een koptekst, verander deze blokcitaat dan in een semantische koptekst (bijvoorbeeld koptekst 2 of koptekst 3).',
    QA_FAKE_HEADING: 'Is dit een koptekst? <strong {r}>%(boldtext)</strong> <hr> Een regel vette of grote tekst ziet er misschien uit als een kop, maar iemand die een schermlezer gebruikt, kan niet zien dat het belangrijk is of naar de inhoud springen. Vette of grote tekst mag nooit semantische koppen vervangen (Kop 2 tot en met Kop 6).',
    QA_SHOULD_BE_LIST: 'Probeer je een lijst te maken? Mogelijk lijstitem gevonden: <strong {r}>%(firstPrefix)</strong> <hr> Zorg ervoor dat je semantische lijsten gebruikt door in plaats daarvan de opsommingsteken- of nummeropmaakknoppen te gebruiken. Als je een semantische lijst gebruikt, kunnen hulptechnologieën informatie overbrengen zoals het totale aantal items en de relatieve positie van elk item in de lijst. Meer informatie over <a href="https://www.w3.org/WAI/tutorials/page-structure/content/#lists">semantische lijsten.</a>',
    ...
    CONTRAST_ERROR: 'Deze tekst heeft niet genoeg contrast met de achtergrond. De contrastverhouding moet ten minste 4,5:1 zijn voor normale tekst en 3:1 voor grote tekst. <hr> De contrastverhouding is <strong {r}>%(cratio)</strong> voor de volgende tekst: <strong {r}>%(sanitizedText)</strong>',
    CONTRAST_WARNING: 'Het contrast van deze tekst is onbekend en moet handmatig worden gecontroleerd. Zorg ervoor dat de tekst en de achtergrond sterk contrasterende kleuren hebben. De contrastverhouding moet minstens 4,5:1 zijn voor normale tekst en 3:1 voor grote tekst. <hr> <strong>Bekijk:</strong> %(sanitizedText)',
    CONTRAST_INPUT_ERROR: 'Tekst binnen deze invoer heeft niet genoeg contrast met de achtergrond. De contrastverhouding moet ten minste 4,5:1 zijn voor normale tekst en 3:1 voor grote tekst. <hr> Contrastverhouding: <strong {r}>%(cratio)</strong>',
  },
};
