...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>ヒント！</strong> リンク先を説明する、明確で一意なリンクテキストを使用してください。通常はページやドキュメントのタイトルを指します。',
    ...
    LINK_SYMBOLS: 'リンクテキスト内でコールトゥアクションとして記号を使用することは避けてください。ただし、補助技術から隠されている場合を除きます。次を削除することを検討してください: <strong {C}>%(ERROR)</strong>',
