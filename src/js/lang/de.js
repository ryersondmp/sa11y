export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Tipp!</strong> Verwenden Sie klaren und einzigartigen Linktext, der das Ziel des Links beschreibt, in der Regel der Titel der Seite oder des Dokuments.',
    ...
    LINK_SYMBOLS: 'Vermeiden Sie die Verwendung von Symbolen als Handlungsaufforderungen innerhalb des Linktexts, es sei denn, sie sind für unterstützende Technologien ausgeblendet. Erwägen Sie das Entfernen: <strong {C}>%(ERROR)</strong>',
