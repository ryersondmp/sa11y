...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Tipp!</strong> Használjon egyértelmű és egyedi link szöveget, amely leírja a link célját, általában az oldal vagy dokumentum címét.',
    ...
    LINK_SYMBOLS: 'Kerülje a szimbólumok használatát, mint cselekvésre való felhívást a link szövegében, hacsak nem rejtette el őket a segítő technológiák elől. Fontolja meg ezek eltávolítását: <strong {C}>%(ERROR)</strong>',
