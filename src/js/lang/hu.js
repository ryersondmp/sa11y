...
export default {
  ...
  strings: {
    ...
    LINK_IMAGE_BAD_ALT_MESSAGE: 'Fájlkiterjesztés az alt szövegben található. Győződjön meg róla, hogy az alt szöveg a link célját írja le, nem pedig a kép szó szerinti leírását. Távolítsa el: <strong {r}>%(hiba)</strong>.<hr><strong>Alt szöveg:</strong> %(altText)',
    ...
    LINK_ALT_HAS_BAD_WORD_MESSAGE: 'Fájlkiterjesztés az alt szövegben található. Ha a kép történetet, hangulatot vagy fontos információt közvetít - mindenképpen írja le a képet. Távolítsa el: <strong {r}>%(hiba)</strong>.<hr><strong>Alt szöveg:</strong> %(altText)',
    ...
    LINK_IMAGE_ARIA_HIDDEN: 'A kép körüli link <code>aria-hidden=&quot;true&quot;</code>, de még mindig fókuszálható a billentyűzeten. Ha egy felesleges vagy duplikált linket kíván elrejteni, adjon hozzá <code>tabindex=&quot;-1&quot;</code> is.',
    ...
    LABELS_ARIA_LABEL_INPUT_MESSAGE: 'A bemenetnek elérhető neve van, de kérjük, gondoskodjon arról, hogy a címke is látható legyen. <hr> Ennek a bemenetnek a hozzáférhető neve a következő: <strong>%(sanitizedText)</strong>',
