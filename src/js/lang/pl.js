export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Wskazówka!</strong> Używaj jasnego i unikalnego tekstu linku, który opisuje cel linku, zwykle tytuł strony lub dokumentu.',
    ...
    LINK_SYMBOLS: 'Unikaj używania symboli jako wezwań do działania w tekście linku, chyba że są one ukryte przed technologiami wspomagającymi. Rozważ ich usunięcie: <strong {C}>%(ERROR)</strong>',
