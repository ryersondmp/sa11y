...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Tips!</strong> Använd tydlig och unik länkttext som beskriver destinationen för länken, vanligtvis sidans eller dokumentets titel.',
    ...
    LINK_SYMBOLS: 'Undvik att använda symboler som uppmaningar till handling inom länkttext, om de inte är dolda för hjälpmedelsteknik. Överväg att ta bort: <strong {C}>%(ERROR)</strong>',
