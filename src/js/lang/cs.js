...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Tip!</strong> Použijte jasný a jedinečný text odkazu, který popisuje cíl odkazu, obvykle název stránky nebo dokumentu.',
    ...
    LINK_SYMBOLS: 'Vyhněte se používání symbolů jako výzvy k akci v textu odkazu, pokud nejsou skryty před asistivními technologiemi. Zvažte odstranění: <strong {C}>%(ERROR)</strong>',
