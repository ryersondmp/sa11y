...
export default {
  ...
  strings: {
    ...
    ACC_NAME: '<strong>Značka odkazu:</strong> %(TEXT)',
    ...
    BTN_EMPTY: 'Tlačítku chybí přístupné jméno, které popisuje jeho účel. Naučte se, jak vytvořit <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">přístupné tlačítko.</a>',
    ...
    PAGE_LANG: 'Jazyk stránky není deklarován! Prosím <a href="https://www.w3.org/International/questions/qa-html-language-declarations">deklarujte jazyk v tagu HTML.</a>',
