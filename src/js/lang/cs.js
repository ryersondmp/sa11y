...
export default {
  ...
  strings: {
    ...
    QA_JUSTIFY: 'Vyhněte se používání textu zarovnaného na oba okraje, protože to může být obtížné pro některé lidi kvůli nerovnoměrným mezerám mezi slovy. Používejte text zarovnaný vlevo pro lepší čitelnost.',
