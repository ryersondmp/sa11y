...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Tips!</strong> Bruk tydelig og unik lenketekst som beskriver destinasjonen til lenken, vanligvis siden eller dokumentets tittel.',
    ...
    LINK_SYMBOLS: 'Unngå å bruke symboler som handlingsoppfordringer i lenketekst med mindre de er skjult for hjelpemidler. Vurder å fjerne: <strong {C}>%(ERROR)</strong>',
