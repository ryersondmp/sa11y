...
export default {
  ...
  strings: {
    ...
    CONTRAST_ERROR: 'Denne teksten har ikke nok kontrast til bakgrunnen. Kontrastforholdet bør være minst 4,5:1 for normal tekst og 3:1 for stor tekst. <hr> Kontrastforholdet er <strong {r}>%(RATIO)</strong> for følgende tekst: <strong {r}>%(TEXT)</strong>',
    ...
    CONTRAST_INPUT_ERROR: 'Teksten i denne inngangen har ikke nok kontrast til bakgrunnen. Kontrastforholdet bør være minst 4,5:1 for normal tekst og 3:1 for stor tekst. <hr> Kontrastforhold: <strong {r}>%(RATIO)</strong>',
  },
};
