...
export default {
  ...
  strings: {
    ...
    LINK_IMAGE_BAD_ALT_MESSAGE: 'Filendelsen i alt-teksten ble funnet. Sørg for at alt-teksten beskriver målet for lenken, ikke en bokstavelig beskrivelse av bildet. Fjern dette: <strong {r}>%(error)</strong>.<hr><strong>Alt-tekst:</strong> %(altText)',
    ...
    LINK_ALT_HAS_BAD_WORD_MESSAGE: 'Filtypen i alt-teksten som er funnet. Hvis bildet formidler en historie, en stemning eller viktig informasjon - husk å beskrive bildet. Fjern dette: <strong {r}>%(error)</strong>.<hr><strong>Alt-tekst:</strong> %(altText)',
    ...
    LINK_IMAGE_ARIA_HIDDEN: 'Lenken rundt bildet har <code>aria-hidden=&quot;true&quot;</code>, men kan fortsatt fokuseres med tastaturet. Hvis du vil skjule en overflødig eller duplisert lenke, kan du også legge til <code>tabindex=&quot;-1&quot;</code>.',
    ...
    LABELS_ARIA_LABEL_INPUT_MESSAGE: 'Inndataene har et tilgjengelig navn, men sørg for at de også har en synlig etikett. <hr> Det tilgjengelige navnet for denne inndataen er: <strong>%(sanitizedText)</strong>',
