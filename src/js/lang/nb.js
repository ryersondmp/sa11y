...
export default {
  ...
  strings: {
    ...
    QA_DUPLICATE_ID: 'Fant <strong>duplisert ID</strong>. Feil med dupliserte ID-er er kjent for å forårsake problemer for hjelpeteknologier når de prøver å samhandle med innhold. <hr> Vennligst fjern eller endre følgende ID: <strong {C}>%(id)</strong>',
    ...
    QA_UNCONTAINED_LI: 'Alle <code>&lt;li&gt;</code> listeelementer må plasseres inne i <code>&lt;ul&gt;</code> uordnede eller <code>&lt;ol&gt;</code> ordnede elementer. Denne strukturen hjelper skjermlesere med å annonsere listen og dens elementer nøyaktig.',
    QA_META_SCALABLE: 'Fjern parameteren <code>user-scalable="no"</code> i <code>&lt;meta name="viewport"&gt;</code> elementet for å tillate zooming.',
    QA_META_MAX: 'Sørg for at <code>maximum-scale</code> parameteren i <code>&lt;meta name="viewport"&gt;</code> elementet ikke er mindre enn 2.',
