...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Sfat!</strong> Utilizați un text de link clar și unic care descrie destinația linkului, de obicei titlul paginii sau al documentului.',
    ...
    LINK_SYMBOLS: 'Evitați utilizarea simbolurilor ca apeluri la acțiune în textul linkurilor, cu excepția cazului în care acestea sunt ascunse tehnologiilor asistive. Luați în considerare eliminarea acestora: <strong {C}>%(ERROR)</strong>',
