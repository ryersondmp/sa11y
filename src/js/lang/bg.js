...
export default {
  ...
  strings: {
    ...
    CONTRAST_WARNING: 'Контрастът на този текст е неизвестен и трябва да бъде прегледан ръчно. Уверете се, че текстът и фоновите цветове имат силен контраст. <hr> <strong {B}>Контраст</strong> <strong {B}>Неизвестен</strong> <strong {C}>%(TEXT)</strong>',
    WCAG_ADVICE: 'Контрастното съотношение трябва да бъде най-малко 4.5:1 за нормален текст и 3:1 за голям текст.',
    APCA_ADVICE: 'Стойността на контраста трябва да бъде най-малко 60 за основния текст и 45 за голям текст.',
