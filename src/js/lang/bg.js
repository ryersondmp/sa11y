...
export default {
  ...
  strings: {
    ...
    MOVE_LEFT: 'Преместване на панела наляво',
    MOVE_RIGHT: 'Преместване на панела надясно',
    ...
    CONTRAST_ERROR_GRAPHIC: 'Графиката няма достатъчен контраст с фона, което затруднява виждането й.',
