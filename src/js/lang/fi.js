...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Vinkki!</strong> Käytä selkeitä ja yksilöllisiä linkkitekstejä, jotka kuvaavat linkin kohdetta, kuten sivun tai dokumentin otsikkoa.',
    ...
    LINK_SYMBOLS: 'Vältä symbolien käyttöä toimintakehotuksena linkkitekstissä, elleivät ne ole piilotettu apuvälineiltä. Harkitse poistamista: <strong {C}>%(ERROR)</strong>',
