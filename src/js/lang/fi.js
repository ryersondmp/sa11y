...
export default {
  ...
  strings: {
    ...
    ACC_NAME: '<strong {B}>Linkki etiketti</strong> %(TEXT)',
    ...
    BTN_EMPTY: 'Nappilta puuttuu saavutettava nimi, joka kuvaa sen tarkoitusta. Opi tekemään <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">saavutettava nappi.</a>',
    BTN_EMPTY_LABELLEDBY: 'Nappilla on <code>aria-labelledby</code> arvo, joka on tyhjä tai ei vastaa sivun toisen elementin <code>id</code> arvoa.',
    ...
    PAGE_LANG: 'Sivun kieltä ei ole ilmoitettu! Ole hyvä ja <a href="https://www.w3.org/International/questions/qa-html-language-declarations">ilmoita kieli HTML-tagissa.</a>',
