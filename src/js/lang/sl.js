...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Nasvet!</strong> Uporabite jasno in edinstveno besedilo povezave, ki opisuje cilj povezave, običajno naslov strani ali dokumenta.',
    ...
    LINK_SYMBOLS: 'Izogibajte se uporabi simbolov kot pozivov k dejanju znotraj besedila povezave, razen če so skriti pred asistivnimi tehnologijami. Razmislite o odstranitvi: <strong {C}>%(ERROR)</strong>',
