export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>¡Consejo!</strong> Use un texto de enlace claro y único que describa el destino del enlace, típicamente el título de la página o documento.',
    ...
    LINK_SYMBOLS: 'Evite usar símbolos como llamadas a la acción dentro del texto del enlace, a menos que estén ocultos de las tecnologías de asistencia. Considere eliminar: <strong {C}>%(ERROR)</strong>',
