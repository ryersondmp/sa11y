...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Näpunäide!</strong> Kasutage selget ja ainulaadset lingiteksti, mis kirjeldab lingi sihtkohta, tavaliselt lehe või dokumendi pealkirja.',
    ...
    LINK_SYMBOLS: 'Vältige sümbolite kasutamist tegevuse sooritamise üleskutsetena lingitekstis, välja arvatud juhul, kui need on abitehnoloogiate eest varjatud. Kaaluge nende eemaldamist: <strong {C}>%(ERROR)</strong>',
