...
export default {
  ...
  strings: {
    ...
    CONTRAST_ERROR: 'Teks ini tidak memiliki kontras yang cukup dengan latar belakang. Rasio kontras minimal 4,5:1 untuk teks normal dan 3:1 untuk teks besar. <hr> Rasio kontras adalah <strong {r}>%(RATIO)</strong> untuk teks berikut ini: <strong {r}>%(TEXT)</strong>',
    ...
    CONTRAST_INPUT_ERROR: 'Teks dalam input ini tidak memiliki kontras yang cukup dengan latar belakang. Rasio kontras minimal 4,5:1 untuk teks normal dan 3:1 untuk teks besar. <hr> Rasio kontras: <strong {r}>%(RATIO)</strong>',
  },
};
