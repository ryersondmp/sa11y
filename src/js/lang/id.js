...
export default {
  ...
  strings: {
    ...
    LINK_IMAGE_BAD_ALT_MESSAGE: 'Ekstensi file dalam teks alt ditemukan. Pastikan teks alt menjelaskan tujuan tautan, bukan deskripsi harfiah dari gambar. Hapus: <strong {r}>%(error)</strong>.<hr><strong>Alt text:</strong> %(altText)',
    ...
    LINK_ALT_HAS_BAD_WORD_MESSAGE: 'Ekstensi file dalam teks alt ditemukan. Jika gambar menyampaikan cerita, suasana hati, atau informasi penting - pastikan untuk mendeskripsikan gambar. Hapus: <strong {r}>%(error)</strong>.<hr><strong>Alt text:</strong> %(altText)',
    ...
    LINK_IMAGE_ARIA_HIDDEN: 'Tautan di sekitar gambar memiliki <kode>aria-hidden=&quot;true&quot;</kode> namun masih dapat difokuskan dengan keyboard. Jika Anda bermaksud menyembunyikan tautan yang berlebihan atau duplikat, tambahkan <code>tabindex=&quot;-1&quot;</code> juga.',
    ...
    LABELS_ARIA_LABEL_INPUT_MESSAGE: 'Input memiliki nama yang dapat diakses, meskipun pastikan ada label yang terlihat juga. <hr> Nama yang dapat diakses untuk input ini adalah: <strong>%(sanitizedText)</strong>',
    ...
    EMBED_MISSING_TITLE: 'Konten yang disematkan memerlukan nama yang dapat diakses yang menjelaskan isinya. Berikan atribut <kode>judul</kode> atau <kode>label-aria</kode> yang unik pada elemen <kode>iframe</kode>. Pelajari lebih lanjut tentang <a href="https://dequeuniversity.com/tips/provide-iframe-titles">iFrames.</a>',
