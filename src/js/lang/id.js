...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Tip!</strong> Gunakan teks tautan yang jelas dan unik yang menjelaskan tujuan tautan, biasanya judul halaman atau dokumen.',
    ...
    LINK_SYMBOLS: 'Hindari penggunaan simbol sebagai ajakan untuk bertindak dalam teks tautan kecuali jika mereka disembunyikan dari teknologi bantu. Pertimbangkan untuk menghapus: <strong {C}>%(ERROR)</strong>',
