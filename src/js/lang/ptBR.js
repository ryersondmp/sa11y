...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Dica!</strong> Use um texto de link claro e único que descreva o destino do link, normalmente o título da página ou documento.',
    ...
    LINK_SYMBOLS: 'Evite usar símbolos como chamadas para ação no texto do link, a menos que estejam ocultos para tecnologias assistivas. Considere removê-los: <strong {C}>%(ERROR)</strong>',
