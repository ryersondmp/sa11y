...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Tip!</strong> Používajte jasný a jedinečný text odkazu, ktorý opisuje cieľ odkazu, zvyčajne názov stránky alebo dokumentu.',
    ...
    LINK_SYMBOLS: 'Vyhnite sa používaniu symbolov ako výzvy na akciu v texte odkazu, pokiaľ nie sú skryté pred asistenčnými technológiami. Zvážte ich odstránenie: <strong {C}>%(ERROR)</strong>',
