export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Astuce !</strong> Utilisez un texte de lien clair et unique qui décrit la destination du lien, généralement le titre de la page ou du document.',
    ...
    LINK_SYMBOLS: 'Évitez d’utiliser des symboles comme appels à l’action dans le texte du lien, sauf s’ils sont masqués pour les technologies d’assistance. Envisagez de supprimer : <strong {C}>%(ERROR)</strong>',
