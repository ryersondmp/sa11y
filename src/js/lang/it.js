...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Consiglio!</strong> Usa un testo del link chiaro e unico che descriva la destinazione del link, tipicamente il titolo della pagina o del documento.',
    ...
    LINK_SYMBOLS: 'Evita di usare simboli come inviti all’azione all’interno del testo del link a meno che non siano nascosti alle tecnologie assistive. Considera di rimuoverli: <strong {C}>%(ERROR)</strong>',
