...
export default {
  ...
  strings: {
    ...
    LINK_IDENTICAL_NAME: 'Linket har samme tekst som et andet link, selvom det peger på en anden side. Flere links med samme tekst kan skabe forvirring for folk, der bruger skærmlæsere. <hr> Overvej at gøre følgende link mere beskrivende for at hjælpe med at skelne det fra andre links: <strong {C}>%(TEXT)</strong>',
    ...
    LABELS_ARIA_LABEL_INPUT: 'Input har et tilgængeligt navn, men sørg for, at der også er en synlig label. <hr> <strong {B}>Indtastningsmærke</strong> <strong {C}>%(TEXT)</strong>',
    ...
    QA_DUPLICATE_ID: 'Fandt <strong>duplikat-ID</strong>. Fejl med dublerede ID\'er er kendt for at give problemer for hjælpeteknologier, når de forsøger at interagere med indhold. <hr> Fjern eller ændr venligst følgende ID: <strong {C}>%(id)</strong>',
    ...
    QA_UNCONTAINED_LI: 'Alle <code>&lt;li&gt;</code> listeelementer skal placeres inde i <code>&lt;ul&gt;</code> uordnede eller <code>&lt;ol&gt;</code> ordnede elementer. Denne struktur hjælper skærmlæsere med at annoncere listen og dens elementer nøjagtigt.',
    QA_META_SCALABLE: 'Fjern parameteren <code>user-scalable="no"</code> i <code>&lt;meta name="viewport"&gt;</code> elementet for at tillade zoomning.',
    QA_META_MAX: 'Sørg for, at <code>maximum-scale</code> parameteren i <code>&lt;meta name="viewport"&gt;</code> elementet ikke er mindre end 2.',
    QA_JUSTIFY: 'Undgå at bruge retfærdiggjort tekst, som er justeret både til venstre og højre margen. Dette kan være svært for nogle personer at læse på grund af de ujævne mellemrum mellem ordene. Brug venstrejusteret tekst for bedre læsbarhed.',
