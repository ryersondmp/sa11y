...
export default {
  ...
  strings: {
    ...
    CONTRAST_ERROR: 'Denne tekst har ikke nok kontrast til baggrunden. Kontrastforholdet skal være mindst 4,5:1 for normal tekst og 3:1 for stor tekst. <hr> <strong {eb}>Kontrastforhold</strong> <strong {eb}>%(RATIO)</strong> <strong {r}>%(TEXT)</strong>',
    ...
    CONTRAST_INPUT_ERROR: 'Teksten i dette input har ikke nok kontrast til baggrunden. Kontrastforholdet skal være mindst 4,5:1 for normal tekst og 3:1 for stor tekst. <hr> <strong {eb}>Kontrastforhold</strong> <strong {eb}>%(RATIO)</strong>',
  },
};
