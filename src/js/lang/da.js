...
export default {
  ...
  strings: {
    ...
    LINK_IMAGE_BAD_ALT_MESSAGE: 'Filtypenavn i alt-teksten fundet. Sørg for, at alt-teksten beskriver linkets destination, ikke en bogstavelig beskrivelse af billedet. Fjern: <strong {r}>%(error)</strong>.<hr><strong>Alt text:</strong> %(altText)',
    ...
    LINK_ALT_HAS_BAD_WORD_MESSAGE: 'Filtypenavn i den fundne alt-tekst. Hvis billedet formidler en historie, en stemning eller vigtig information - så sørg for at beskrive billedet. Fjern det: <strong {r}>%(error)</strong>.<hr><strong>Alt text:</strong> %(altText)',
    ...
    LINK_IMAGE_ARIA_HIDDEN: 'Linket omkring billedet har <code>aria-hidden=&quot;true&quot;</code>, men er stadig tastaturfokuserbart. Hvis du har til hensigt at skjule et overflødigt eller duplikeret link, skal du også tilføje <code>tabindex=&quot;-1&quot;</code>.',
    ...
    LABELS_ARIA_LABEL_INPUT_MESSAGE: 'Input har et tilgængeligt navn, men sørg for, at der også er en synlig label. <hr> Det tilgængelige navn for dette input er: <strong>%(sanitizedText)</strong>',
    ...
    EMBED_MISSING_TITLE: 'Indlejret indhold kræver et tilgængeligt navn, der beskriver dets indhold. Angiv venligst en unik <code>title</code> eller <code>aria-label</code> attribut på <code>iframe</code>-elementet. Få mere at vide om <a href="https://dequeuniversity.com/tips/provide-iframe-titles">iFrames.</a>',
