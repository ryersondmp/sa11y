...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Tip!</strong> Brug tydelig og unik linktekst, der beskriver destinationen for linket, typisk siden eller dokumentets titel.',
    ...
    LINK_SYMBOLS: 'Undgå at bruge symboler som opfordringer til handling i linktekst, medmindre de er skjult for hjælpeværktøjer. Overvej at fjerne: <strong {C}>%(ERROR)</strong>',
