...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Padoms!</strong> Izmantojiet skaidru un unikālu saites tekstu, kas apraksta saites galamērķi, parasti lapas vai dokumenta nosaukumu.',
    ...
    LINK_SYMBOLS: 'Izvairieties no simbolu izmantošanas kā darbības aicinājumiem saites tekstā, ja tie nav slēpti no palīgtehnoloģijām. Apsveriet to noņemšanu: <strong {C}>%(ERROR)</strong>',
