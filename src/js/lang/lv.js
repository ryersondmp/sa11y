...
export default {
  ...
  strings: {
    ...
    ACC_NAME: '<strong {B}>Saites etiķete</strong> %(TEXT)',
    ...
    BTN_EMPTY: 'Pogai trūkst pieejama nosaukuma, kas apraksta tās mērķi. Uzziniet, kā izveidot <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">pieejamu pogu.</a>',
    BTN_EMPTY_LABELLEDBY: 'Pogai ir <code>aria-labelledby</code> vērtība, kas ir tukša vai nesakrīt ar cita elementa <code>id</code> vērtību lapā.',
    ...
    PAGE_LANG: 'Lapas valoda nav deklarēta! Lūdzu, <a href="https://www.w3.org/International/questions/qa-html-language-declarations">deklarējiet valodu HTML tagā.</a>',
