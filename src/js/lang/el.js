...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>Συμβουλή!</strong> Χρησιμοποιήστε σαφές και μοναδικό κείμενο συνδέσμου που περιγράφει τον προορισμό του συνδέσμου, συνήθως τον τίτλο της σελίδας ή του εγγράφου.',
    ...
    LINK_SYMBOLS: 'Αποφύγετε τη χρήση συμβόλων ως προτροπές ενέργειας στο κείμενο συνδέσμων, εκτός εάν είναι κρυμμένα από βοηθητικές τεχνολογίες. Εξετάστε την αφαίρεση: <strong {C}>%(ERROR)</strong>',
    ...
    CONTRAST_ERROR_GRAPHIC: 'Το γραφικό δεν έχει επαρκή αντίθεση με το φόντο, καθιστώντας το δύσκολο να γίνει αντιληπτό.',
