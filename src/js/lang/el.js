...
export default {
  ...
  strings: {
    ...
    // Contrast
    CONTRAST_OPACITY: 'Αυξήστε την αδιαφάνεια του κειμένου για καλύτερη ορατότητα:',
    CONTRAST_APCA: 'Αυτό δεν είναι αρκετός αντίκτυπος για οποιοδήποτε μέγεθος κειμένου. Σκεφτείτε να χρησιμοποιήσετε αυτόν τον συνδυασμό χρώματος και μεγέθους κειμένου;',
    CONTRAST_COLOR: 'Σκεφτείτε να χρησιμοποιήσετε αυτό το χρώμα αντί;',
    CONTRAST_SIZE: 'Σκεφτείτε να κάνετε το μέγεθος του κειμένου μεγαλύτερο για αυτόν τον συνδυασμό χρωμάτων;',
    ...
    CONTRAST_WARNING: 'Η αντίθεση αυτού του κειμένου είναι άγνωστη και χρειάζεται να ελεγχθεί χειροκίνητα. Βεβαιωθείτε ότι το κείμενο και το φόντο έχουν ισχυρή αντίθεση χρωμάτων. <hr> <strong {B}>Αντίθεση</strong> <strong {B}>Άγνωστη</strong> <strong {C}>%(TEXT)</strong>',
    WCAG_ADVICE: 'Η αναλογία αντίθεσης πρέπει να είναι τουλάχιστον 4.5:1 για το κανονικό κείμενο και 3:1 για το μεγάλο κείμενο.',
    APCA_ADVICE: 'Η τιμή της αντίθεσης πρέπει να είναι τουλάχιστον 60 για το κύριο κείμενο και 45 για το μεγάλο κείμενο.',
