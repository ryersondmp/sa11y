...
export default {
  ...
  strings: {
    ...
    LINK_STOPWORD_TIP: '<hr> <strong>İpucu!</strong> Bağlantının amacını tanımlayan, genellikle sayfa veya belge başlığı olan açık ve benzersiz bağlantı metni kullanın.',
    ...
    LINK_SYMBOLS: 'Bağlantı metninde sembollerle harekete geçme çağrılarını kullanmaktan kaçının, bunlar yardım teknolojilerinden gizlenmedikçe. Bunları kaldırmayı düşünün: <strong {C}>%(ERROR)</strong>',
