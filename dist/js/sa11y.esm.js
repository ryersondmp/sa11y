      ...
      if (!checkRunPrevent()) {
        ...
        documentLoadingCheck(() => {
          if (option.headless) {
            ...
            if (Constants.Global.showMovePanelToggle && store.getItem('sa11y-position') === null) {
