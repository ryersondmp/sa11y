      ...
      if (!checkRunPrevent()) {
        ...
        documentLoadingCheck(() => {
          if (option.headless) {
            ...
            if (Constants.Global.panelPositionToggle && store.getItem('sa11y-position') === null) {
