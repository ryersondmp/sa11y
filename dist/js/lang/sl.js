...
var sl = {
  ...
  strings: {
    ...
    CONTRAST_ERROR: 'Besedilo ni dovolj kontrastno glede na ozadje. Kontrastno razmerje bi moralo biti vsaj 4,5:1 za običajno besedilo in 3:1 za veliko besedilo. <hr> Kontrastno razmerje je <strong {r}>%(RATIO)</strong> za naslednje besedilo: <strong {r}>%(TEXT)</strong>',
    ...
    CONTRAST_INPUT_ERROR: 'Besedilo v tem vnosu ni dovolj kontrastno z ozadjem. Kontrastno razmerje mora biti vsaj 4,5 : 1 za običajno besedilo in 3 : 1 za veliko besedilo. <hr> Kontrastno razmerje: <strong {r}>%(RATIO)</strong>',
  },
};
