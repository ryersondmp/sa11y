...
(function (global, factory) {
  ...
  var it = {
    ...
    strings: {
      ...
      CONTRAST_ERROR: 'Il testo non ha un contrasto sufficiente con lo sfondo. Il rapporto di contrasto dovrebbe essere almeno 4,5:1 per il testo normale e 3:1 per il testo grande. <hr> Il rapporto di contrasto è <strong {r}>%(RATIO)</strong> per il seguente testo: <strong {r}>%(TEXT)</strong>',
      ...
      CONTRAST_INPUT_ERROR: 'Il testo all\'interno di questo input non ha un contrasto sufficiente con lo sfondo. Il rapporto di contrasto dovrebbe essere di almeno 4,5:1 per il testo normale e di 3:1 per il testo grande. <hr> Rapporto di contrasto: <strong {r}>%(RATIO)</strong>',
    },
  };
