...
(function (global, factory) {
  ...
  var it = {
    ...
    strings: {
      ...
      // Headings
      HEADING_SKIPPED_LEVEL: 'È stato utilizzato un livello di intestazione non consecutivo. I titoli non devono mai saltare livelli o passare da <strong>Heading %(prevLevel)</strong> a <strong {C}>Heading %(level)</strong>.',
      ...
      LINK_STOPWORD: 'Il testo del link potrebbe non essere abbastanza descrittivo fuori dal contesto: <strong {C}>%(ERROR)</strong> <hr> <strong>Tip!</strong> Il testo del link deve essere sempre chiaro, unico e significativo. Evitate parole comuni come &quot;clicca qui&quot; o &quot;per saperne di più&quot;',
