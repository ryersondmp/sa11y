...
var en = {
  ...
  strings: {
    ...
    LINK_IMAGE_ALT_WARNING: 'Image link contains alt text. Does the alt text describe where the link takes you? <strong>Consider using the title of the page it links to as the alt text.</strong> <hr> {ALT} {L} <strong {W}>%(ALT_TEXT)</strong>',
    LINK_IMAGE_ALT_AND_TEXT_WARNING: 'Image link contains <strong>both alt text and surrounding link text.</strong> If this image is decorative and is being used as a functional link to another page, consider marking the image as decorative. The surrounding link text should suffice. <hr> {ALT} <strong {W}>%(ALT_TEXT)</strong> <hr> <strong {B}>Label</strong> {L} <strong {W}>%(TEXT)</strong>',
    ...
    LABELS_ARIA_LABEL_INPUT_MESSAGE: 'Input has an accessible name, although please ensure there is a visible label too. <hr> <strong {B}>Input label</strong> <strong {W}>%(TEXT)</strong>',
