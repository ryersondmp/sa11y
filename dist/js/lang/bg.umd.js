...
(function (global, factory) {
  ...
  var bg = {
    ...
    strings: {
      ...
      ACC_NAME: '<strong>Етикет на връзката:</strong> %(TEXT)',
      ...
      BTN_EMPTY: 'Бутонът липсва достъпно име, което описва неговата цел. Научете как да създадете <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">достъпен бутон.</a>',
      BTN_EMPTY_LABELLEDBY: 'Бутонът има стойност <code>aria-labelledby</code>, която е празна или не съвпада със стойността на <code>id</code> на друг елемент в страницата.',
      ...
      PAGE_LANG: 'Езикът на страницата не е обявен! Моля, <a href="https://www.w3.org/International/questions/qa-html-language-declarations">декларирайте езика в HTML тага.</a>',
      ...
      DUPLICATE_ID: 'Намерен е <strong>дубликат на ID</strong>. Известно е, че грешките с дублиращи се идентификатори причиняват проблеми на помощните технологии, когато те се опитват да взаимодействат със съдържанието. <hr> Моля, премахнете или променете следния ID: <strong {C}>%(id)</strong>',
      ...
      QA_JUSTIFY: 'Избягвайте използването на оправен текст, който се подравнява както с левия, така и с десния ръб. Това може да бъде трудно за четене за някои хора поради неравномерното разстояние между думите. Използвайте текст, подравнен наляво, за по-добра четимост.',
