...
(function (global, factory) {
  ...
  var bg = {
    ...
    strings: {
      ...
      CONTRAST_ERROR: 'Този текст не контрастира достатъчно с фона. Контрастното съотношение трябва да бъде поне 4,5:1 за нормален текст и 3:1 за голям текст. <hr> Съотношението на контраста е <strong {r}>%(RATIO)</strong> за следния текст: <strong {r}%(TEXT)</strong>',
      ...
      CONTRAST_INPUT_ERROR: 'Текстът в този вход не контрастира достатъчно с фона. Съотношението на контраста трябва да е поне 4,5:1 за нормален текст и 3:1 за голям текст. <hr> Контрастно съотношение: <strong {r}>%(RATIO)</strong>',
    },
  };
