...
var fr = {
  ...
  strings: {
    ...
    ACC_NAME: '<strong {B}>Lien de l’étiquette</strong> %(TEXT)',
    ...
    // Buttons
    BTN_EMPTY: 'Le bouton ne possède pas de nom accessible qui décrit son utilité. Apprenez à créer un <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">bouton accessible.</a>',
    ...
    PAGE_LANG: 'La langue de la page n’est pas indiquée! Veuillez <a href="https://www.w3.org/International/questions/qa-html-language-declarations.fr">indiquer la langue sur la balise HTML.</a>',
