...
var cs = {
  ...
  strings: {
    ...
    CONTRAST_ERROR: 'Tento text není dostatečně kontrastní s pozadím. Kontrastní poměr by měl být alespoň 4,5:1 pro normální text a 3:1 pro velký text. <hr> Pro následující text je kontrastní poměr <strong {r}>%(RATIO)</strong>: <strong {r}>%(TEXT)</strong>',
    ...
    CONTRAST_INPUT_ERROR: 'Text v tomto vstupu není dostatečně kontrastní s pozadím. Kontrastní poměr by měl být alespoň 4,5:1 pro normální text a 3:1 pro velký text. <hr> Kontrastní poměr: <strong {r}>%(RATIO)</strong>.',
  },
};
