...
(function (global, factory) {
  ...
  var ua = {
    ...
    strings: {
      ...
      // Contrast
      CONTRAST_OPACITY: 'Збільшіть непрозорість тексту для кращої видимості:',
      CONTRAST_APCA: 'Цього недостатньо для контрасту будь-якого розміру тексту. Розгляньте можливість використання цієї комбінації кольору та розміру тексту?',
      CONTRAST_COLOR: 'Розгляньте можливість використання цього кольору замість?',
      CONTRAST_SIZE: 'Розгляньте можливість збільшення розміру тексту для цієї кольорової комбінації?',
      ...
      CONTRAST_WARNING: 'Контрастність цього тексту не встановлена і потребує перевірки вручну. Переконайтеся, що текст і фон мають різко контрастні кольори. Коефіцієнт контрастності має бути не менше 4,5:1 для звичайного тексту та 3:1 для великого тексту. <hr> <strong {B}>Співвідношення контрасту</strong> <strong {B}>Невідомо</strong> <strong {C}>%(TEXT)</strong>',
