...
(function (global, factory) {
  ...
  var enUS = {
    ...
    strings: {
      ...
      LINK_ALT_FILE_EXT: 'File extension within the alt text found. Ensure the alt text describes the destination of the link, not a literal description of the image. Remove: <strong {R}>%(ERROR)</strong> <hr> {ALT} {L} <strong {W}>%(ALT_TEXT)</strong>',
