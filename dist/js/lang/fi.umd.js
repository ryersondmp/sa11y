...
(function (global, factory) {
  ...
  var fi = {
    ...
    strings: {
      ...
      CONTRAST_ERROR: 'Tässä tekstissä ei ole riittävästi kontrastia taustaan nähden. Kontrastisuhteen tulisi olla vähintään 4,5:1 normaalille tekstille ja 3:1 suurelle tekstille. <hr> Kontrastisuhde on <strong {r}>%(RATIO)</strong> seuraavalle tekstille: <strong {r}>%(TEXT)</strong>',
      ...
      CONTRAST_INPUT_ERROR: 'Tekstin kontrasti taustaan nähden ei ole riittävä. Kontrastisuhteen tulisi olla vähintään 4,5:1 normaalille tekstille ja 3:1 suurelle tekstille. <hr> Kontrastisuhde: <strong {r}>%(RATIO)</strong>',
    },
  };
