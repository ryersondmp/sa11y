...
var sk = {
  ...
  strings: {
    ...
    QA_DUPLICATE_ID: 'Nájdené <strong>duplicitné ID</strong>. Je známe, že chyby duplicitného ID spôsobujú problémy asistenčným technológiám pri pokusoch o interakciu s obsahom. <hr> Odstráňte alebo zmeňte nasledujúce ID: <strong {C}>%(id)</strong>',
    ...
    QA_UNCONTAINED_LI: 'Všetky položky zoznamu <code>&lt;li&gt;</code> musia byť umiestnené vo vnútri <code>&lt;ul&gt;</code> neusporiadaných alebo <code>&lt;ol&gt;</code> usporiadaných prvkov. Táto štruktúra pomáha čítačkám obrazovky presne oznamovať zoznam a jeho položky.',
    QA_META_SCALABLE: 'Odstráňte parameter <code>user-scalable="no"</code> z prvku <code>&lt;meta name="viewport"&gt;</code>, aby sa umožnilo priblíženie.',
    QA_META_MAX: 'Uistite sa, že parameter <code>maximum-scale</code> v prvku <code>&lt;meta name="viewport"&gt;</code> nie je menší ako 2.',
