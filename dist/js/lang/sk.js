...
var sk = {
  ...
  strings: {
    ...
    LINK_ALT_HAS_FILE_EXTENSION: 'Nájdená prípona súboru v texte alt. Uistite sa, že text alt opisuje cieľ odkazu, nie doslovný opis obrázka. Odstráňte: <strong {r}>%(error)</strong>.<hr><strong>Textu alt:</strong> %(altText)',
    ...
    ALT_HAS_FILE_EXTENSION: 'Nájdená prípona súboru v texte alt. Ak obrázok vyjadruje príbeh, náladu alebo dôležitú informáciu, nezabudnite ho opísať. Odstráňte: <strong {r}>%(error)</strong>.<hr><strong>Textu alt:</strong> %(altText)',
    ...
    LABELS_ARIA_LABEL_INPUT_MESSAGE: 'Vstup má prístupný názov, ale dbajte na to, aby bol viditeľný aj štítok. <hr> <strong>Štítok vstupu:</strong> %(sanitizedText)',
