...
(function(global, factory) {
    ...
    HEADING_LONG: '¡El título es largo! Los encabezados deben usarse para organizar el contenido y transmitir la estructura. Deben ser breves, informativos y únicos. Mantenga los encabezados de menos de 160 caracteres (no más de una oración) <hr> Número de caracteres: <strong {r}>%(Longitud del encabezado)</strong>',
    ...
    HEADING_EMPTY_WITH_IMAGE: 'El encabezado no tiene texto, pero contiene una imagen. Si no es un encabezado, cambie su formato de <strong {r}>Título %(nivel)</strong> a <strong>Normal</strong> o <strong>Párrafo</strong>. De lo contrario, agregue texto alternativo a la imagen si no es decorativa..',
    ...
    LINK_IMAGE_SUS_ALT_MESSAGE: 'Las tecnologías de asistencia ya indican que se trata de una imagen, por lo que &quot;<strong {r}>%(error)</strong>&quot; puede ser redundante. Asegúrese de que el texto alternativo describa el destino del enlace, no una descripción literal de la imagen. <hr> <strong>Texto alternativo:</strong> %(texto alternativo)',
    ...
    ALT_HAS_SUS_WORD: 'Las tecnologías de asistencia ya indican que se trata de una imagen, por lo que &quot;<strong {r}>%(error)</strong>&quot; puede ser redundante. <hr> <strong>Texto alternativo:</strong> %(texto alternativo)',
    ...
    LINK_IMAGE_LONG_ALT: 'La descripción del texto alternativo en una imagen vinculada es <strong>demasiado larga</strong>. El texto alternativo en las imágenes vinculadas debe describir a dónde lo lleva el enlace, no una descripción literal de la imagen. <strong>Considere usar el título de la página a la que enlaza como texto alternativo.</strong> <hr> <strong>Texto alternativo (<span {r}>%(altLength)</span> caracteres):</ fuerte> %(texto alternativo)',
    LINK_IMAGE_ALT_WARNING: 'El enlace de la imagen contiene texto alternativo, aunque asegúrese de que el texto alternativo describa la página de destino. <strong>Considere usar el título de la página a la que se vincula como texto alternativo.</strong> ¿Describe el texto alternativo a dónde lo lleva el enlace? <hr> <strong>Texto alternativo:</strong> %(texto alternativo)',
    LINK_IMAGE_ALT_AND_TEXT_WARNING: 'El enlace de la imagen contiene <strong>texto alternativo y texto del enlace que la rodea.</strong> Si esta imagen es decorativa y se usa como un enlace funcional a otra página, considere marcar la imagen como decorativa o nula; el texto del enlace que la rodea debería ser suficiente. . <hr> <strong>Texto alternativo:</strong> %(texto alternativo)',
    ...
    QA_PAGE_TITLE: '¡Falta el título de la página! Proporcione un <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/title">título de página</a>.',
