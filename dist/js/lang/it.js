...
var it = {
  ...
  strings: {
    ...
    LINK_ALT_HAS_FILE_EXTENSION: "Estensione del file nel testo alt trovata. Assicurarsi che il testo alt descriva la destinazione del link e non una descrizione letterale dell'immagine. Rimuovere: <strong {r}>%(error)</strong>.<hr><strong>Testo alt:</strong> %(altText)",
    ...
    ALT_HAS_FILE_EXTENSION: "Estensione del file nel testo alt trovato. Se l'immagine trasmette una storia, uno stato d'animo o un'informazione importante, assicuratevi di descrivere l'immagine. Rimuovere: <strong {r}>%(error)</strong>.<hr><strong>Testo alt:</strong> %(altText)",
    ...
    LABELS_ARIA_LABEL_INPUT_MESSAGE: "L'input ha un nome accessibile, anche se bisogna assicurarsi che ci sia anche un'etichetta visibile. <hr> <strong>Etichetta input:</strong> %(sanitizedText)",
