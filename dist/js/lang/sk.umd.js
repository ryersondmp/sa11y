...
(function (global, factory) {
  ...
  var sk = {
    ...
    strings: {
      ...
      CONTRAST_ERROR: 'Tento text nie je dostatočne kontrastný s pozadím. Kontrastný pomer by mal byť aspoň 4,5:1 pre normálny text a 3:1 pre veľký text. <hr> Kontrastný pomer je <strong {r}>%(RATIO)</strong> pre nasledujúci text: <strong {r}>%(TEXT)</strong>',
      ...
      CONTRAST_INPUT_ERROR: 'Text v tomto vstupe nie je dostatočne kontrastný s pozadím. Kontrastný pomer by mal byť aspoň 4,5:1 pre normálny text a 3:1 pre veľký text. <hr> Kontrastný pomer: <strong {r}>%(RATIO)</strong>',
    },
  };
