...
(function (global, factory) {
  ...
  var sk = {
    ...
    strings: {
      ...
      MOVE_LEFT: 'Presunúť panel doľava',
      MOVE_RIGHT: 'Presunúť panel doprava',
      ...
      CONTRAST_SIZE: 'Zvážte zvýšenie veľkosti textu pre túto kombináciu farieb?',
      CONTRAST_PLACEHOLDER: 'Text v tomto políčku pre zadávanie nie je dostatočne kontrastný s pozadím, čo sťažuje jeho čítanie.',
      CONTRAST_INPUT: 'Text v tomto políčku pre zadávanie nie je dostatočne kontrastný s pozadím, čo sťažuje jeho čítanie.',
      CONTRAST: 'Kontrast',
      UNKNOWN: 'Neznámy',
      LARGE_TEXT: 'Veľký text',
      BODY_TEXT: 'Telo textu',
      FG: 'Predné pozadie',
      BG: 'Pozadie',
      NON_TEXT: 'Ne-tekst',
    },
