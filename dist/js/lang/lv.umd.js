...
(function (global, factory) {
  ...
  var lv = {
    ...
    strings: {
      ...
      CONTRAST_ERROR: 'Šis teksts nav pietiekami kontrastējošs ar fonu. Kontrasta attiecībai jābūt vismaz 4,5:1 parastam tekstam un 3:1 lielam tekstam. <hr> Kontrasta attiecība ir <strong {r}>%(RATIO)</strong> šādam tekstam: <strong {r}>%(TEXT)</strong>',
      ...
      CONTRAST_INPUT_ERROR: 'Teksts šajā ievades laukā nav pietiekami kontrastējošs ar fonu. Kontrasta attiecībai jābūt vismaz 4,5:1 parastam tekstam un 3:1 lielam tekstam. <hr> Kontrasta attiecība: <strong {r}>%(RATIO)</strong>',
    },
  };
