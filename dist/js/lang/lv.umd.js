...
(function (global, factory) {
  ...
  var lv = {
    ...
    strings: {
      ...
      MOVE_LEFT: 'Pārvietot paneli pa kreisi',
      MOVE_RIGHT: 'Pārvietot paneli pa labi',
      ...
      CONTRAST_COLOR: 'Apsveriet iespēju izmantot šo krāsu vietā?',
      CONTRAST_SIZE: 'Apsveriet iespēju palielināt teksta izmēru šai krāsu kombinācijai?',
      CONTRAST_PLACEHOLDER: 'Aizvietotājteksts šajā ievades laukā nav pietiekami kontrastējošs ar fonu, padarot to grūti nolasāmu.',
      CONTRAST_INPUT: 'Teksts šajā ievades laukā nav pietiekami kontrastējošs ar fonu, padarot to grūti nolasāmu.',
      CONTRAST: 'Kontrasts',
      UNKNOWN: 'Nezināms',
      LARGE_TEXT: 'Liels teksts',
      BODY_TEXT: 'Teksta saturs',
      FG: 'Priekšplāns',
      BG: 'Fons',
      NON_TEXT: 'Ne-teksts',
    },
