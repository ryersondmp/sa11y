...
var lv = {
  ...
  strings: {
    ...
    LINK_URL: 'Garākus, mazāk saprotamus URL, kas izmantoti kā saite teksts, var būt grūti uzklausīt, izmantojot palīgtehnoloģijas. Vairumā gadījumu URL vietā ir labāk izmantot cilvēkam saprotamu tekstu. Īsi URL (piemēram, vietnes sākumlapa) ir piemēroti.<hr><strong>Padoms!</strong> Saites tekstam vienmēr jābūt skaidram, unikālam un jēgpilnam, lai to varētu saprast arī ārpus konteksta.',
    ...
    LINK_IMAGE_BAD_ALT_MESSAGE: 'Atrasts faila paplašinājums alt tekstā. Pārliecinieties, ka alt teksts apraksta saites galamērķi, nevis burtisku attēla aprakstu. Noņemt: <strong {r}>%(error)</strong>.<hr><strong>Alt teksts:</strong> %(altText)',
    ...
    LINK_ALT_HAS_BAD_WORD_MESSAGE: 'Atrasts faila paplašinājums alt tekstā. Ja attēls ir stāsts, noskaņa vai svarīga informācija, noteikti aprakstiet attēlu. Noņemt: <strong {r}>%(error)</strong>.<hr><strong>Alt teksts:</strong> %(altText)',
    ...
    LINK_IMAGE_ARIA_HIDDEN: 'Saitei ap attēlu ir <code>aria-hidden=&quot;true&quot;</code>, bet tā joprojām ir fokusējama no tastatūras. Ja vēlaties paslēpt lieku vai dublējošu saiti, pievienojiet arī <code>tabindex=&quot;-1&quot;</code>.',
    ...
    LABELS_ARIA_LABEL_INPUT_MESSAGE: 'Ievadei ir pieejams nosaukums, tomēr pārliecinieties, ka ir redzams arī marķējums. <hr> Šī ievades pieejamais nosaukums ir: <strong>%(sanitizedText)</strong>.',
