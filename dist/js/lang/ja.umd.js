...
(function (global, factory) {
  ...
  var ja = {
    ...
    strings: {
      ...
      // Contrast
      CONTRAST_ERROR: 'このテキストは背景との対比が不足しています。通常のテキストには対比比率が少なくとも4.5:1、大きなテキストには3:1以上である必要があります。<hr> 以下のテキストの対比比率は<strong {r}>%(RATIO)</strong>です：<strong {r}>%(TEXT)</strong>',
      ...
      CONTRAST_INPUT_ERROR: 'この入力内のテキストは背景との対比が不足しています。通常のテキストには対比比率が少なくとも4.5:1、大きなテキストには3:1以上である必要があります。<hr> 対比比率：<strong {r}>%(RATIO)</strong>',
    },
  };
