...
var ro = {
  ...
  strings: {
    ...
    LINK_IMAGE_BAD_ALT_MESSAGE: 'Extensia fișierului din textul alternativ găsit. Asigurați-vă că textul alternativ descrie destinația linkului și nu o descriere literală a imaginii. Eliminați: <strong {r}>%(eroare)</strong>.<hr><strong>Text alternativ:</strong> %(altText)',
    ...
    LINK_ALT_HAS_BAD_WORD_MESSAGE: 'Extensia fișierului din textul alternativ găsit. Dacă imaginea transmite o poveste, o stare de spirit sau o informație importantă, nu uitați să descrieți imaginea. Eliminați: <strong {r}>%(error)</strong>.<hr><strong>Text alternativ:</strong> %(altText)',
    ...
    LINK_IMAGE_ARIA_HIDDEN: 'Legătura din jurul imaginii are <code>aria-hidden=&quot;true&quot;</code>, dar este în continuare focalizabilă de la tastatură. Dacă intenționați să ascundeți un link redundant sau duplicat, adăugați și <code>tabindex=&quot;-1&quot;</code>.',
    ...
    LABELS_ARIA_LABEL_INPUT_MESSAGE: 'Intrarea are un nume accesibil, deși vă rugăm să vă asigurați că există și o etichetă vizibilă. <hr> Numele accesibil pentru această intrare este: <strong>%(sanitizedText)</strong>.',
