...
var nl = {
  ...
  strings: {
    ...
    CONTRAST_ERROR: 'Deze tekst heeft niet genoeg contrast met de achtergrond. De contrastverhouding moet ten minste 4,5:1 zijn voor normale tekst en 3:1 voor grote tekst. <hr> De contrastverhouding is <strong {r}>%(RATIO)</strong> voor de volgende tekst: <strong {r}>%(TEXT)</strong>',
    ...
    CONTRAST_INPUT_ERROR: 'Tekst binnen deze invoer heeft niet genoeg contrast met de achtergrond. De contrastverhouding moet ten minste 4,5:1 zijn voor normale tekst en 3:1 voor grote tekst. <hr> Contrastverhouding: <strong {r}>%(RATIO)</strong>',
  },
};
