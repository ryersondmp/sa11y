...
var tr = {
  ...
  strings: {
    ...
    CONTRAST_ERROR: "Bu metin arka planla yeterli kontrasta sahip değil. Kontrast oranı normal metin için en az 4,5:1 ve büyük metin için 3:1 olmalıdır. <hr> Aşağıdaki metin için kontrast oranı <strong {r}>%(RATIO)</strong>'dur: <strong {r}>%(TEXT)</strong>",
    ...
    CONTRAST_INPUT_ERROR: 'Bu girişteki metin arka planla yeterli kontrasta sahip değil. Kontrast oranı normal metin için en az 4,5:1 ve büyük metin için 3:1 olmalıdır. <hr> Kontrast oranı: <strong {r}>%(RATIO)</strong>',
  },
};
