...
(function (global, factory) {
  ...
  var hu = {
    ...
    strings: {
      ...
      ACC_NAME: '<strong {B}>Link címke</strong> %(TEXT)',
      ...
      BTN_EMPTY: 'A gombnak nincs olyan hozzáférhető neve, amely leírná a célját. Tanulja meg, hogyan készíthet egy <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">hozzáférhető gombot.</a>',
      BTN_EMPTY_LABELLEDBY: 'A gomb <code>aria-labelledby</code> értéke üres, vagy nem egyezik meg az oldal másik elemének <code>id</code> értékével.',
      ...
      PAGE_LANG: 'Az oldal nyelve nincs megadva! Kérjük, <a href="https://www.w3.org/International/questions/qa-html-language-declarations">declare language on HTML tag.</a>',
