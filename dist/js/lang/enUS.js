...
var enUS = {
  ...
  strings: {
    ...
    LINK_ALT_HAS_FILE_EXTENSION: 'File extension within the alt text found. Ensure the alt text describes the destination of the link, not a literal description of the image. Remove: <strong {r}>%(ERROR)</strong>.<hr> <strong {b}>ALT</strong> <strong {w}>%(ALT_TEXT)</strong>',
    ...
    ALT_HAS_SUS_WORD: 'Assistive technologies already indicate that this is an image, so &quot;<strong {r}>%(ERROR)</strong>&quot; may be redundant. <hr> <strong {wb}>ALT</strong> <strong {w}>%(ALT_TEXT)</strong>',
    ...
    LINK_IMAGE_ALT_AND_TEXT_WARNING: 'Image link contains <strong>both alt text and surrounding link text.</strong> If this image is decorative and is being used as a functional link to another page, consider marking the image as decorative. The surrounding link text should suffice. <hr> <strong {b}>ALT</strong> %(ALT_TEXT) <hr> <strong {wb}>Label</strong> <strong {w}>%(TEXT)</strong>',
