...
var enUS = {
  ...
  strings: {
    ...
    LINK_IMAGE_ALT_AND_TEXT_WARNING: 'Image link contains <strong>both alt text and surrounding link text.</strong> If this image is decorative and is being used as a functional link to another page, consider marking the image as decorative. The surrounding link text should suffice. <hr> {ALT} %(ALT_TEXT) <hr> <strong {B}>Label</strong> {L} <strong {W}>%(TEXT)</strong>',
