...
(function (global, factory) {
  ...
  var ptBR = {
    ...
    strings: {
      ...
      // Headings
      HEADING_SKIPPED_LEVEL: 'Nível de cabeçalho não consecutivo usado. Os cabeçalhos nunca devem pular níveis ou ir de <strong>Cabeçalho %(prevLevel)</strong> para <strong {C}>Cabeçalho %(level)</strong>.',
      ...
      // QA
      QA_BAD_LINK: 'Encontrado link incorreto. O link parece apontar para um ambiente de desenvolvimento. <hr> Esse link aponta para: <br> <strong {C}>%(LINK)</strong>',
