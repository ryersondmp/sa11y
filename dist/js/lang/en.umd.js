(function (global, factory) {
  ...
  var en = {
    ...
    strings: {
      ...
      QA_FAKE_HEADING: 'Is this a heading? <strong {r}>%(boldtext)</strong> A line of bold text might look like a heading, but someone using a screen reader cannot tell that it is important or jump to its content. Bolded text should never replace semantic headings (Heading 2 to Heading 6).',
