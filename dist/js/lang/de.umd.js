...
(function (global, factory) {
  ...
  var de = {
    ...
    strings: {
      ...
      ACC_NAME: '<strong {B}>Link Label</strong> %(TEXT)',
      ...
      // Buttons
      BTN_EMPTY: 'Der Schaltfläche fehlt ein zugänglicher Name, der ihren Zweck beschreibt. Erfahren Sie, wie Sie eine <a href="https://www.sarasoueidan.com/blog/accessible-icon-buttons/">zugängliche Schaltfläche</a> erstellen.',
      ...
      PAGE_LANG: 'Seitensprache nicht angegeben! Bitte <a href="https://www.w3.org/International/questions/qa-html-language-declarations">deklariere die Sprache im HTML-Tag.</a>',
