...
(function (global, factory) {
  ...
  var de = {
    ...
    strings: {
      ...
      LABELS_ARIA_LABEL_INPUT_MESSAGE: 'Die Eingabe hat einen zugänglichen Namen, stelle bitte trotzdem sicher, dass es auch ein sichtbares Label gibt. <hr> Der zugängliche Name für diese Eingabe lautet: <strong>%(sanitizedText)</strong>',
