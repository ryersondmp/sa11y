...
function ma(t, e, n) {
  const s = () => {
    ...
    e.forEach((i, a) => {
      ...
      if (g) {
        const D = ft(d, "display", "none"), _ = document.createElement("sa11y-image-anchor");
        _.setAttribute("data-sa11y-parent", `image${a}`), (D?.previousElementSibling || D?.parentNode)?.insertAdjacentElement("beforebegin", _);
      } else
...
function Pn(t) {
  ...
  if (p) {
    ...
    if (I === ee(n) && (I = Se(n), Le(I).position !== "static" && l === "absolute" && (S = "scrollHeight", C = "scrollWidth")), I = I, r === J || (r === Z || r === oe) && i === ct) {
      h = re;
      var D = c && I === x && x.visualViewport ? x.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        I[S]
      );
...
function dt(t, e) {
  ...
  var n = e, s = n.placement, r = s === void 0 ? t.placement : s, i = n.strategy, a = i === void 0 ? t.strategy : i, l = n.boundary, d = l === void 0 ? ya : l, p = n.rootBoundary, o = p === void 0 ? rs : p, c = n.elementContext, m = c === void 0 ? nt : c, g = n.altBoundary, A = g === void 0 ? !1 : g, y = n.padding, b = y === void 0 ? 0 : y, E = us(typeof b != "number" ? b : fs(b, mt)), v = m === nt ? va : nt, L = t.rects.popper, h = t.elements[A ? v : m], x = Za(De(h) ? h : h.contextElement || Se(t.elements.popper), d, o, a), I = Ve(t.elements.reference), S = gs({
    ...
    element: L,
    placement: r
  }), C = sn(Object.assign({}, L, S)), D = m === nt ? C : I, _ = {
...
function ni(t) {
  ...
  if (!e.modifiersData[s]._skip) {
    ...
    }, []), x = e.rects.reference, I = e.rects.popper, S = /* @__PURE__ */ new Map(), C = !0, D = h[0], _ = 0; _ < h.length; _++) {
...
function ui(t) {
  var e = t.state, n = t.options, s = t.name, r = n.mainAxis, i = r === void 0 ? !0 : r, a = n.altAxis, l = a === void 0 ? !1 : a, d = n.boundary, p = n.rootBoundary, o = n.altBoundary, c = n.padding, m = n.tether, g = m === void 0 ? !0 : m, A = n.tetherOffset, y = A === void 0 ? 0 : A, b = dt(e, {
    ...
    padding: c,
    altBoundary: o
  }), E = he(e.placement), v = Ye(e.placement), L = !v, h = hn(E), x = pi(h), I = e.modifiersData.popperOffsets, S = e.rects.reference, C = e.rects.popper, D = typeof y == "function" ? y(Object.assign({}, e.rects, {
    placement: e.placement
  })) : y, _ = typeof D == "number" ? {
    mainAxis: D,
    altAxis: D
    ...
    mainAxis: 0,
    altAxis: 0
  }, D), k = e.modifiersData.offset ? e.modifiersData.offset[e.placement] : null, w = {
    x: 0,
    y: 0
  };
  if (I) {
        ...
        if (!m) {
          ...
          if (Hn(v, L)) {
            ...
            for (var h = 0; h < o.orderedModifiers.length; h++) {
              ...
              var x = o.orderedModifiers[h], I = x.fn, S = x.options, C = S === void 0 ? {} : S, D = x.name;
...
function Ji(t, e, n, s) {
  const i = n == null || s == null, a = pt(e), l = (D, _) => a <= 0.179 ? xs(D, _) : Ns(D, _);
...
function nr(t, e) {
  if (t?.querySelector("#contrast-tools")) {
    const { fontSize: s, fontWeight: r, type: i, isLargeText: a } = e, l = t.querySelector("#contrast"), d = t.querySelector("#contrast-preview"), p = t.querySelector("#fg-input"), o = t.querySelector("#bg-input"), c = t.querySelector("#value"), m = t.querySelector("#good"), g = (b, E) => {
      ...
      if (d.style.color = E, d.style.backgroundColor = v, d.style.backgroundImage = "none", b.target.classList.remove("unknown"), b.target.parentElement.classList.remove("unknown"), p.classList.contains("unknown") || o.classList.contains("unknown"))
        return;
      const h = ut(
        de(E),
        de(v),
      ...
      if (u.Global.contrastAlgorithm === "APCA") {
        const I = h.ratio;
        c.textContent = yn(I);
        const S = Ut(I).slice(1), C = I >= 45 && S[0] >= 0 && S[0] <= 777;
        let D;
        switch (i) {
          case "svg-error":
          case "svg-warning": {
            m.hidden = !C, D = C, g(x, D);
            break;
          }
          default: {
            const _ = S[Math.floor(r / 100) - 1];
            D = L >= _, g(x, D), m.hidden = !D;
            break;
          }
        }
      }
      if (u.Global.contrastAlgorithm === "AA" || u.Global.contrastAlgorithm === "AAA") {
        const I = h.ratio;
        c.textContent = vn(I);
        const S = u.Global.contrastAlgorithm === "AAA", C = 3, D = S ? 7 : 4.5, _ = S ? 4.5 : 3, k = I >= C, w = L >= 24 || L >= 18.66 && r >= 700 || a, R = I >= D, G = I >= _;
        switch (i) {
          case "svg-error":
          case "svg-text":
          case "svg-warning": {
          ...
          default: {
            w ? (g([c, l], G), m.hidden = !G) : (g([c, l], R), m.hidden = !R);
            break;
          }
        }
      }
  ...
  return M.Found.Images.forEach((s) => {
    ...
    if (!(s.height < 2 && s.width < 2 && (Re(s) || r === ""))) {
      ...
      if (r === null)
        ...
        const S = i ? e.checks.LINK_ALT_MAYBE_BAD : e.checks.ALT_MAYBE_BAD, C = new RegExp(`^\\S{${S.minLength || 15},}$`), D = /[^\p{L}\-,.!?]/u.test(r);
        if (m[0] !== null) {
