...
async function ia(t, e) {
  ...
  async function i(b, E) {
    ...
    const w = b.map(async (I) => {
      let k = "";
      if (I.element) {
        const R = ["IMG", "IFRAME", "AUDIO", "VIDEO"], G = await ns(I, !0);
        R.includes(I.element.tagName) ? k = `<li><strong>${f._("PREVIEW")}:</strong> ${G}</li><li><strong>${f._("ELEMENT")}:</strong> <pre><code>${lt(I.htmlPath)}</code></pre></li>` : k = `<li><strong>${f._("ELEMENT")}:</strong> <pre><code>${lt(I.htmlPath)}</code></pre></li>`;
      }
      const C = I.cssPath ? `<li><strong>${f._("PATH")}:</strong> <pre><code>${I.cssPath}</code></pre></li>` : "";
      return `<li>${I.content} <ul>${k}${C}</ul></li>`;
...
function ma(t, e, n) {
  const s = () => {
    ...
    e.forEach((i, a) => {
      ...
      if (g) {
        const M = ft(d, "display", "none"), I = document.createElement("sa11y-image-anchor");
        I.setAttribute("data-sa11y-parent", `image${a}`), (M?.previousElementSibling || M?.parentNode)?.insertAdjacentElement("beforebegin", I);
      } else
      ...
      ), x = n.imageWithinLightbox ? `a[href]:not(${n.imageWithinLightbox})` : "a[href]", _ = d.closest(x) ? `<div class="badge"><span class="link-icon"></span><span class="visually-hidden">${f._("LINKED")}</span></div>` : "", S = g === !0 ? `<div class="badge"><span class="hidden-icon"></span><span class="visually-hidden">${f._("HIDDEN")}</span></div>` : "";
      let w;
      if (p === "error" && !b) {
...
function Ga(t) {
  ...
  if (!(!i || !a)) {
    var c = Ba(r.padding, n), m = fn(i), g = d === "y" ? J : Z, A = d === "y" ? re : oe, y = n.rects.reference[o] + n.rects.reference[d] - a[d] - n.rects.popper[o], b = a[d] - n.rects.reference[d], E = At(i), v = E ? d === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, L = y / 2 - b / 2, h = c[g], x = v - m[o] - c[A], _ = v / 2 - m[o] / 2 + L, S = at(h, _, x), w = d;
    n.modifiersData[s] = (e = {}, e[w] = S, e.centerOffset = S - _, e);
  }
}
function Ha(t) {
...
function Pn(t) {
  ...
  if (p) {
    var _ = At(n), S = "clientHeight", w = "clientWidth";
    if (_ === ee(n) && (_ = Se(n), Le(_).position !== "static" && l === "absolute" && (S = "scrollHeight", w = "scrollWidth")), _ = _, r === J || (r === Z || r === oe) && i === ct) {
      h = re;
      var M = c && _ === x && x.visualViewport ? x.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        _[S]
      );
...
function dt(t, e) {
  ...
  if (m === nt && k) {
    ...
    Object.keys(I).forEach(function(R) {
      var G = [oe, re].indexOf(R) >= 0 ? 1 : -1, $ = [J, re].indexOf(R) >= 0 ? "y" : "x";
      I[R] += C[$] * G;
    });
  }
  return I;
...
function ni(t) {
  ...
  if (!e.modifiersData[s]._skip) {
    for (var r = n.mainAxis, i = r === void 0 ? !0 : r, a = n.altAxis, l = a === void 0 ? !0 : a, d = n.fallbackPlacements, p = n.padding, o = n.boundary, c = n.rootBoundary, m = n.altBoundary, g = n.flipVariations, A = g === void 0 ? !0 : g, y = n.allowedAutoPlacements, b = e.options.placement, E = he(b), v = E === b, L = d || (v || !A ? [Ot(b)] : ti(b)), h = [b].concat(L).reduce(function(me, ce) {
    ...
    }, []), x = e.rects.reference, _ = e.rects.popper, S = /* @__PURE__ */ new Map(), w = !0, M = h[0], I = 0; I < h.length; I++) {
      var k = h[I], C = he(k), R = Ye(k) === We, G = [J, re].indexOf(C) >= 0, $ = G ? "width" : "height", W = dt(e, {
        placement: k,
        boundary: o,
        rootBoundary: c,
        altBoundary: m,
      ...
      x[$] > _[$] && (H = Ot(H));
      var F = Ot(H), Q = [];
      if (i && Q.push(W[C] <= 0), l && Q.push(W[H] <= 0, W[F] <= 0), Q.every(function(me) {
        return me;
      })) {
        M = k, w = !1;
        break;
...
function ui(t) {
  var e = t.state, n = t.options, s = t.name, r = n.mainAxis, i = r === void 0 ? !0 : r, a = n.altAxis, l = a === void 0 ? !1 : a, d = n.boundary, p = n.rootBoundary, o = n.altBoundary, c = n.padding, m = n.tether, g = m === void 0 ? !0 : m, A = n.tetherOffset, y = A === void 0 ? 0 : A, b = dt(e, {
    ...
    padding: c,
    altBoundary: o
  }), E = he(e.placement), v = Ye(e.placement), L = !v, h = hn(E), x = pi(h), _ = e.modifiersData.popperOffsets, S = e.rects.reference, w = e.rects.popper, M = typeof y == "function" ? y(Object.assign({}, e.rects, {
    placement: e.placement
  })) : y, I = typeof M == "number" ? {
    mainAxis: M,
    altAxis: M
    ...
    mainAxis: 0,
    altAxis: 0
  }, M), k = e.modifiersData.offset ? e.modifiersData.offset[e.placement] : null, C = {
    x: 0,
    y: 0
  };
  if (_) {
    if (i) {
      var R, G = h === "y" ? J : Z, $ = h === "y" ? re : oe, W = h === "y" ? "height" : "width", H = _[h], F = H + b[G], Q = H - b[$], te = g ? -w[W] / 2 : 0, le = v === We ? S[W] : w[W], ne = v === We ? -w[W] : -S[W], ke = e.elements.arrow, me = g && ke ? fn(ke) : {
        width: 0,
        height: 0
      }, ce = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : ps(), Ae = ce[G], Me = ce[$], be = at(0, S[W], me[W]), Be = L ? S[W] / 2 - te - be - Ae - I.mainAxis : le - be - Ae - I.mainAxis, Te = L ? -S[W] / 2 + te + be + Me + I.mainAxis : ne + be + Me + I.mainAxis, Ge = e.elements.arrow && At(e.elements.arrow), bt = Ge ? h === "y" ? Ge.clientTop || 0 : Ge.clientLeft || 0 : 0, qe = (R = k?.[h]) != null ? R : 0, Et = H + Be - qe - bt, yt = H + Te - qe, Xe = at(g ? Dt(F, Et) : F, H, g ? Pe(Q, yt) : Q);
      _[h] = Xe, C[h] = Xe - H;
    }
    if (l) {
      var Je, vt = h === "x" ? J : Z, Lt = h === "x" ? re : oe, Ee = _[x], Ie = x === "y" ? "height" : "width", Ze = Ee + b[vt], we = Ee - b[Lt], et = [J, Z].indexOf(E) !== -1, Tt = (Je = k?.[x]) != null ? Je : 0, It = et ? Ze : Ee - S[Ie] - w[Ie] - Tt + I.altAxis, _t = et ? Ee + S[Ie] + w[Ie] - Tt - I.altAxis : we, xt = g && et ? Ma(It, Ee, _t) : at(g ? It : Ze, Ee, g ? _t : we);
      _[x] = xt, C[x] = xt - Ee;
    }
    e.modifiersData[s] = C;
  }
        ...
        if (!m) {
          ...
          if (Hn(v, L)) {
            ...
            for (var h = 0; h < o.orderedModifiers.length; h++) {
              ...
              var x = o.orderedModifiers[h], _ = x.fn, S = x.options, w = S === void 0 ? {} : S, M = x.name;
...
function Qi(t, e) {
  ...
  if (!n.render)
    return h;
  var x = n.render(h), _ = x.popper, S = x.onUpdate;
  ...
  return Ge(), te(), H(), F("onCreate", [h]), n.showOnCreate && Ze(), _.addEventListener("mouseenter", function() {
  ...
  function F(T, O, B) {
    if (B === void 0 && (B = !0), w.forEach(function(U) {
      ...
      var K;
      (K = h.props)[T].apply(K, O);
    }
  }
  function Q() {
    var T = h.props.aria;
    if (T.content) {
      var O = "aria-" + T.content, B = _.id, K = $e(h.props.triggerTarget || t);
  ...
  function Be(T, O) {
    var B = $().box;
    function K(U) {
      U.target === B && (Xt(B, "remove", K), O());
    }
    if (T === 0)
      return O();
    Xt(B, "remove", c), Xt(B, "add", K), c = K;
  }
  function Te(T, O, B) {
    B === void 0 && (B = !1);
    var K = $e(h.props.triggerTarget || t);
    K.forEach(function(U) {
  ...
  function bt() {
    g.forEach(function(T) {
      var O = T.node, B = T.eventType, K = T.handler, U = T.options;
      O.removeEventListener(B, K, U);
    }), g = [];
  }
  function qe(T) {
    var O, B = !1;
    if (!(!h.state.isEnabled || Je(T) || l)) {
      ...
      o = T, y = T.currentTarget, te(), !h.state.isVisible && Ci(T) && wt.forEach(function(U) {
        return U(T);
      }), T.type === "click" && (h.props.trigger.indexOf("mouseenter") < 0 || a) && h.props.hideOnClick !== !1 && h.state.isVisible ? B = !0 : Ze(T), T.type === "click" && (a = !B), B && !K && we(T);
    }
  }
  function Et(T) {
    var O = T.target, B = R().contains(O) || _.contains(O);
    if (!(T.type === "mousemove" && B)) {
      var K = Ie().concat(_).map(function(U) {
  ...
  function vt() {
    Lt();
    var T = h.props, O = T.popperOptions, B = T.placement, K = T.offset, U = T.getReferenceClientRect, j = T.moveTransition, se = C() ? rn(_).arrow : null, He = U ? {
  ...
  function Ee() {
    ...
    h.props.interactive && T === Es || T === "parent" ? O = B.parentNode : O = ys(T, [B]), O.contains(_) || O.appendChild(_), h.state.isMounted = !0, vt();
  }
  function Ie() {
  ...
  function Ze(T) {
    ...
    var O = W(!0), B = I(), K = B[0], U = B[1];
    ue.isTouch && K === "hold" && U && (O = U), O ? s = setTimeout(function() {
      h.show();
    }, O) : h.show();
  }
  function we(T) {
  ...
  function _t(T) {
    if (!h.state.isDestroyed) {
      ...
      h.props = B, Ge(), O.interactiveDebounce !== B.interactiveDebounce && (le(), A = Un(Et, B.interactiveDebounce)), O.triggerTarget && !B.triggerTarget ? $e(O.triggerTarget).forEach(function(K) {
        K.removeAttribute("aria-expanded");
      }) : B.triggerTarget && t.removeAttribute("aria-expanded"), te(), H(), S && S(O, B), h.popperInstance && (vt(), Ie().forEach(function(K) {
  ...
  function Os() {
    var T = h.state.isVisible, O = h.state.isDestroyed, B = !h.state.isEnabled, K = ue.isTouch && !h.props.touch, U = jt(h.props.duration, 0, pe.duration);
    if (!(T || O || B || K) && !R().hasAttribute("disabled") && (F("onShow", [h], !1), h.props.onShow(h) !== !1)) {
      if (h.state.isVisible = !0, C() && (_.style.visibility = "visible"), H(), ce(), h.state.isMounted || (_.style.transition = "none"), C()) {
        var j = $(), se = j.box, He = j.content;
        qt([se, He], 0);
      }
      m = function() {
        var Ce;
        if (!(!h.state.isVisible || p)) {
          if (p = !0, _.offsetHeight, _.style.transition = h.props.moveTransition, C() && h.props.animation) {
            var Ft = $(), Nt = Ft.box, Ue = Ft.content;
            qt([Nt, Ue], U), Kn([Nt, Ue], "visible");
          }
          Q(), te(), Fn(Jt, h), (Ce = h.popperInstance) == null || Ce.forceUpdate(), F("onMount", [h]), h.props.animation && C() && be(U, function() {
  ...
  function Ps() {
    var T = !h.state.isVisible, O = h.state.isDestroyed, B = !h.state.isEnabled, K = jt(h.props.duration, 1, pe.duration);
    if (!(T || O || B) && (F("onHide", [h], !1), h.props.onHide(h) !== !1)) {
      if (h.state.isVisible = !1, h.state.isShown = !1, p = !1, a = !1, C() && (_.style.visibility = "hidden"), le(), Ae(), H(!0), C()) {
        var U = $(), j = U.box, se = U.content;
        h.props.animation && (qt([j, se], K), Kn([j, se], "hidden"));
      }
      Q(), te(), h.props.animation ? C() && Me(K, h.unmount) : h.unmount();
    }
  }
  function Rs(T) {
...
function Ji(t, e, n, s) {
  const i = n == null || s == null, a = pt(e), l = (M, I) => a <= 0.179 ? xs(M, I) : Ns(M, I);
...
function tr(t) {
  const { sanitizedText: e, color: n, background: s, fontWeight: r, fontSize: i, ratio: a, textUnderline: l } = t, d = s && s.type !== "image", p = d ? q(s) : "#000000", o = n ? q(n) : "#000000", c = r ? `font-weight:${r};` : "", m = i ? `font-size:${i}px;` : "", g = l ? `text-decoration:${l};` : "", A = n ? "" : 'class="unknown"', y = s && s.type !== "image" ? "" : 'class="unknown"', b = n ? "" : `<span id="fg-input-unknown" class="visually-hidden">(${f._("UNKNOWN")})</span>`, E = s ? "" : `<span id="bg-input-unknown" class="visually-hidden">(${f._("UNKNOWN")})</span>`;
  let v;
...
function nr(t, e) {
  ...
  const { fontSize: s, fontWeight: r, type: i, isLargeText: a } = e, l = t.querySelector("#contrast"), d = t.querySelector("#contrast-preview"), p = t.querySelector("#fg-input"), o = t.querySelector("#bg-input"), c = t.querySelector("#value"), m = t.querySelector("#good"), g = (b, E) => {
    ...
    const E = p.value, v = o.value, L = A();
    if (setTimeout(() => {
      const S = p.classList.contains("unknown"), w = o.classList.contains("unknown");
      d.style.color = S ? "" : E, d.style.backgroundColor = w ? "" : v, d.style.backgroundImage = w ? "" : "none";
    ...
    const h = u.Global.contrastAlgorithm, x = ut(
      de(E),
      de(v),
    ...
    if (h === "APCA") {
      const S = x.ratio;
      c.textContent = yn(S);
      const w = Ut(S).slice(1), M = S >= 45 && w[0] >= 0 && w[0] <= 777;
      let I;
      switch (i) {
        case "svg-error":
        case "svg-warning": {
          m.hidden = !M, I = M, g(_, I);
          break;
        }
        default: {
          const k = w[Math.floor(r / 100) - 1];
          I = L >= k, g(_, I), m.hidden = !I;
          break;
        }
      }
    } else {
      const S = x.ratio;
      c.textContent = vn(S);
      const w = h === "AAA", M = 3, I = w ? 7 : 4.5, k = w ? 4.5 : 3, C = S >= M, R = L >= 24 || L >= 18.66 && r >= 700 || a, G = S >= I, $ = S >= k;
      switch (i) {
        case "svg-error":
        case "svg-text":
        case "svg-warning": {
        ...
        default: {
          R ? (g([c, l], $), m.hidden = !$) : (g([c, l], G), m.hidden = !G);
          break;
        }
      }
    }
...
function rr(t, e) {
  ...
  if (n) {
    ...
    if (b.setAttribute("data-sa11y-annotation", l), is()) {
      ...
      const w = n.style.anchorName;
      n.style.anchorName = w ? `${w}, --sa11y-anchor-${l}` : `--sa11y-anchor-${l}`;
    }
    ...
    const _ = e.ignoreHiddenOverflow ? e.ignoreHiddenOverflow.split(",").flatMap((w) => [...document.querySelectorAll(w)]) : [], S = ft(n, "overflow", "hidden");
  ...
  return D.Found.Images.forEach((s) => {
    ...
    if (!(s.height < 2 && s.width < 2 && (Re(s) || r === ""))) {
      ...
      if (r === null)
        ...
        if (y || x) {
          const I = e.checks.IMAGE_DECORATIVE_CAROUSEL.sources, k = I ? s.closest(I) : "";
          if (k) {
            const C = k.querySelectorAll("img"), R = C.length === 1 ? e.checks.IMAGE_DECORATIVE : e.checks.IMAGE_DECORATIVE_CAROUSEL, G = C.length === 1 ? "IMAGE_DECORATIVE" : "IMAGE_DECORATIVE_CAROUSEL";
            R && t.push({
              test: G,
              element: s,
              type: R.type || "warning",
            ...
            const C = p === 0 ? e.checks.LINK_IMAGE_NO_ALT_TEXT : e.checks.LINK_IMAGE_TEXT, R = p === 0 ? "LINK_IMAGE_NO_ALT_TEXT" : "LINK_IMAGE_TEXT";
            C && t.push({
              test: R,
              element: s,
              type: C.type || (p === 0 ? "error" : "good"),
              content: f.sprintf(C.content || R),
              dismiss: N(`${R + a + p}`),
              dismissAll: C.dismissAll ? R : !1,
              developer: C.developer || !1
            });
          } else if (b) {
            const C = E && v.length ? e.checks.IMAGE_FIGURE_DECORATIVE : e.checks.IMAGE_DECORATIVE, R = E && v.length ? "IMAGE_FIGURE_DECORATIVE" : "IMAGE_DECORATIVE";
            C && t.push({
              test: R,
              element: s,
              type: C.type || "warning",
        ...
        const S = i ? e.checks.LINK_ALT_MAYBE_BAD : e.checks.ALT_MAYBE_BAD, w = new RegExp(`^\\S{${S.minLength || 15},}$`), M = /[^\p{L}\-,.!?]/u.test(r);
        if (m[0] !== null) {
          const I = i ? e.checks.LINK_ALT_FILE_EXT : e.checks.ALT_FILE_EXT, k = i ? "LINK_ALT_FILE_EXT" : "ALT_FILE_EXT";
          I && t.push({
            test: k,
            element: s,
            type: I.type || "error",
            content: f.sprintf(I.content || k, m[0], c),
            dismiss: N(`${k + a + c}`),
            dismissAll: I.dismissAll ? k : !1,
            developer: I.developer || !1
          });
        } else if (m[2] !== null) {
          const I = i ? e.checks.LINK_PLACEHOLDER_ALT : e.checks.ALT_PLACEHOLDER, k = i ? "LINK_PLACEHOLDER_ALT" : "ALT_PLACEHOLDER";
          I && t.push({
            test: k,
            element: s,
            type: I.type || "error",
            content: f.sprintf(I.content || k, c),
            dismiss: N(`${k + a + c}`),
            dismissAll: I.dismissAll ? k : !1,
            developer: I.developer || !1
          });
        } else if (m[1] !== null) {
          const I = i ? e.checks.LINK_SUS_ALT : e.checks.SUS_ALT, k = i ? "LINK_SUS_ALT" : "SUS_ALT";
          I && t.push({
            test: k,
            element: s,
            type: I.type || "warning",
            content: f.sprintf(I.content || k, m[1], c),
            dismiss: N(`${k + a + c}`),
            dismissAll: I.dismissAll ? k : !1,
            developer: I.developer || !1
          });
        } else if (S && w.test(r) && M) {
          ...
          const I = i ? e.checks.LINK_IMAGE_LONG_ALT : e.checks.IMAGE_ALT_TOO_LONG, k = i ? "LINK_IMAGE_LONG_ALT" : "IMAGE_ALT_TOO_LONG", C = xe(c, 600);
          I && t.push({
            test: k,
            element: s,
            type: I.type || "warning",
            content: f.sprintf(I.content || k, r.length, C),
            dismiss: N(`${k + a + c}`),
            dismissAll: I.dismissAll ? k : !1,
            developer: I.developer || !1
          });
        } else if (i) {
          const I = p === 0 ? e.checks.LINK_IMAGE_ALT : e.checks.LINK_IMAGE_ALT_AND_TEXT, k = p === 0 ? "LINK_IMAGE_ALT" : "LINK_IMAGE_ALT_AND_TEXT";
          if (I) {
            const C = ve(i), R = fe(C), G = Y(R), $ = p === 0 ? f.sprintf("LINK_IMAGE_ALT", c) : `${f.sprintf("LINK_IMAGE_ALT_AND_TEXT", c, G)} ${f.sprintf("ACC_NAME_TIP")}`;
            t.push({
              test: k,
              element: s,
              type: I.type || "warning",
              content: I.content ? f.sprintf(I.content, c, G) : $,
              dismiss: N(`${k + a + c}`),
              dismissAll: I.dismissAll ? k : !1,
              developer: I.developer || !1
            });
...
function Ar(t, e) {
  ...
  return D.Found.Links.forEach((a) => {
    ...
    ), p = Array.isArray(e.linkIgnoreStrings) ? e.linkIgnoreStrings.reduce((G, $) => G.replace($, ""), d) : d, o = Kt(p), c = r(o), m = /[^a-zA-Z0-9]/g, g = p.length === 1 && m.test(p), A = /([<>↣↳←→↓«»↴]+)/, y = p.match(A), b = y ? y[1] : null, E = a.getAttribute("title"), v = a.getAttribute("aria-hidden") === "true", L = a.getAttribute("tabindex") === "-1", h = a.querySelector(":scope [aria-labelledby], :scope [aria-label]") || a.getAttribute("aria-labelledby") || a.getAttribute("aria-label"), x = a.querySelector(":scope [aria-labelledby]") || a.getAttribute("aria-labelledby"), _ = f._("NEW_WINDOW_PHRASES").some(
    ...
    ), C = p.replace(/'|"|-|\.|\s+/g, "").toLowerCase(), R = a.textContent.trim().toLowerCase();
    if (!a.querySelectorAll("img").length) {
      ...
      if (e.linkIgnoreStrings && e.linkIgnoreStrings.forEach((H) => {
        ...
        e.checks.LINK_STOPWORD_ARIA && le !== null ? t.push({
          ...
          inline: !0,
          dismiss: N(`LINKSTOPWORDARIA${l + C}`),
      ...
      (c[1] !== null || S) && e.checks.LINK_CLICK_HERE && t.push({
        ...
        content: f.sprintf(e.checks.DUPLICATE_TITLE.content || "DUPLICATE_TITLE"),
        inline: !0,
        dismiss: N(`LINKDUPLICATETITLE${l + C}`),
        dismissAll: e.checks.DUPLICATE_TITLE.dismissAll ? "DUPLICATE_TITLE" : !1,
        developer: e.checks.DUPLICATE_TITLE.developer || !1
      });
    }
    if (e.linksAdvancedPlugin && C.length !== 0) {
      if (i[C] && !i[l]) {
        const G = a.ariaHidden === "true" && a.getAttribute("tabindex") === "-1", $ = a.hasAttribute("role") || a.hasAttribute("disabled");
        if (e.checks.LINK_IDENTICAL_NAME && !$ && !G) {
          const W = Y(p);
          t.push({
    ...
    if ((p.length === 1 || c) && o.length === 0) {
      ...
      if (![S, w].includes("unsupported") && d) {
        ...
        if (_ && (I = ut(
          ...
          l,
          e.contrastAlgorithm
        ), k = e.contrastAlgorithm === "APCA" ? I.ratio >= 45 : I.ratio >= 3), x && (I = ut(
          w,
          l,
          e.contrastAlgorithm
        ), C = e.contrastAlgorithm === "APCA" ? I.ratio >= 45 : I.ratio >= 3), _ && x && !k && !C || _ && !x && !k || !_ && x && !C) {
        ...
        _ && S !== "unsupported" ? a.color = S : x && w !== "unsupported" && (a.color = w), d && (a.background = l), n.push(a);
    } else
