...
function Qe(t, e, n) {
  Ke();
  const s = document.querySelector("sa11y-control-panel").shadowRoot, r = s.getElementById("panel-alert"), i = s.getElementById("panel-alert-text"), a = s.getElementById("panel-alert-preview"), l = s.getElementById("close-alert"), d = s.getElementById("skip-button");
  ...
  function o() {
    Ke(), (d.hasAttribute("disabled") ? s.getElementById("toggle") : d).focus();
  }
...
const u = /* @__PURE__ */ (function() {
  ...
  function n(c) {
    ...
    if (y) {
      const x = y.split(/\s*[\s,]\s*/).map((I) => `[src*="${I}"]`);
    ...
    if (E) {
      const x = E.split(/\s*[\s,]\s*/).map((I) => `[src*="${I}"]`);
    ...
    if (L) {
      const x = L.split(/\s*[\s,]\s*/).map((I) => `[src*="${I}"]`);
  ...
  const s = {};
  function r(c, m, g) {
    if (s.areaToCheck = [], s.Readability = [], g) {
      s.areaToCheck = g, s.Readability = g;
      return;
    }
    try {
    ...
    s.areaToCheck.length === 0 && e.headless === !1 && (Qe(f.sprintf("MISSING_ROOT", c)), s.areaToCheck.push(document.body));
    try {
    ...
    s.Readability.length === 0 && e.headless === !1 && (s.areaToCheck.length === 0 ? s.Readability.push(document.body) : (s.Readability = s.areaToCheck, setTimeout(() => {
      ...
      if (A && b && !E) {
        const v = s.areaToCheck.map((h) => h.id ? `#${h.id}` : h.className ? `.${h.className.split(/\s+/).filter(Boolean).join(".")}` : h.tagName.toLowerCase()).join(", "), L = document.createElement("div");
...
function X(t, e, n) {
  ...
  const r = u.Exclusions.Container.join(", "), i = n?.join(", ") || "", a = i ? `, ${i}` : "";
  let l = [];
...
const D = /* @__PURE__ */ (function() {
  ...
  const s = {};
  function r() {
    s.Array = X("sa11y-annotation", "document"), s.Array.forEach((i, a) => {
...
})(), Gs = "[data-sa11y-overflow]{overflow:auto!important}[data-sa11y-error]{outline-offset:2px;outline:5px solid var(--sa11y-error)!important}[data-sa11y-warning]:not([data-sa11y-error]){outline-offset:2px;outline:5px solid var(--sa11y-warning)!important}[data-sa11y-pulse-border]{box-shadow:0;animation:1s 2 pulse;outline:5px solid var(--sa11y-focus-color)!important}[data-sa11y-pulse-border]:hover,[data-sa11y-pulse-border]:focus{animation:none}@keyframes pulse{0%{box-shadow:0 0 0 5px var(--sa11y-focus-color)}50%{box-shadow:0 0 0 12px var(--sa11y-pulse-color)}to{box-shadow:0 0 0 5px var(--sa11y-pulse-color)}}img[data-sa11y-pulse-border],h1[data-sa11y-pulse-border],h2[data-sa11y-pulse-border],h3[data-sa11y-pulse-border],h4[data-sa11y-pulse-border],h5[data-sa11y-pulse-border],h6[data-sa11y-pulse-border]{animation:1s 2 pulse-scale}@keyframes pulse-scale{0%{opacity:1;transform:scale(1)}50%{opacity:.7;transform:scale(1.02)}to{opacity:1;transform:scale(1)}}@media(prefers-reduced-motion:reduce){[data-sa11y-pulse-border]{animation:none!important}}@media(forced-colors:active){[data-sa11y-error],[data-sa11y-warning],[data-sa11y-good],[data-sa11y-error-inline],[data-sa11y-warning-inline],[data-sa11y-pulse-border]{forced-color-adjust:none}}", In = (t) => {
  if (t.shadowRoot.querySelectorAll(".sa11y-css-utilities").length === 0) {
    const n = document.createElement("style");
    n.setAttribute("class", "sa11y-css-utilities"), n.textContent = Gs, t.shadowRoot.appendChild(n);
  }
};
function Hs(t) {
  if (t.autoDetectShadowComponents) {
    ...
    Array.from(n ? n.querySelectorAll(`*:not(${e})`) : document.body.querySelectorAll(`*:not(${e})`)).forEach((r) => {
      r.shadowRoot && r.shadowRoot.mode === "open" && (r.setAttribute("data-sa11y-has-shadow-root", ""), In(r));
    });
  } else t.shadowComponents && document.querySelectorAll(t.shadowComponents).forEach((n) => {
    n.setAttribute("data-sa11y-has-shadow-root", ""), In(n);
  });
}
function Us(t) {
...
function _e(t, e = !1) {
  ...
  return n.innerHTML = t, ["script", "style", "noscript", "iframe", "form"].forEach((r) => {
    const i = n.getElementsByTagName(r);
    for (; i.length > 0; )
...
function je(t, e = []) {
  const s = [...["noscript", "script", "style", "audio", "video", "form", "iframe"], ...e].join(", "), r = t.cloneNode(!0);
  return Array.from(r.querySelectorAll(s)).forEach((a) => {
...
function V(t) {
  if (Wt.has(t))
    return Wt.get(t);
  const n = je(t).textContent.replace(/[\r\n]+/g, "").replace(/\s+/g, " ").trim();
  return Wt.set(t, n), n;
}
function fe(t) {
  return t.replace(/[\r\n]+/g, " ").replace(/\s+/g, " ").trim();
...
function zs(t) {
  ...
  for (; n; ) {
    ...
    if (n.id) {
      ...
      const i = n.getAttribute ? n.getAttribute("class") : null;
      if (i) {
    ...
    if (r) {
      const i = r.children;
      if (i.length > 1) {
        const a = Array.prototype.indexOf.call(i, n) + 1;
        s += `:nth-child(${a})`;
      }
      e.unshift(s);
    } else
...
function Vs(t) {
  ...
  t.addEventListener("keydown", (r) => {
    ...
    i && (r.shiftKey ? a.activeElement === n && (s.focus(), r.preventDefault()) : a.activeElement === s && (n.focus(), r.preventDefault()));
  });
}
function Zn(t, e) {
  t.forEach((n) => {
...
function ts(t) {
  const e = (a) => a?.split(/,\s+/).pop()?.trim()?.split(/\s+/)[0], n = (a) => a ? new URL(a, window.location.href).href : null, s = e(t.getAttribute("data-src") || t.getAttribute("srcset"));
  if (s)
    return n(s);
  const r = t.closest("picture")?.querySelector("source[srcset]")?.getAttribute("srcset"), i = e(r);
  return n(i || t.getAttribute("src"));
}
const Ys = (t) => new Promise((e, n) => {
...
function ns(t, e = !1) {
  const n = t.element, s = _e(t.htmlPath), r = xe(s, 600), i = `<pre><code>${lt(r)}</code></pre>`, a = (o) => {
    ...
    IMG: (o) => {
      const c = o.closest("a[href]"), m = o.alt ? `alt="${Y(o.alt)}"` : "alt", g = ts(o);
      function A(b) {
        ...
        return new Promise((b) => {
          if (g)
            if (new URL(g, window.location.origin).origin === window.location.origin)
              fetch(g).then((v) => v.blob()).then((v) => Ys(v)).then((v) => {
...
function ss(t, e, n = [], s) {
  let r = "";
  const i = n?.length ? n.join(",") : "", a = Array.isArray(s) ? s : null, l = (o = "") => a ? a.reduce((c, m) => c.replace(m, ""), o) : o;
  t.childNodes.forEach((o) => {
    o.nodeType === Node.TEXT_NODE && (r += l(o.textContent)), o.nodeType === Node.ELEMENT_NODE && (i && o.matches(i) || cn(o) || (r += l(V(o))));
  });
...
function as(t, e) {
  ...
  const s = (r) => {
    ...
    let a;
    r.code === "ArrowDown" ? (a = n + 1, n === e.length - 1 && (a = 0)) : r.code === "ArrowUp" && (a = n - 1, n === 0 && (a = e.length - 1)), e[a].setAttribute("tabindex", 0), e[a].focus(), n = a, r.preventDefault();
  };
...
class _n extends HTMLElement {
  ...
  connectedCallback() {
    ...
    n.innerHTML = js + gt, e.appendChild(n);
...
function Xs(t, e) {
  const n = JSON.parse(localStorage.getItem("sa11y-dismissed") || "[]"), s = window.location.pathname, r = (m, g) => g.key.includes(m.dismiss) && g.href === s && (m.type === "warning" || m.type === "good"), i = (m, g) => typeof g.dismissAll == "string" && m.dismissAll === g.dismissAll && g.href === s, a = t.filter(
    (m) => n.some((g) => r(m, g))
  ), l = t.filter(
    (m) => n.some((g) => i(m, g))
  ), d = [...a, ...l], p = [
  ...
  return o ? (u.Panel.dismissButton.classList.add("active"), u.Panel.dismissTooltip.innerText = f.sprintf("PANEL_DISMISS_BUTTON", o), e.object.setContent(f.sprintf("PANEL_DISMISS_BUTTON", o))) : u.Panel.dismissButton.classList.remove("active"), { dismissedIssues: n, updatedResults: c, dismissCount: o, dismissedResults: p };
}
let Zt, Ct;
const Js = async (t, e, n, s) => {
...
function ea(t, e, n, s) {
  u.Global.dismissAnnotations && (Ct = (i) => Js(i, t, n, s), document.querySelector("sa11y-tooltips").shadowRoot.addEventListener("click", Ct), u.Panel.panel.addEventListener("click", Ct)), Zt = () => Zs(e, n, s), u.Panel.dismissButton?.addEventListener("click", Zt);
}
function ta() {
...
function dn() {
  const t = /* @__PURE__ */ new Date(), e = String(t.getDate()).padStart(2, "0"), n = String(t.getMonth() + 1).padStart(2, "0"), s = t.getFullYear(), r = (/* @__PURE__ */ new Date()).toLocaleString(), i = `${n}-${e}-${s}`, a = document.querySelector("head title"), l = !a || a.textContent.trim().length === 0, d = l ? "" : a.textContent, p = window.location.href;
  return { date: r, numericDate: i, titleCheck: l, metaTitle: d, pageURL: p };
}
async function ia(t, e) {
  const n = t.filter((b) => b.type === "error"), s = t.filter((b) => b.type === "warning"), r = { error: n.length, warning: s.length, dismiss: e.length };
  async function i(b, E) {
    ...
    if (!(b.length > 0))
      return "";
    let x = `<h2>${L}</h2>`, I = `<ol class="${E}">`, S = "</ol>";
    E === "dismissed" && (I = `<details><summary>${f.sprintf("PANEL_DISMISS_BUTTON", r.dismiss)}</summary><ol>`, S = "</details>"), x += I;
    const C = b.map(async (_) => {
      let k = "";
      if (_.element) {
        const R = ["IMG", "IFRAME", "AUDIO", "VIDEO"], G = await ns(_, !0);
        R.includes(_.element.tagName) ? k = `<li><strong>${f._("PREVIEW")}:</strong> ${G}</li><li><strong>${f._("ELEMENT")}:</strong> <pre><code>${lt(_.htmlPath)}</code></pre></li>` : k = `<li><strong>${f._("ELEMENT")}:</strong> <pre><code>${lt(_.htmlPath)}</code></pre></li>`;
      }
      const w = _.cssPath ? `<li><strong>${f._("PATH")}:</strong> <pre><code>${_.cssPath}</code></pre></li>` : "";
      return `<li>${_.content} <ul>${k}${w}</ul></li>`;
    }), M = await Promise.all(C);
    return x += M.join(""), x += S, x;
  }
  const a = await i(n, "error"), l = await i(s, "warning"), d = await i(e, "dismissed"), p = dn(), o = p.titleCheck ? "" : `<dt>${f._("PAGE_TITLE")}</dt><dd>${p.metaTitle}</dd>`, c = r.error !== 0 ? `<dt>${f._("ERRORS")}</dt><dd>${r.error}</dd>` : "", m = r.warning !== 0 ? `<dt>${f._("WARNINGS")}</dt><dd>${r.warning}</dd>` : "", g = r.dismiss !== 0 ? `<dt>${f._("DISMISSED")}</dt><dd>${r.dismiss}</dd>` : "";
  return `
      <!DOCTYPE html>
...
async function ra(t, e) {
  const n = await ia(t, e), s = dn(), r = new Blob([n], { type: "text/html" }), i = document.createElement("a"), a = s.titleCheck ? "" : `_${s.metaTitle.trim().replace(/ /g, "")}`;
  i.href = window.URL.createObjectURL(r), i.download = `Sa11y_${s.numericDate + a}.html`, document.body.appendChild(i), i.click(), setTimeout(() => {
    document.body.removeChild(i), window.URL.revokeObjectURL(i.href);
  }, 100);
}
function oa(t) {
  const e = dn(), n = t.filter((o) => o.type === "warning" || o.type === "error").map((o) => {
    const { type: c, content: m, htmlPath: g, cssPath: A } = o, y = m.replaceAll(/<span\s+class="visually-hidden"[^>]*>.*?<\/span>/gi, "").replaceAll('<hr aria-hidden="true">', " | ").replaceAll(/"/g, '""'), b = Ks(String(y)), E = $s(b), v = {
      Title: `"${e.metaTitle}"`,
      URL: `"${e.pageURL}"`,
      Type: `"${String(c)}"`,
      Issue: `"${E}"`,
...
let en, tn;
function la(t, e) {
  u.Global.exportResultsPlugin && (en = async () => {
    await ra(t, e);
  }, tn = () => {
    oa(t);
  }, u.Panel.exportHTML.addEventListener("click", en), u.Panel.exportCSV.addEventListener("click", tn));
}
function ca() {
  u.Global.exportResultsPlugin && (u.Panel.exportHTML.removeEventListener("click", en), u.Panel.exportCSV.removeEventListener("click", tn));
}
function da(t, e) {
...
class xn extends HTMLElement {
  connectedCallback() {
    ...
    k.setAttribute("id", "container"), k.setAttribute("role", "region"), k.setAttribute("data-sa11y-version", "dev-4.4.0"), k.setAttribute("lang", f._("LANG_CODE")), k.setAttribute("aria-label", f._("CONTAINER_LABEL")), k.setAttribute("dir", u.Global.langDirection), a === "top-left" || a === "top-right" ? k.innerHTML = `
        ${A}
        ...
        <div id="panel" class="${a}" part="panel">
          ...
          ${S}
          ${_}
        </div>`, this.shadowRoot.appendChild(k), u.initializePanelSelectors();
  }
}
function ua(t, e) {
  ...
  const n = window.matchMedia("(prefers-color-scheme: dark)"), { themeToggle: s } = u.Panel, { html: r } = u.Global, i = (l) => {
    r.setAttribute("data-sa11y-theme", l), P.setItem("sa11y-theme", l);
    const d = s.querySelector("span").classList;
    d.toggle("moon-icon", l === "light"), d.toggle("sun-icon", l === "dark"), s.setAttribute("aria-pressed", l === "dark" ? "true" : "false");
  }, a = P.getItem("sa11y-theme") || (n.matches ? "dark" : "light");
  i(a), n.addEventListener("change", () => {
    i(n.matches ? "dark" : "light");
  }), s.onclick = () => {
    const d = (P.getItem("sa11y-theme") || (n.matches ? "dark" : "light")) === "dark" ? "light" : "dark";
    i(d);
...
function fa() {
  u.Panel.outlineToggle.addEventListener("click", () => {
    u.Panel.outlineToggle.getAttribute("aria-expanded") === "true" ? Vt() : (Nn(), Qt(), Yt()), u.Panel.outlineHeader.focus();
  }), P.getItem("sa11y-outline") === "Opened" && Nn(), u.Global.showImageOutline && (u.Panel.imagesToggle.addEventListener("click", () => {
    u.Panel.imagesToggle.getAttribute("aria-expanded") === "true" ? Yt() : (Sn(), Vt(), Qt()), u.Panel.imagesHeader.focus();
  }), P.getItem("sa11y-images") === "Opened" && Sn()), u.Panel.settingsToggle.addEventListener("click", () => {
    u.Panel.settingsToggle.getAttribute("aria-expanded") === "true" ? Qt() : (kn(), Vt(), Yt()), u.Panel.settingsHeader.focus();
  }), P.getItem("sa11y-settings") === "Opened" && kn(), u.Panel.skipToPageIssues.addEventListener("click", () => {
...
function ha(t, e, n) {
  const s = () => {
    ...
    e.forEach((l, d) => {
      const { element: p, headingLevel: o, text: c, type: m, dismissedHeading: g, isWithinRoot: A } = l, y = cn(p), b = y === !0 ? `<span class="hidden-icon"></span><span class="visually-hidden">${f._("HIDDEN")}</span>` : "", E = n.showHinPageOutline === !0 || n.showHinPageOutline === 1 ? "H" : "";
      let v;
      m === "error" && A === !0 ? (v = `
            <li class="outline-${o}">
      ...
      if (h.id = `sa11y-h${d}`, y) {
        const I = ft(p, "display", "none"), S = I?.previousElementSibling || I?.parentNode;
...
const tt = (t, e) => {
  ...
  for (; a.nextNode() && g; ) {
    ...
    if (o && !A.closest("a") && (c === r && (r += o), o = !1, c = !1), A.ariaHidden === "true" && !(n && m < 3)) {
      wn(a) || (g = !1);
      continue;
    }
    const b = Ne(A, n);
...
function ma(t, e, n) {
  const s = () => {
    const r = [];
    e.forEach((i, a) => {
      t.some((M) => M.dismiss === i.dismiss) && Object.assign(i, { dismissedImage: !0 });
      const { element: d, type: p, developer: o, dismissedImage: c } = i, m = Ne(d) === "noAria" ? lt(d.getAttribute("alt")) : Ne(d), g = cn(d);
      if (g) {
        const M = ft(d, "display", "none"), _ = document.createElement("sa11y-image-anchor");
        _.setAttribute("data-sa11y-parent", `image${a}`), (M?.previousElementSibling || M?.parentNode)?.insertAdjacentElement("beforebegin", _);
      } else
        d.setAttribute("data-sa11y-image", a);
      const A = P.getItem("sa11y-developer"), b = (A === "Off" || A === null) && (p === "error" || p === "warning") && o === !0, E = ts(i.element), v = u.Global.editImageURLofCMS ? ga(i) : "", L = d.hasAttribute("alt") && m === "" ? `<div class="badge">${f._("DECORATIVE")}</div>` : "", h = n.altPlaceholder?.some(
        (M) => m.toLowerCase().startsWith(M.toLowerCase())
      ), x = n.imageWithinLightbox ? `a[href]:not(${n.imageWithinLightbox})` : "a[href]", I = d.closest(x) ? `<div class="badge"><span class="link-icon"></span><span class="visually-hidden">${f._("LINKED")}</span></div>` : "", S = g === !0 ? `<div class="badge"><span class="hidden-icon"></span><span class="visually-hidden">${f._("HIDDEN")}</span></div>` : "";
      let C;
      if (p === "error" && !b) {
        const M = m.length === 0 ? `<div class="badge">${f._("MISSING")}</div>` : "";
        C = `
        <li class="error">
          <button type="button" tabindex="-1">
            <img src="${E}" alt/>
...
var J = "top", re = "bottom", oe = "right", Z = "left", pn = "auto", mt = [J, re, oe, Z], We = "start", ct = "end", ya = "clippingParents", rs = "viewport", nt = "popper", va = "reference", Cn = /* @__PURE__ */ mt.reduce(function(t, e) {
  return t.concat([e + "-" + We, e + "-" + ct]);
}, []), os = /* @__PURE__ */ [].concat(mt, [pn]).reduce(function(t, e) {
...
function Oa(t) {
  ...
  Object.keys(e.elements).forEach(function(n) {
    var s = e.styles[n] || {}, r = e.attributes[n] || {}, i = e.elements[n];
    !ie(i) || !ge(i) || (Object.assign(i.style, s), Object.keys(r).forEach(function(a) {
      var l = r[a];
...
function Pa(t) {
  ...
  return Object.assign(e.elements.popper.style, n.popper), e.styles = n, e.elements.arrow && Object.assign(e.elements.arrow.style, n.arrow), function() {
    Object.keys(e.elements).forEach(function(s) {
      var r = e.elements[s], i = e.attributes[s] || {}, a = Object.keys(e.styles.hasOwnProperty(s) ? e.styles[s] : n[s]), l = a.reduce(function(d, p) {
        return d[p] = "", d;
      }, {});
...
function Ve(t, e, n) {
  ...
  var s = t.getBoundingClientRect(), r = 1, i = 1;
  e && ie(t) && (r = t.offsetWidth > 0 && ze(s.width) / t.offsetWidth || 1, i = t.offsetHeight > 0 && ze(s.height) / t.offsetHeight || 1);
  var a = De(t) ? ee(t) : window, l = a.visualViewport, d = !cs() && n, p = (s.left + (d && l ? l.offsetLeft : 0)) / r, o = (s.top + (d && l ? l.offsetTop : 0)) / i, c = s.width / r, m = s.height / i;
  return {
    width: c,
    height: m,
    top: o,
...
function fn(t) {
  var e = Ve(t), n = t.offsetWidth, s = t.offsetHeight;
...
function Da(t) {
  ...
  var r = Gt(t);
  for (un(r) && (r = r.host); ie(r) && ["html", "body"].indexOf(ge(r)) < 0; ) {
    var i = Le(r);
...
function At(t) {
  for (var e = ee(t), n = On(t); n && Ra(n) && Le(n).position === "static"; )
    n = On(n);
  return n && (ge(n) === "html" || ge(n) === "body" && Le(n).position === "static") ? e : n || Da(t) || e;
}
function hn(t) {
...
var Ba = function(e, n) {
  ...
  })) : e, us(typeof e != "number" ? e : fs(e, mt));
};
function Ga(t) {
  var e, n = t.state, s = t.name, r = t.options, i = n.elements.arrow, a = n.modifiersData.popperOffsets, l = he(n.placement), d = hn(l), p = [Z, oe].indexOf(l) >= 0, o = p ? "height" : "width";
  if (!(!i || !a)) {
    var c = Ba(r.padding, n), m = fn(i), g = d === "y" ? J : Z, A = d === "y" ? re : oe, y = n.rects.reference[o] + n.rects.reference[d] - a[d] - n.rects.popper[o], b = a[d] - n.rects.reference[d], E = At(i), v = E ? d === "y" ? E.clientHeight || 0 : E.clientWidth || 0 : 0, L = y / 2 - b / 2, h = c[g], x = v - m[o] - c[A], I = v / 2 - m[o] / 2 + L, S = at(h, I, x), C = d;
    n.modifiersData[s] = (e = {}, e[C] = S, e.centerOffset = S - I, e);
  }
}
function Ha(t) {
  var e = t.state, n = t.options, s = n.element, r = s === void 0 ? "[data-popper-arrow]" : s;
  r != null && (typeof r == "string" && (r = e.elements.popper.querySelector(r), !r) || ds(e.elements.popper, r) && (e.elements.arrow = r));
}
const Ua = {
  name: "arrow",
  enabled: !0,
...
function Pn(t) {
  var e, n = t.popper, s = t.popperRect, r = t.placement, i = t.variation, a = t.offsets, l = t.position, d = t.gpuAcceleration, p = t.adaptive, o = t.roundOffsets, c = t.isFixed, m = a.x, g = m === void 0 ? 0 : m, A = a.y, y = A === void 0 ? 0 : A, b = typeof o == "function" ? o({
    x: g,
    y
  }) : {
    x: g,
  ...
  if (p) {
    var I = At(n), S = "clientHeight", C = "clientWidth";
    if (I === ee(n) && (I = Se(n), Le(I).position !== "static" && l === "absolute" && (S = "scrollHeight", C = "scrollWidth")), I = I, r === J || (r === Z || r === oe) && i === ct) {
      h = re;
      var M = c && I === x && x.visualViewport ? x.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        I[S]
      );
      y -= M - s.height, y *= d ? 1 : -1;
    }
    if (r === Z || (r === J || r === re) && i === ct) {
      L = oe;
      var _ = c && I === x && x.visualViewport ? x.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        I[C]
      );
      g -= _ - s.width, g *= d ? 1 : -1;
  ...
  if (g = w.x, y = w.y, d) {
    var R;
    return Object.assign({}, k, (R = {}, R[h] = v ? "0" : "", R[L] = E ? "0" : "", R.transform = (x.devicePixelRatio || 1) <= 1 ? "translate(" + g + "px, " + y + "px)" : "translate3d(" + g + "px, " + y + "px, 0)", R));
  }
  return Object.assign({}, k, (e = {}, e[h] = v ? y + "px" : "", e[L] = E ? g + "px" : "", e.transform = "", e));
}
function Ka(t) {
  var e = t.state, n = t.options, s = n.gpuAcceleration, r = s === void 0 ? !0 : s, i = n.adaptive, a = i === void 0 ? !0 : i, l = n.roundOffsets, d = l === void 0 ? !0 : l, p = {
...
function za(t) {
  var e = t.state, n = t.instance, s = t.options, r = s.scroll, i = r === void 0 ? !0 : r, a = s.resize, l = a === void 0 ? !0 : a, d = ee(e.elements.popper), p = [].concat(e.scrollParents.reference, e.scrollParents.popper);
  return i && p.forEach(function(o) {
    o.addEventListener("scroll", n.update, kt);
  }), l && d.addEventListener("resize", n.update, kt), function() {
    i && p.forEach(function(o) {
      o.removeEventListener("scroll", n.update, kt);
    }), l && d.removeEventListener("resize", n.update, kt);
  };
}
const Va = {
  name: "eventListeners",
...
function gn(t) {
  var e = ee(t), n = e.pageXOffset, s = e.pageYOffset;
  return {
    scrollLeft: n,
    scrollTop: s
  };
...
function mn(t) {
  return Ve(Se(t)).left + gn(t).scrollLeft;
}
function ja(t, e) {
  var n = ee(t), s = Se(t), r = n.visualViewport, i = s.clientWidth, a = s.clientHeight, l = 0, d = 0;
  if (r) {
...
function qa(t) {
  var e, n = Se(t), s = gn(t), r = (e = t.ownerDocument) == null ? void 0 : e.body, i = Pe(n.scrollWidth, n.clientWidth, r ? r.scrollWidth : 0, r ? r.clientWidth : 0), a = Pe(n.scrollHeight, n.clientHeight, r ? r.scrollHeight : 0, r ? r.clientHeight : 0), l = -s.scrollLeft + mn(t), d = -s.scrollTop;
  return Le(r || n).direction === "rtl" && (l += Pe(n.clientWidth, r ? r.clientWidth : 0) - i), {
    width: i,
    height: a,
    x: l,
    y: d
...
function An(t) {
  var e = Le(t), n = e.overflow, s = e.overflowX, r = e.overflowY;
  return /auto|scroll|overlay|hidden/.test(n + r + s);
}
function hs(t) {
  return ["html", "body", "#document"].indexOf(ge(t)) >= 0 ? t.ownerDocument.body : ie(t) && An(t) ? t : hs(Gt(t));
}
function it(t, e) {
  var n;
  e === void 0 && (e = []);
  var s = hs(t), r = s === ((n = t.ownerDocument) == null ? void 0 : n.body), i = ee(s), a = r ? [i].concat(i.visualViewport || [], An(s) ? s : []) : s, l = e.concat(a);
  return r ? l : (
...
function Xa(t, e) {
  var n = Ve(t, !1, e === "fixed");
  return n.top = n.top + t.clientTop, n.left = n.left + t.clientLeft, n.bottom = n.top + t.clientHeight, n.right = n.left + t.clientWidth, n.width = t.clientWidth, n.height = t.clientHeight, n.x = n.left, n.y = n.top, n;
}
function Dn(t, e, n) {
  return e === rs ? sn(ja(t, n)) : De(e) ? Xa(e, n) : sn(qa(Se(t)));
}
function Ja(t) {
  var e = it(Gt(t)), n = ["absolute", "fixed"].indexOf(Le(t).position) >= 0, s = n && ie(t) ? At(t) : t;
  return De(s) ? e.filter(function(r) {
    return De(r) && ds(r, s) && ge(r) !== "body";
  }) : [];
}
function Za(t, e, n, s) {
  var r = e === "clippingParents" ? Ja(t) : [].concat(e), i = [].concat(r, [n]), a = i[0], l = i.reduce(function(d, p) {
    var o = Dn(t, p, s);
...
function gs(t) {
  var e = t.reference, n = t.element, s = t.placement, r = s ? he(s) : null, i = s ? Ye(s) : null, a = e.x + e.width / 2 - n.width / 2, l = e.y + e.height / 2 - n.height / 2, d;
  switch (r) {
    case J:
      d = {
        x: a,
...
function dt(t, e) {
  e === void 0 && (e = {});
  var n = e, s = n.placement, r = s === void 0 ? t.placement : s, i = n.strategy, a = i === void 0 ? t.strategy : i, l = n.boundary, d = l === void 0 ? ya : l, p = n.rootBoundary, o = p === void 0 ? rs : p, c = n.elementContext, m = c === void 0 ? nt : c, g = n.altBoundary, A = g === void 0 ? !1 : g, y = n.padding, b = y === void 0 ? 0 : y, E = us(typeof b != "number" ? b : fs(b, mt)), v = m === nt ? va : nt, L = t.rects.popper, h = t.elements[A ? v : m], x = Za(De(h) ? h : h.contextElement || Se(t.elements.popper), d, o, a), I = Ve(t.elements.reference), S = gs({
    reference: I,
    element: L,
    placement: r
  }), C = sn(Object.assign({}, L, S)), M = m === nt ? C : I, _ = {
    top: x.top - M.top + E.top,
    bottom: M.bottom - x.bottom + E.bottom,
    left: x.left - M.left + E.left,
    right: M.right - x.right + E.right
...
function ei(t, e) {
  e === void 0 && (e = {});
  var n = e, s = n.placement, r = n.boundary, i = n.rootBoundary, a = n.padding, l = n.flipVariations, d = n.allowedAutoPlacements, p = d === void 0 ? os : d, o = Ye(s), c = o ? l ? Cn : Cn.filter(function(A) {
    return Ye(A) === o;
...
function ni(t) {
  ...
  if (!e.modifiersData[s]._skip) {
    for (var r = n.mainAxis, i = r === void 0 ? !0 : r, a = n.altAxis, l = a === void 0 ? !0 : a, d = n.fallbackPlacements, p = n.padding, o = n.boundary, c = n.rootBoundary, m = n.altBoundary, g = n.flipVariations, A = g === void 0 ? !0 : g, y = n.allowedAutoPlacements, b = e.options.placement, E = he(b), v = E === b, L = d || (v || !A ? [Ot(b)] : ti(b)), h = [b].concat(L).reduce(function(me, ce) {
      return me.concat(he(ce) === pn ? ei(e, {
        placement: ce,
        boundary: o,
        rootBoundary: c,
        padding: p,
    ...
    }, []), x = e.rects.reference, I = e.rects.popper, S = /* @__PURE__ */ new Map(), C = !0, M = h[0], _ = 0; _ < h.length; _++) {
      var k = h[_], w = he(k), R = Ye(k) === We, G = [J, re].indexOf(w) >= 0, K = G ? "width" : "height", W = dt(e, {
        placement: k,
        boundary: o,
        rootBoundary: c,
        altBoundary: m,
      ...
      x[K] > I[K] && (H = Ot(H));
      var F = Ot(H), Q = [];
      if (i && Q.push(W[w] <= 0), l && Q.push(W[H] <= 0, W[F] <= 0), Q.every(function(me) {
        return me;
      })) {
        M = k, C = !1;
        break;
...
function ai(t) {
  var e = t.state, n = t.name, s = e.rects.reference, r = e.rects.popper, i = e.modifiersData.preventOverflow, a = dt(e, {
    elementContext: "reference"
  }), l = dt(e, {
    altBoundary: !0
  }), d = Mn(a, s), p = Mn(l, r, i), o = Bn(d), c = Bn(p);
  e.modifiersData[n] = {
...
function ri(t, e, n) {
  var s = he(t), r = [Z, J].indexOf(s) >= 0 ? -1 : 1, i = typeof n == "function" ? n(Object.assign({}, e, {
    placement: t
  })) : n, a = i[0], l = i[1];
  return a = a || 0, l = (l || 0) * r, [Z, oe].indexOf(s) >= 0 ? {
    x: l,
    y: a
  } : {
    x: a,
...
function oi(t) {
  var e = t.state, n = t.options, s = t.name, r = n.offset, i = r === void 0 ? [0, 0] : r, a = os.reduce(function(o, c) {
    return o[c] = ri(c, e.rects, i), o;
  }, {}), l = a[e.placement], d = l.x, p = l.y;
  e.modifiersData.popperOffsets != null && (e.modifiersData.popperOffsets.x += d, e.modifiersData.popperOffsets.y += p), e.modifiersData[s] = a;
}
const li = {
  name: "offset",
  enabled: !0,
...
function ui(t) {
  var e = t.state, n = t.options, s = t.name, r = n.mainAxis, i = r === void 0 ? !0 : r, a = n.altAxis, l = a === void 0 ? !1 : a, d = n.boundary, p = n.rootBoundary, o = n.altBoundary, c = n.padding, m = n.tether, g = m === void 0 ? !0 : m, A = n.tetherOffset, y = A === void 0 ? 0 : A, b = dt(e, {
    boundary: d,
    rootBoundary: p,
    padding: c,
    altBoundary: o
  }), E = he(e.placement), v = Ye(e.placement), L = !v, h = hn(E), x = pi(h), I = e.modifiersData.popperOffsets, S = e.rects.reference, C = e.rects.popper, M = typeof y == "function" ? y(Object.assign({}, e.rects, {
    placement: e.placement
  })) : y, _ = typeof M == "number" ? {
    mainAxis: M,
    altAxis: M
    ...
    mainAxis: 0,
    altAxis: 0
  }, M), k = e.modifiersData.offset ? e.modifiersData.offset[e.placement] : null, w = {
    x: 0,
    y: 0
  };
  if (I) {
    if (i) {
      var R, G = h === "y" ? J : Z, K = h === "y" ? re : oe, W = h === "y" ? "height" : "width", H = I[h], F = H + b[G], Q = H - b[K], te = g ? -C[W] / 2 : 0, le = v === We ? S[W] : C[W], ne = v === We ? -C[W] : -S[W], ke = e.elements.arrow, me = g && ke ? fn(ke) : {
        width: 0,
        height: 0
      }, ce = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : ps(), Ae = ce[G], Me = ce[K], be = at(0, S[W], me[W]), Be = L ? S[W] / 2 - te - be - Ae - _.mainAxis : le - be - Ae - _.mainAxis, Te = L ? -S[W] / 2 + te + be + Me + _.mainAxis : ne + be + Me + _.mainAxis, Ge = e.elements.arrow && At(e.elements.arrow), bt = Ge ? h === "y" ? Ge.clientTop || 0 : Ge.clientLeft || 0 : 0, qe = (R = k?.[h]) != null ? R : 0, Et = H + Be - qe - bt, yt = H + Te - qe, Xe = at(g ? Dt(F, Et) : F, H, g ? Pe(Q, yt) : Q);
      I[h] = Xe, w[h] = Xe - H;
    }
    if (l) {
      var Je, vt = h === "x" ? J : Z, Lt = h === "x" ? re : oe, Ee = I[x], Ie = x === "y" ? "height" : "width", Ze = Ee + b[vt], we = Ee - b[Lt], et = [J, Z].indexOf(E) !== -1, Tt = (Je = k?.[x]) != null ? Je : 0, It = et ? Ze : Ee - S[Ie] - C[Ie] - Tt + _.altAxis, _t = et ? Ee + S[Ie] + C[Ie] - Tt - _.altAxis : we, xt = g && et ? Ma(It, Ee, _t) : at(g ? It : Ze, Ee, g ? _t : we);
      I[x] = xt, w[x] = xt - Ee;
    }
    e.modifiersData[s] = w;
  }
...
function gi(t) {
  return t === ee(t) || !ie(t) ? gn(t) : hi(t);
}
function mi(t) {
  var e = t.getBoundingClientRect(), n = ze(e.width) / t.offsetWidth || 1, s = ze(e.height) / t.offsetHeight || 1;
  return n !== 1 || s !== 1;
}
function Ai(t, e, n) {
  n === void 0 && (n = !1);
  var s = ie(e), r = ie(e) && mi(e), i = Se(e), a = Ve(t, r, n), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, d = {
    x: 0,
  ...
  An(i)) && (l = gi(e)), ie(e) ? (d = Ve(e, !0), d.x += e.clientLeft, d.y += e.clientTop) : i && (d.x = mn(i))), {
...
function Li(t) {
  t === void 0 && (t = {});
  var e = t, n = e.defaultModifiers, s = n === void 0 ? [] : n, r = e.defaultOptions, i = r === void 0 ? Gn : r;
  return function(l, d, p) {
    ...
    var o = {
      ...
      setOptions: function(E) {
        ...
        var L = Ei(vi([].concat(s, o.options.modifiers)));
        ...
        if (!m) {
          ...
          if (Hn(v, L)) {
            o.rects = {
              ...
              popper: fn(L)
            }, o.reset = !1, o.placement = o.options.placement, o.orderedModifiers.forEach(function(_) {
              return o.modifiersData[_.name] = Object.assign({}, _.data);
            });
            for (var h = 0; h < o.orderedModifiers.length; h++) {
              ...
              var x = o.orderedModifiers[h], I = x.fn, S = x.options, C = S === void 0 ? {} : S, M = x.name;
...
var Ti = [Va, di, Wa, ls, li, si, fi, Ua, ii], Ii = /* @__PURE__ */ Li({
  defaultModifiers: Ti
}), _i = "tippy-box", ms = "tippy-content", xi = "tippy-backdrop", As = "tippy-arrow", bs = "tippy-svg-arrow", Oe = {
  passive: !0,
  capture: !0
}, Es = function() {
...
function wi(t) {
  return bn(t, "NodeList");
}
function Ci(t) {
  return bn(t, "MouseEvent");
}
function Oi(t) {
...
function Di(t, e) {
  ...
  return t.every(function(r) {
    ...
    if (!o)
      return !0;
    var c = p === "bottom" ? o.top.y : 0, m = p === "top" ? o.bottom.y : 0, g = p === "right" ? o.left.x : 0, A = p === "left" ? o.right.x : 0, y = i.top - s + c > d, b = s - i.bottom - m > d, E = i.left - n + g > d, v = n - i.right - A > d;
    return y || b || E || v;
  });
}
function Xt(t, e, n) {
...
function Mi() {
  ue.isTouch || (ue.isTouch = !0, window.performance && document.addEventListener("mousemove", vs));
}
function vs() {
  var t = performance.now();
  t - zn < 20 && (ue.isTouch = !1, document.removeEventListener("mousemove", vs)), zn = t;
}
function Bi() {
...
function Ls(t) {
  var e = t.plugins || [], n = e.reduce(function(s, r) {
    ...
    if (i) {
      var l;
      s[i] = t[i] !== void 0 ? t[i] : (l = pe[i]) != null ? l : a;
    }
    return s;
  }, {});
...
function zi(t, e) {
  var n = e ? Object.keys(Ls(Object.assign({}, pe, {
    plugins: e
  }))) : Ki, s = n.reduce(function(r, i) {
...
function Vn(t, e) {
  var n = Object.assign({}, e, {
    content: ys(e.content, [t])
  }, e.ignoreAttributes ? {} : zi(t, e.plugins));
  return n.aria = Object.assign({}, pe.aria, n.aria), n.aria = {
...
function Yn(t) {
  var e = rt();
  return t === !0 ? e.className = As : (e.className = bs, Ht(t) ? e.appendChild(t) : an(e, t)), e;
}
function Qn(t, e) {
  Ht(e.content) ? (an(t, ""), t.appendChild(e.content)) : typeof e.content != "function" && (e.allowHTML ? an(t, e.content) : t.textContent = e.content);
}
function rn(t) {
  var e = t.firstElementChild, n = Mt(e.children);
  return {
    box: e,
    ...
    arrow: n.find(function(s) {
      return s.classList.contains(As) || s.classList.contains(bs);
    }),
    backdrop: n.find(function(s) {
      return s.classList.contains(xi);
    })
  };
}
function Ts(t) {
  var e = rt(), n = rt();
  n.className = _i, n.setAttribute("data-state", "hidden"), n.setAttribute("tabindex", "-1");
  var s = rt();
  s.className = ms, s.setAttribute("data-state", "hidden"), Qn(s, t.props), e.appendChild(n), n.appendChild(s), r(t.props, t.props);
  function r(i, a) {
    var l = rn(e), d = l.box, p = l.content, o = l.arrow;
    a.theme ? d.setAttribute("data-theme", a.theme) : d.removeAttribute("data-theme"), typeof a.animation == "string" ? d.setAttribute("data-animation", a.animation) : d.removeAttribute("data-animation"), a.inertia ? d.setAttribute("data-inertia", "") : d.removeAttribute("data-inertia"), d.style.maxWidth = typeof a.maxWidth == "number" ? a.maxWidth + "px" : a.maxWidth, a.role ? d.setAttribute("role", a.role) : d.removeAttribute("role"), (i.content !== a.content || i.allowHTML !== a.allowHTML) && Qn(p, t.props), a.arrow ? o ? i.arrow !== a.arrow && (d.removeChild(o), d.appendChild(Yn(a.arrow))) : d.appendChild(Yn(a.arrow)) : o && d.removeChild(o);
  }
  return {
    popper: e,
    onUpdate: r
...
var Yi = 1, wt = [], Jt = [];
function Qi(t, e) {
  var n = Vn(t, Object.assign({}, pe, Ls($n(e)))), s, r, i, a = !1, l = !1, d = !1, p = !1, o, c, m, g = [], A = Un(Et, n.interactiveDebounce), y, b = Yi++, E = null, v = Si(n.plugins), L = {
  ...
  if (!n.render)
    return h;
  var x = n.render(h), I = x.popper, S = x.onUpdate;
  I.setAttribute("data-tippy-root", ""), I.id = "tippy-" + h.id, h.popper = I, t._tippy = h, I._tippy = h;
  var C = v.map(function(T) {
    return T.fn(h);
  }), M = t.hasAttribute("aria-expanded");
  return Ge(), te(), H(), F("onCreate", [h]), n.showOnCreate && Ze(), I.addEventListener("mouseenter", function() {
  ...
  function H(T) {
    T === void 0 && (T = !1), I.style.pointerEvents = h.props.interactive && !T ? "" : "none", I.style.zIndex = "" + h.props.zIndex;
  }
  function F(T, O, B) {
    if (B === void 0 && (B = !0), C.forEach(function(U) {
      U[T] && U[T].apply(U, O);
    }), B) {
      var $;
      ($ = h.props)[T].apply($, O);
  ...
  function Q() {
    var T = h.props.aria;
    if (T.content) {
      var O = "aria-" + T.content, B = I.id, $ = $e(h.props.triggerTarget || t);
      $.forEach(function(U) {
        var j = U.getAttribute(O);
        if (h.state.isVisible)
          U.setAttribute(O, j ? j + " " + B : B);
        else {
          var se = j && j.replace(B, "").trim();
          se ? U.setAttribute(O, se) : U.removeAttribute(O);
        }
      });
    }
  }
  function te() {
    if (!(M || !h.props.aria.expanded)) {
  ...
  function ce() {
    var T = G();
    T.addEventListener("mousedown", ne, !0), T.addEventListener("touchend", ne, Oe), T.addEventListener("touchstart", me, Oe), T.addEventListener("touchmove", ke, Oe);
  }
  function Ae() {
    var T = G();
    T.removeEventListener("mousedown", ne, !0), T.removeEventListener("touchend", ne, Oe), T.removeEventListener("touchstart", me, Oe), T.removeEventListener("touchmove", ke, Oe);
  }
  function Me(T, O) {
    Be(T, function() {
      !h.state.isVisible && I.parentNode && I.parentNode.contains(I) && O();
    });
  }
  function be(T, O) {
    Be(T, O);
  ...
  function Et(T) {
    var O = T.target, B = R().contains(O) || I.contains(O);
    if (!(T.type === "mousemove" && B)) {
      var $ = Ie().concat(I).map(function(U) {
        var j, se = U._tippy, He = (j = se.popperInstance) == null ? void 0 : j.state;
        return He ? {
  ...
  function Xe(T) {
    h.props.trigger.indexOf("focusin") < 0 && T.target !== R() || h.props.interactive && T.relatedTarget && I.contains(T.relatedTarget) || we(T);
  }
  function Je(T) {
    return ue.isTouch ? k() !== T.type.indexOf("touch") >= 0 : !1;
  }
  function vt() {
    Lt();
    var T = h.props, O = T.popperOptions, B = T.placement, $ = T.offset, U = T.getReferenceClientRect, j = T.moveTransition, se = w() ? rn(I).arrow : null, He = U ? {
    ...
    }), Ce.push.apply(Ce, O?.modifiers || []), h.popperInstance = Ii(He, I, Object.assign({}, O, {
      placement: B,
      onFirstUpdate: m,
      modifiers: Ce
    }));
  ...
  function Ee() {
    ...
    h.props.interactive && T === Es || T === "parent" ? O = B.parentNode : O = ys(T, [B]), O.contains(I) || O.appendChild(I), h.state.isMounted = !0, vt();
  }
  function Ie() {
    return Mt(I.querySelectorAll("[data-tippy-root]"));
  }
  function Ze(T) {
    h.clearDelayTimeouts(), T && F("onTrigger", [h, T]), ce();
    var O = W(!0), B = _(), $ = B[0], U = B[1];
    ue.isTouch && $ === "hold" && U && (O = U), O ? s = setTimeout(function() {
      h.show();
    }, O) : h.show();
  }
  function we(T) {
  ...
  function It() {
    clearTimeout(s), clearTimeout(r), cancelAnimationFrame(i);
  }
  function _t(T) {
    if (!h.state.isDestroyed) {
      F("onBeforeUpdate", [h, T]), bt();
      var O = h.props, B = Vn(t, Object.assign({}, O, $n(T), {
        ignoreAttributes: !0
      }));
      h.props = B, Ge(), O.interactiveDebounce !== B.interactiveDebounce && (le(), A = Un(Et, B.interactiveDebounce)), O.triggerTarget && !B.triggerTarget ? $e(O.triggerTarget).forEach(function($) {
  ...
  function Os() {
    ...
    if (!(T || O || B || $) && !R().hasAttribute("disabled") && (F("onShow", [h], !1), h.props.onShow(h) !== !1)) {
      if (h.state.isVisible = !0, w() && (I.style.visibility = "visible"), H(), ce(), h.state.isMounted || (I.style.transition = "none"), w()) {
        var j = K(), se = j.box, He = j.content;
        qt([se, He], 0);
      }
      m = function() {
        var Ce;
        if (!(!h.state.isVisible || p)) {
          if (p = !0, I.offsetHeight, I.style.transition = h.props.moveTransition, w() && h.props.animation) {
            var Ft = K(), Nt = Ft.box, Ue = Ft.content;
            qt([Nt, Ue], U), Kn([Nt, Ue], "visible");
          }
          Q(), te(), Fn(Jt, h), (Ce = h.popperInstance) == null || Ce.forceUpdate(), F("onMount", [h]), h.props.animation && w() && be(U, function() {
  ...
  function Ps() {
    ...
    if (!(T || O || B) && (F("onHide", [h], !1), h.props.onHide(h) !== !1)) {
      if (h.state.isVisible = !1, h.state.isShown = !1, p = !1, a = !1, w() && (I.style.visibility = "hidden"), le(), Ae(), H(!0), w()) {
        var U = K(), j = U.box, se = U.content;
        h.props.animation && (qt([j, se], $), Kn([j, se], "hidden"));
      }
      Q(), te(), h.props.animation ? w() && Me($, h.unmount) : h.unmount();
    }
  }
  function Rs(T) {
    G().addEventListener("mousemove", A), Fn(wt, A), A(T);
  }
  function Ds() {
    h.state.isVisible && h.hide(), h.state.isMounted && (Lt(), Ie().forEach(function(T) {
      T._tippy.unmount();
    }), I.parentNode && I.parentNode.removeChild(I), Jt = Jt.filter(function(T) {
      return T !== h;
...
function ye(t, e) {
  e === void 0 && (e = {});
  var n = pe.plugins.concat(e.plugins || []);
  Gi();
...
function Ut(t, e = 2) {
  ...
  let o = 0, c = (t - n[p][o]) * d;
  for (o++; o < i; o++)
    l = n[p][o], l > 400 ? a[o] = l : t < 14.5 ? a[o] = 999 : t < 29.5 ? a[o] = 777 : l > 24 ? a[o] = Math.round(l - s[p][o] * c) : a[o] = l - (2 * s[p][o] * c | 0) * 0.5;
  return a;
}
function pt(t = [0, 0, 0]) {
  function e(n) {
...
function En(t = [0, 0, 0, 1], e = [0, 0, 0], n = !0) {
  t[3] = Math.max(Math.min(t[3], 1), 0);
  let s = 1 - t[3], r = [0, 0, 0, 1, !0];
  for (let i = 0; i < 3; i++)
    r[i] = e[i] * s + t[i] * t[3], n && (r[i] = Math.min(Math.round(r[i]), 255));
  return r;
}
function jn(t) {
...
function de(t, e) {
  ...
  if (n.startsWith("rgb")) {
    ...
    d.fillStyle = n, d.fillRect(0, 0, 1, 1), [s, r, i, a] = d.getImageData(0, 0, 1, 1).data, a = (a / 255).toFixed(2);
  }
  return e && e < 1 && (a = (a * e).toFixed(2)), [s, r, i, Number(a)];
}
function Pt(t, e) {
  let n = t;
  for (; n && n.nodeType === 1; ) {
...
function Bt(t, e) {
  const n = En(t, e).slice(0, 4), s = pt(n), r = pt(e);
  return { ratio: _s(s, r), blendedColor: n };
}
function st(t, e) {
...
function q(t) {
  const [e, n, s] = t.map((l) => Math.min(255, Math.max(0, l))), r = e.toString(16).padStart(2, "0"), i = n.toString(16).padStart(2, "0"), a = s.toString(16).padStart(2, "0");
  return `#${r}${i}${a}`;
}
function yn(t) {
...
function ji(t, e) {
  return e === "APCA" ? yn(t) : vn(t);
}
function ut(t, e, n) {
  let s;
  const r = En(t, e).slice(0, 4);
  if (n === "APCA") {
    const i = pt(r), a = pt(e);
    s = _s(i, a);
  } else {
...
function qi(t, e, n, s) {
  ...
  const i = ot(t), a = ot(e), l = i > a ? st(1, a) > r : st(0, a) < r, d = (L, h, x) => x ? xs(L, h) : Ns(L, h);
  let p = t, o = p, c = st(i, a), m = c, g = t, A = 0.16;
  const y = 0.5, b = 0.01;
  let E = 0;
  const v = 100;
  for (; A >= b; ) {
    ...
    p = d(p, A, l);
    const L = ot(p);
    c = st(L, a), c >= r && (o = c <= m ? p : o, m = c, p = g, A *= y), g = p;
  }
  return { color: q(o) };
}
const Xi = (t, e) => {
  const n = Bt(t, [0, 0, 0, 1]), s = Bt(t, [255, 255, 255, 1]), r = Math.abs(n.ratio) > Math.abs(s.ratio), i = r ? [0, 0, 0, 1] : [255, 255, 255, 1], a = r ? n.ratio : s.ratio, l = Ut(a).slice(1), d = Math.ceil(l[Math.floor(e / 100) - 1]);
  return { suggestedColor: i, size: d };
};
function Ji(t, e, n, s) {
  const i = n == null || s == null, a = pt(e), l = (M, _) => a <= 0.179 ? xs(M, _) : Ns(M, _);
  let d = t, p = Bt(d, e), { ratio: o } = p, c = null, m = o, g = null, A, y, b;
  const E = () => (A = Ut(o).slice(1), y = Math.min(
    Math.max(Math.floor(n / 100) - 1, 0),
    A.length - 1
  ), b = A[y], b <= s && b !== 999 && b !== 777), v = () => Math.abs(o) >= 45;
  if (i) {
    if (v())
      return { color: q(t), size: null };
  } else {
    if (c = Xi(e, n), c.size > s)
      return {
...
function Zi(t, e, n, s, r, i, a) {
  const { ratio: l, blendedColor: d } = ut(e, n), p = s >= 24 || s >= 18.67 && r >= 700;
  let o;
  if (a === "AAA")
    o = p ? l < 4.5 : l < 7;
  else {
...
function er(t, e, n, s, r, i, a) {
  const { ratio: l, blendedColor: d } = ut(e, n, a), p = Ut(l).slice(1), o = Math.floor(r / 100) - 1, c = p[o];
  return s < c ? {
    $el: t,
    ratio: yn(l),
    color: d,
...
function qn(t, e, n, s, r, i, a) {
  return (a === "APCA" ? er : Zi)(t, e, n, s, r, i, a);
}
function tr(t) {
  const { sanitizedText: e, color: n, background: s, fontWeight: r, fontSize: i, ratio: a, textUnderline: l } = t, d = s && s.type !== "image", p = d ? q(s) : "#000000", o = n ? q(n) : "#000000", c = r ? `font-weight:${r};` : "", m = i ? `font-size:${i}px;` : "", g = l ? `text-decoration:${l};` : "", A = n ? "" : 'class="unknown"', y = s && s.type !== "image" ? "" : 'class="unknown"', b = n ? "" : `<span class="visually-hidden">(${f._("UNKNOWN")})</span>`, E = s ? "" : `<span class="visually-hidden">(${f._("UNKNOWN")})</span>`;
  let v;
...
function nr(t, e) {
  if (t?.querySelector("#contrast-tools")) {
    const { fontSize: s, fontWeight: r, type: i, isLargeText: a } = e, l = t.querySelector("#contrast"), d = t.querySelector("#contrast-preview"), p = t.querySelector("#fg-input"), o = t.querySelector("#bg-input"), c = t.querySelector("#value"), m = t.querySelector("#good"), g = (b, E) => {
      b.forEach((v) => {
      ...
      if (u.Global.contrastAlgorithm === "APCA") {
        const x = L.ratio;
        c.textContent = yn(x);
        const I = Ut(x).slice(1), S = x >= 45 && I[0] >= 0 && I[0] <= 777;
        let C;
        switch (i) {
          case "svg-error":
          case "svg-warning": {
            m.hidden = !S, C = S, g(h, C);
            break;
          }
          default: {
            const M = I[Math.floor(r / 100) - 1];
            C = v >= M, g(h, C), m.hidden = !C;
            break;
          }
        }
      }
      if (u.Global.contrastAlgorithm === "AA" || u.Global.contrastAlgorithm === "AAA") {
        const x = L.ratio;
        c.textContent = vn(x);
        const I = u.Global.contrastAlgorithm === "AAA", S = 3, C = I ? 7 : 4.5, M = I ? 4.5 : 3, _ = x >= S, k = v >= 24 || v >= 18.66 && r >= 700 || a, w = x >= C, R = x >= M;
        switch (i) {
          case "svg-error":
          case "svg-text":
          case "svg-warning": {
          ...
          default: {
            k ? (g([c, l], R), m.hidden = !R) : (g([c, l], w), m.hidden = !w);
            break;
          }
        }
      }
...
function sr(t) {
  let e;
  const { color: n, background: s, fontWeight: r, fontSize: i, isLargeText: a, type: l } = t;
  if (n && s && s.type !== "image" && (l === "text" || l === "svg-error" || l === "input")) {
    const d = u.Global.contrastAlgorithm === "APCA" ? Ji(n, s, r, i) : qi(
      n,
      s,
      a,
      u.Global.contrastAlgorithm
...
class ir extends HTMLElement {
  connectedCallback() {
    const e = this.attachShadow({ mode: "open" }), n = document.createElement("style");
    n.innerHTML = ar + gt, e.appendChild(n);
  }
}
const Ss = [];
function rr(t, e) {
  ...
  const g = {
    ...
    [m[1]]: f._("WARNING"),
    [m[2]]: f._("GOOD")
  }, A = e.dismissAnnotations && (s === "warning" || s === "good") && d ? `<button data-sa11y-dismiss='${l}' type='button'>${f._("DISMISS")}</button>` : "";
  if (n) {
    ...
    [s].forEach((C) => {
      y[C] && n.setAttribute(y[C], "");
    });
    const b = document.createElement("sa11y-annotation");
    if (b.setAttribute("data-sa11y-annotation", l), is()) {
      b.style.position = "absolute", b.style.positionAnchor = `--sa11y-anchor-${l}`, b.style.top = "anchor(top)", b.style.left = "anchor(left)";
      const C = n.style.anchorName;
      n.style.anchorName = C ? `${C}, --sa11y-anchor-${l}` : `--sa11y-anchor-${l}`;
    }
    const E = e.dismissAnnotations && e.dismissAll && typeof p == "string" && (s === "warning" || s === "good") ? `<button data-sa11y-dismiss='${l}' data-sa11y-dismiss-all type='button'>${f._("DISMISS_ALL")}</button>` : "", v = document.createElement("div");
    v.classList.add(i ? "annotation-inline" : "annotation");
    const L = document.createElement("button");
    L.type = "button", L.className = `${s}-btn`, L.setAttribute("aria-label", g[s]), L.setAttribute("aria-haspopup", "dialog"), L.style.margin = `${i ? "-10px" : ""} ${c}`, L.dataset.tippyContent = `<div lang='${f._("LANG_CODE")}' class='${s}'><button type='button' class='close-btn close-tooltip' aria-label='${f._("ALERT_CLOSE")}'></button><h2>${g[s]}</h2> ${r} ${o ? "<div data-sa11y-contrast-details></div>" : ""} <div class='dismiss-group'>${A}${E}</div></div>`, v.appendChild(L), Ss.push(L);
    const h = e.insertAnnotationBefore ? `, ${e.insertAnnotationBefore}` : "";
    (n.closest(`a, button, [role="link"], [role="button"] ${h}`) || n).insertAdjacentElement(a, b), b.shadowRoot.appendChild(v);
    const I = e.ignoreHiddenOverflow ? e.ignoreHiddenOverflow.split(",").flatMap((C) => [...document.querySelectorAll(C)]) : [], S = ft(n, "overflow", "hidden");
    S && !I.includes(S) && S.setAttribute("data-sa11y-overflow", "");
  } else {
    const y = document.createElement("li");
    y.innerHTML = `<h3>${g[s]}</h3> ${r}${A}`, u.Panel.pageIssuesList.insertAdjacentElement("afterbegin", y), u.Panel.pageIssues.classList.add("active"), u.Panel.panel.classList.add("has-page-issues");
  }
}
class Xn extends HTMLElement {
  connectedCallback() {
    const e = this.attachShadow({ mode: "open" }), n = document.createElement("style");
    n.innerHTML = Is + gt, e.appendChild(n);
    const s = ye(Ss, {
      interactive: !0,
      ...
      onTrigger(r, i) {
        i.type === "click" && setTimeout(() => {
          r.popper.querySelector(".close-btn").focus(), Vs(r.popper);
        }, 0);
      },
      onHide(r) {
...
class Jn extends HTMLElement {
  connectedCallback() {
    ...
    s.innerHTML = Is + gt, n.appendChild(s);
...
const cr = () => {
  ...
  const e = t.getRootNode().host, n = ft(e, "display", "none");
  if (n !== null) {
  ...
  if (t.offsetTop === 0) {
    const s = t.getRootNode().host, r = ft(s, "display", "none"), i = parseInt(s.getAttribute("data-sa11y-annotation"), 10), a = e.find((p) => p.id === i), l = ns(a);
    dr(t);
...
const ws = () => {
  ...
  ae >= e.length - 1 && (ae = -1);
  const s = e[ae + 1].shadowRoot.querySelector("button"), r = ks(s, t);
  window.scrollTo({
    top: r,
    behavior: `${u.Global.scrollBehaviour}`
  }), s.offsetTop !== 0 && (s.focus(), s.click()), ae += 1;
}, pr = (t) => {
  ws();
  const e = D.Annotations.Array;
  ae <= 0 && (ae = e.length);
  const n = D.Annotations.Array[ae - 1].shadowRoot.querySelector("button"), s = ks(n, t);
  window.scrollTo({
    top: s,
    behavior: `${u.Global.scrollBehaviour}`
  }), n.offsetTop !== 0 && (n.focus(), n.click()), ae -= 1, ae === -1 && (ae = D.Annotations.Array.length - 1);
};
function ur(t, e) {
  D.Annotations.Array.length && !u.Panel.skipButton.hasAttribute("disabled") && (t.altKey && (t.code === "KeyS" || t.code === "Period") ? (t.preventDefault(), Cs(e)) : t.altKey && (t.code === "KeyW" || t.code === "Comma") && (t.preventDefault(), pr(e)));
}
let on, ln;
function fr(t) {
  on = (e) => {
    ...
    Cs(t);
  }, document.addEventListener("keydown", on), u.Panel.skipButton.addEventListener("click", ln);
}
function hr() {
  document.removeEventListener("keydown", on), u.Panel.skipButton.removeEventListener("click", ln);
}
function gr(t, e) {
  const n = (s) => {
    const r = [
    ...
    r.forEach((d) => {
      if (s.toLowerCase().indexOf(d.toLowerCase()) !== -1)
        i[0] = d;
      else {
        const p = /\b\d{2,6}\s*x\s*\d{2,6}\b/, o = s.toLowerCase().match(p);
        o && ([i[0]] = o);
      }
    }), (e.susAltStopWords ? e.susAltStopWords.split(",").map((d) => d.trim()) : f._("SUS_ALT_STOPWORDS")).forEach((d) => {
      const p = s.toLowerCase().indexOf(d);
      p > -1 && p < 6 && (i[1] = d);
    }), f._("PLACEHOLDER_ALT_STOPWORDS").forEach((d) => {
      s.length === d.length && s.toLowerCase().indexOf(d) >= 0 && (i[2] = d);
    });
    const { extraPlaceholderStopWords: l } = e;
    return l.length && l.split(",").map((p) => p.trim()).forEach((p) => {
      const o = s.toLowerCase().indexOf(p);
      o > -1 && o < 6 && (i[2] = p);
    }), i;
  };
  return D.Found.Images.forEach((s) => {
    const r = Ne(s) === "noAria" ? s.getAttribute("alt") : Ne(s), i = s.closest(
      e.imageWithinLightbox ? `a[href]:not(${e.imageWithinLightbox})` : "a[href]"
    ), a = s.getAttribute("src") ? s.getAttribute("src") : s.getAttribute("srcset"), l = i ? je(i, u.Exclusions.LinkSpan).textContent : "", d = Array.isArray(e.linkIgnoreStrings) ? e.linkIgnoreStrings.reduce(
      (o, c) => o.replace(c, ""),
      l
    ) : l, p = i ? fe(d).length : 0;
    if (!(s.height < 2 && s.width < 2 && (Re(s) || r === ""))) {
      ...
      if (r === null)
        ...
        const o = Y(r), c = fe(o), m = n(c), g = s.getAttribute("aria-label") || s.getAttribute("aria-labelledby"), A = s.getAttribute("title"), y = r === "", b = s.closest("figure"), E = b?.querySelector("figcaption"), v = E ? E.textContent.trim() : "", L = e.checks.LINK_IMAGE_LONG_ALT.maxLength || 250, h = e.checks.IMAGE_ALT_TOO_LONG.maxLength || 250;
        ...
        const x = e.altPlaceholder?.some(
          (_) => r.toLowerCase().startsWith(_.toLowerCase())
        );
        if (y || x) {
          const _ = e.checks.IMAGE_DECORATIVE_CAROUSEL.sources, k = _ ? s.closest(_) : "";
          if (k) {
            const w = k.querySelectorAll("img"), R = w.length === 1 ? e.checks.IMAGE_DECORATIVE : e.checks.IMAGE_DECORATIVE_CAROUSEL, G = w.length === 1 ? "IMAGE_DECORATIVE" : "IMAGE_DECORATIVE_CAROUSEL";
            R && t.push({
              test: G,
              element: s,
              type: R.type || "warning",
            ...
            const w = p === 0 ? e.checks.LINK_IMAGE_NO_ALT_TEXT : e.checks.LINK_IMAGE_TEXT, R = p === 0 ? "LINK_IMAGE_NO_ALT_TEXT" : "LINK_IMAGE_TEXT";
            w && t.push({
              test: R,
              element: s,
              type: w.type || (p === 0 ? "error" : "good"),
              content: f.sprintf(w.content || R),
              dismiss: N(`${R + a + p}`),
              dismissAll: w.dismissAll ? R : !1,
              developer: w.developer || !1
            });
          } else if (b) {
            const w = E && v.length ? e.checks.IMAGE_FIGURE_DECORATIVE : e.checks.IMAGE_DECORATIVE, R = E && v.length ? "IMAGE_FIGURE_DECORATIVE" : "IMAGE_DECORATIVE";
            w && t.push({
              test: R,
              element: s,
              type: w.type || "warning",
        ...
        const I = i ? e.checks.LINK_ALT_UNPRONOUNCEABLE : e.checks.ALT_UNPRONOUNCEABLE;
        if (I && r.replace(/"|'|\?|\.|-|\s+/g, "") === "" && p === 0) {
          const _ = i ? "LINK_ALT_UNPRONOUNCEABLE" : "ALT_UNPRONOUNCEABLE";
          t.push({
            test: _,
            element: s,
            type: I.type || "error",
            content: f.sprintf(I.content || _, c),
        ...
        const S = i ? e.checks.LINK_ALT_MAYBE_BAD : e.checks.ALT_MAYBE_BAD, C = new RegExp(`^\\S{${S.minLength || 15},}$`), M = /[^\p{L}\-,.!?]/u.test(r);
        if (m[0] !== null) {
          const _ = i ? e.checks.LINK_ALT_FILE_EXT : e.checks.ALT_FILE_EXT, k = i ? "LINK_ALT_FILE_EXT" : "ALT_FILE_EXT";
          _ && t.push({
            test: k,
            element: s,
            type: _.type || "error",
            content: f.sprintf(_.content || k, m[0], c),
            dismiss: N(`${k + a + c}`),
            dismissAll: _.dismissAll ? k : !1,
            developer: _.developer || !1
          });
        } else if (m[2] !== null) {
          const _ = i ? e.checks.LINK_PLACEHOLDER_ALT : e.checks.ALT_PLACEHOLDER, k = i ? "LINK_PLACEHOLDER_ALT" : "ALT_PLACEHOLDER";
          _ && t.push({
            test: k,
            element: s,
            type: _.type || "error",
            content: f.sprintf(_.content || k, c),
            dismiss: N(`${k + a + c}`),
            dismissAll: _.dismissAll ? k : !1,
            developer: _.developer || !1
          });
        } else if (m[1] !== null) {
          const _ = i ? e.checks.LINK_SUS_ALT : e.checks.SUS_ALT, k = i ? "LINK_SUS_ALT" : "SUS_ALT";
          _ && t.push({
            test: k,
            element: s,
            type: _.type || "warning",
            content: f.sprintf(_.content || k, m[1], c),
            dismiss: N(`${k + a + c}`),
            dismissAll: _.dismissAll ? k : !1,
            developer: _.developer || !1
          });
        } else if (S && C.test(r) && M) {
          const _ = i ? "LINK_ALT_MAYBE_BAD" : "ALT_MAYBE_BAD";
          t.push({
            test: _,
            element: s,
            type: S.type || "warning",
            content: f.sprintf(S.content || _, c),
            dismiss: N(`${_ + a + c}`),
            dismissAll: S.dismissAll ? _ : !1,
            developer: S.developer || !1
          });
        } else if (i ? r.length > L : r.length > h) {
          const _ = i ? e.checks.LINK_IMAGE_LONG_ALT : e.checks.IMAGE_ALT_TOO_LONG, k = i ? "LINK_IMAGE_LONG_ALT" : "IMAGE_ALT_TOO_LONG", w = xe(c, 600);
          _ && t.push({
            test: k,
            element: s,
            type: _.type || "warning",
            content: f.sprintf(_.content || k, r.length, w),
            dismiss: N(`${k + a + c}`),
            dismissAll: _.dismissAll ? k : !1,
            developer: _.developer || !1
          });
        } else if (i) {
          const _ = p === 0 ? e.checks.LINK_IMAGE_ALT : e.checks.LINK_IMAGE_ALT_AND_TEXT, k = p === 0 ? "LINK_IMAGE_ALT" : "LINK_IMAGE_ALT_AND_TEXT";
          if (_) {
            const w = ve(i), R = fe(w), G = Y(R), K = p === 0 ? f.sprintf("LINK_IMAGE_ALT", c) : `${f.sprintf("LINK_IMAGE_ALT_AND_TEXT", c, G)} ${f.sprintf("ACC_NAME_TIP")}`;
            t.push({
              test: k,
              element: s,
              type: _.type || "warning",
              content: _.content ? f.sprintf(_.content, c, G) : K,
              dismiss: N(`${k + a + c}`),
              dismissAll: _.dismissAll ? k : !1,
              developer: _.developer || !1
            });
        ...
        }) : e.checks.IMAGE_PASS && (s.closest('button, [role="button"]') || t.push({
          test: "IMAGE_PASS",
          element: s,
          type: e.checks.IMAGE_PASS.type || "good",
          content: f.sprintf(e.checks.IMAGE_PASS.content || "IMAGE_PASS", c),
...
function mr(t, e, n) {
  let s, r = "";
  return D.Found.Headings.forEach((i, a) => {
    const l = ve(i, u.Exclusions.HeaderSpan), d = e.headerIgnoreStrings ? l.replace(e.headerIgnoreStrings, "") : l, p = fe(d), o = Y(p), c = u.Root.areaToCheck.some((C) => C.contains(i)), m = u.Root.areaToCheck.some(
      (C) => C.contains(i.getRootNode().host)
    ), g = c || m, A = D.Found.HeadingOverrideStart.get(i);
    A && (s = A);
    const y = parseInt(i.getAttribute("aria-level") || i.tagName.slice(1), 10), b = p.length, E = e.checks.HEADING_LONG.maxLength || 160;
    let v = null, L = null, h = null, x = null, I = null, S = null;
    if (b === 0)
      if (i.querySelectorAll("img").length) {
        const C = i.querySelector("img")?.getAttribute("alt");
        i.querySelector("img") && (!C || C.trim() === "") && e.checks.HEADING_EMPTY_WITH_IMAGE && (v = "HEADING_EMPTY_WITH_IMAGE", L = e.checks.HEADING_EMPTY_WITH_IMAGE.type || "error", h = f.sprintf(
          e.checks.HEADING_EMPTY_WITH_IMAGE.content || "HEADING_EMPTY_WITH_IMAGE",
          y
        ), x = e.checks.HEADING_EMPTY_WITH_IMAGE.developer || !1, I = e.checks.HEADING_EMPTY_WITH_IMAGE.dismissAll ? "HEADING_EMPTY_WITH_IMAGE" : !1, S = "-15px 30px");
      } else e.checks.HEADING_EMPTY && (v = "HEADING_EMPTY", L = e.checks.HEADING_EMPTY.type || "error", h = f.sprintf(e.checks.HEADING_EMPTY.content || "HEADING_EMPTY", y), x = e.checks.HEADING_EMPTY.developer || !1, I = e.checks.HEADING_EMPTY.dismissAll ? "HEADING_EMPTY" : !1, S = "0");
    else y - s > 1 && a !== 0 ? e.checks.HEADING_SKIPPED_LEVEL && (v = "HEADING_SKIPPED_LEVEL", L = e.checks.HEADING_SKIPPED_LEVEL.type || "error", h = f.sprintf(
    ...
    h && L && t.push({
      ...
      developer: x,
      margin: S
    }), s = y, r = o, D.Found.OutlineIgnore.includes(i) || n.push({
      element: i,
      headingLevel: y,
      text: o,
      type: L,
  ...
  }), e.checks.HEADING_MISSING_ONE && D.Found.HeadingOne.length === 0 && t.push({
...
function Ar(t, e) {
  const n = e.linkStopWords ? [
    ...
    return l[0] = s(a, n), f._("CLICK").forEach((o) => {
  ...
  return D.Found.Links.forEach((a) => {
    const l = Qs(a), d = fe(
      ve(a, u.Exclusions.LinkSpan)
    ), p = Array.isArray(e.linkIgnoreStrings) ? e.linkIgnoreStrings.reduce((G, K) => G.replace(K, ""), d) : d, o = Kt(p), c = r(o), m = /[^a-zA-Z0-9]/g, g = p.length === 1 && m.test(p), A = /([<>↣↳←→↓«»↴]+)/, y = p.match(A), b = y ? y[1] : null, E = a.getAttribute("title"), v = a.getAttribute("aria-hidden") === "true", L = a.getAttribute("tabindex") === "-1", h = a.querySelector(":scope [aria-labelledby], :scope [aria-label]") || a.getAttribute("aria-labelledby") || a.getAttribute("aria-label"), x = a.querySelector(":scope [aria-labelledby]") || a.getAttribute("aria-labelledby"), I = f._("NEW_WINDOW_PHRASES").some(
      (G) => d.toLowerCase().includes(G)
    ), S = f._("CLICK").some((G) => new RegExp(`\\b${G}\\b`, "i").test(a.textContent)), _ = [
      "pdf",
      "doc",
      "docx",
      "word",
    ...
    ), w = p.replace(/'|"|-|\.|\s+/g, "").toLowerCase(), R = a.textContent.trim().toLowerCase();
    if (!a.querySelectorAll("img").length) {
      ...
      if (e.linkIgnoreStrings && e.linkIgnoreStrings.forEach((H) => {
        ...
        const H = Y(p), F = je(a, u.Exclusions.LinkSpan), Q = e.linkIgnoreStrings ? V(F).replace(e.linkIgnoreStrings, "") : V(F), te = Kt(Q), le = s(te, n), ne = ss(
          a,
          d,
      ...
      (c[1] !== null || S) && e.checks.LINK_CLICK_HERE && t.push({
        ...
        content: f.sprintf(e.checks.DUPLICATE_TITLE.content || "DUPLICATE_TITLE"),
        inline: !0,
        dismiss: N(`LINKDUPLICATETITLE${l + w}`),
        dismissAll: e.checks.DUPLICATE_TITLE.dismissAll ? "DUPLICATE_TITLE" : !1,
        developer: e.checks.DUPLICATE_TITLE.developer || !1
      });
    }
    if (e.linksAdvancedPlugin && w.length !== 0) {
      if (i[w] && !i[l]) {
...
function br(t, e) {
  const n = [];
  for (let i = 0; i < D.Found.Contrast.length; i++) {
    const a = D.Found.Contrast[i], l = getComputedStyle(a), d = parseFloat(l.opacity), p = de(l.color, d), o = parseFloat(l.fontSize), c = l.fontWeight, m = jn(c), g = Pt(a, u.Global.shadowDetection), A = Fs(a), b = Re(a) || A || d === 0 || o === 0, v = Array.from(a.childNodes).filter((h) => h.nodeType === 3).map((h) => h.textContent).join("").trim(), L = ["SELECT", "INPUT", "TEXTAREA"].includes(a.tagName);
    if (v.length !== 0 || L) {
      ...
      if (p === "unsupported" || g === "unsupported")
        ...
        x && (x.type = L ? "input" : "text", n.push(x));
      }
    }
  }
  return D.Found.Svg.forEach((i) => {
    ...
    if ((p.length === 1 || c) && o.length === 0) {
      ...
      const h = Math.min(v, L) < 50 ? 1 : 3, x = A && E >= h && A !== "none", I = g && g !== "none" && !g.startsWith("url("), S = de(g === "currentColor" ? getComputedStyle(p[0]).color : g, b), C = de(A === "currentColor" ? getComputedStyle(p[0]).color : A, b);
      if (![S, C].includes("unsupported") && d) {
        let _, k = !1, w = !1;
        if (I && (_ = ut(
          S,
          l,
          e.contrastAlgorithm
        ), k = e.contrastAlgorithm === "APCA" ? _.ratio >= 45 : _.ratio >= 3), x && (_ = ut(
          C,
          l,
          e.contrastAlgorithm
        ), w = e.contrastAlgorithm === "APCA" ? _.ratio >= 45 : _.ratio >= 3), I && x && !k && !w || I && !x && !k || !I && x && !w) {
          const W = q(l), H = q(S), F = q(C);
          if (H === W && !x || F === W && !I)
            return;
          n.push({
            $el: i,
            ratio: ji(_.ratio, e.contrastAlgorithm),
            color: _.blendedColor,
            type: "svg-error",
            isLargeText: !0,
        ...
        I && S !== "unsupported" ? a.color = S : x && C !== "unsupported" && (a.color = C), d && (a.background = l), n.push(a);
    } else
      d && (a.background = l), n.push(a);
  }), D.Found.Inputs.forEach((i) => {
    if (i.placeholder && i.placeholder.length !== 0) {
      const a = getComputedStyle(i, "::placeholder"), l = de(a.getPropertyValue("color")), d = parseFloat(a.fontSize), p = jn(a.fontWeight), o = Pt(i, u.Global.shadowDetection), c = parseFloat(a.opacity);
      if (l === "unsupported")
        n.push({ $el: i, type: "placeholder-unsupported" });
...
function Er(t, e) {
  return e.formLabelsPlugin && D.Found.Inputs.forEach((n) => {
    const s = n.getAttribute("aria-hidden") === "true", r = n.getAttribute("tabindex") === "-1";
    if (Re(n) || s && r)
      return;
    const a = ve(n), l = fe(a), d = n.getAttribute("alt"), p = n.getAttribute("type"), o = n.getAttribute("title"), c = n.placeholder && n.placeholder !== 0, m = n.getAttribute("aria-label") || n.getAttribute("aria-labelledby");
    ...
    const g = n.closest("label"), A = g ? fe(ve(g)) : "";
    if (g && A.length)
      return;
    const y = n.getAttribute("id");
    y ? D.Found.Labels.some((b) => b.getAttribute("for") === y) || e.checks.LABELS_NO_FOR_ATTRIBUTE && t.push({
...
function yr(t, e) {
  const n = [], s = [".", "?", "!"];
  t.forEach((i) => {
    const a = i[i.length - 1], l = s.includes(a) ? i : `${i}.`;
    n.push(l);
  });
  const r = n.join(" ");
  if (r.length === 0)
...
function vr(t) {
  const e = D.Found.Readability.map(
    (r) => V(je(r))
  ).filter(Boolean), n = yr(e, u.Readability.Lang);
  let s;
  return n && (s = {
    test: "READABILITY",
...
function Lr(t, e) {
  ...
  return e.checks.EMBED_AUDIO && D.Found.Audio.forEach((s) => {
    t.push({
      test: "EMBED_AUDIO",
      element: s,
  ...
  }), e.checks.EMBED_VIDEO && D.Found.Videos.forEach((s) => {
    const r = s.querySelector("track"), i = r?.getAttribute("src");
  ...
  }), e.checks.EMBED_DATA_VIZ && D.Found.Visualizations.forEach((s) => {
    t.push({
      test: "EMBED_DATA_VIZ",
      element: s,
  ...
  }), D.Found.iframes.forEach((s) => {
    const r = ["presentation", "none"].includes(s.getAttribute("role")), i = Re(s), a = s.tagName === "VIDEO" || s.tagName === "AUDIO", l = s.getAttribute("aria-hidden") === "true", d = s.getAttribute("tabindex") === "-1";
    if (!(i || a || l && d || r)) {
      if (d) {
      ...
      if (e.checks.EMBED_MISSING_TITLE) {
        const p = Ne(s), o = p === "noAria" ? s.getAttribute("title") || "" : p;
  ...
  }), e.checks.EMBED_GENERAL && D.Found.EmbeddedContent.forEach((s) => {
    const r = ["presentation", "none"].includes(s.getAttribute("role")), i = s.getAttribute("aria-hidden") === "true", a = s.getAttribute("tabindex") === "-1";
    Re(s) || i && a || r || s.tagName === "VIDEO" || s.tagName === "AUDIO" || t.push({
      test: "EMBED_GENERAL",
      element: s,
...
function Tr(t, e) {
  if (e.checks.QA_BAD_LINK && D.Found.CustomErrorLinks.forEach((a) => {
    t.push({
      test: "QA_BAD_LINK",
      element: a,
  ...
  }), e.checks.QA_STRONG_ITALICS && D.Found.StrongItalics.forEach((a) => {
    const l = V(a);
  ...
  }), e.checks.QA_BLOCKQUOTE && D.Found.Blockquotes.forEach((a) => {
    const l = V(a);
  ...
  if (e.checks.QA_FAKE_LIST) {
    ...
    let g = "", A = "", y = !1;
    D.Found.Paragraphs.forEach((b, E) => {
      let v = !1, L = !1;
      A = A || V(b).replace("(", "");
      const h = A.substring(0, 2), x = h.match(l), I = h.match(a), S = h.match(d), C = o.test(h.charAt(0));
      if (h.length > 0 && h !== g && !I && (x || S || C)) {
        const M = D.Found.Paragraphs[E + 1];
        if (M) {
          if (v = V(M).replace("(", "").substring(0, 2), p.includes(v?.toLowerCase().trim()))
            return;
          const _ = m(v);
          x ? h !== "A " && h === _ && (L = !0) : S && !y && _.match(d) && (L = !0, y = !0);
        }
        if (!L) {
          let _ = b?.querySelector("br")?.nextSibling?.nodeValue;
          _ && (_ = _.replace(/<\/?[^>]+(>|$)/g, "").trim().substring(0, 2), (o.test(_.charAt(0)) || h === m(_) || !y && _.match(d)) && (L = !0));
        }
        L ? (t.push({
          test: "QA_FAKE_LIST",
          element: b,
  ...
  if (e.checks.QA_UPPERCASE) {
    ...
    D.Found.Paragraphs.forEach((l) => {
      a(l);
    }), D.Found.Headings.forEach((l) => {
      a(l);
    }), D.Found.Lists.forEach((l) => {
      a(l);
    }), D.Found.Blockquotes.forEach((l) => {
      a(l);
    });
  }
  const n = (a) => {
    ...
    e.checks.QA_UNDERLINE && (a.closest("u") || d === "underline") && !a.closest(c) && !a.matches(c) && n(a);
    ...
    e.checks.QA_JUSTIFY && p === "justify" && !v && s(a);
  };
  if (e.checks.QA_UNDERLINE || e.checks.QA_JUSTIFY || e.checks.QA_SMALL_TEXT)
    for (let a = 0; a < D.Found.Everything.length; a++) {
      const l = D.Found.Everything[a];
      Array.from(l.childNodes).filter((o) => o.nodeType === 3).map((o) => o.textContent).join("").trim().length !== 0 && i(l);
    }
  return e.checks.QA_SUBSCRIPT && D.Found.Subscripts.forEach((a) => {
    const l = V(a);
    l.length >= 80 && t.push({
      test: "QA_SUBSCRIPT",
      element: a,
  ...
  }), e.checks.QA_NESTED_COMPONENTS && D.Found.NestedComponents.forEach((a) => {
...
function Ir(t, e) {
  if (e.checks.META_LANG && (!D.Found.Language || D.Found.Language.length < 2) && t.push({
    test: "META_LANG",
  ...
  return e.checks.META_REFRESH && document.querySelector('meta[http-equiv="refresh"]') && t.push({
    ...
    i(a, s);
  }), (e.checks.BTN_EMPTY || e.checks.BTN_EMPTY_LABELLEDBY || e.checks.BTN_LABEL || e.checks.HIDDEN_FOCUSABLE || e.checks.LABEL_IN_NAME) && D.Found.Buttons.forEach((n) => {
    const s = ve(n), r = s.replace(/'|"|-|\.|\s+/g, "").toLowerCase(), i = N(`BTN${n.tagName + n.id + n.className + s}`), a = n.querySelector(":scope [aria-labelledby], :scope [aria-label]") || n.getAttribute("aria-labelledby") || n.getAttribute("aria-label"), l = n.querySelector(":scope [aria-labelledby]") || n.getAttribute("aria-labelledby"), d = n.getAttribute("aria-hidden") === "true", p = n.getAttribute("tabindex") === "-1";
    if (d) {
  ...
  }), e.checks.UNCONTAINED_LI && D.Found.Lists.forEach((n) => {
  ...
  }), e.checks.TABINDEX_ATTR && D.Found.TabIndex.forEach((n) => {
    t.push({
      test: "TABINDEX_ATTR",
      element: n,
...
class _r {
  constructor(e) {
    ...
    this.initialize = () => {
      ...
      })() || (customElements.define("sa11y-heading-label", lr), customElements.define("sa11y-heading-anchor", or), customElements.define("sa11y-annotation", ir), customElements.define("sa11y-tooltips", Xn), customElements.define("sa11y-panel-tooltips", Jn), customElements.define("sa11y-control-panel", xn), customElements.define("sa11y-console-error", _n), u.initializeGlobal(n), u.initializeReadability(n), u.initializeExclusions(n), n.developerChecksOnByDefault && (P.getItem("sa11y-developer") === null || n.checkAllHideToggles) && P.setItem("sa11y-developer", "On"), Us(() => {
        if (n.headless)
          this.checkAll(), P.removeItem("sa11y-dismissed");
        else {
          const r = P.getItem("sa11y-position"), { panelPosition: i } = n;
          n.showMovePanelToggle && (!r || !r.includes("top") != !i.includes("top")) && P.setItem("sa11y-position", i);
          const a = new xn();
          document.body.appendChild(a), ua(this.checkAll, this.resetAll), fa(), na(), qs(n.detectSPArouting, this.checkAll, this.resetAll), this.panelTooltips = new Jn(), document.body.appendChild(this.panelTooltips), u.Panel.toggle.disabled = !1, setTimeout(() => {
            this.resetAll(), this.checkAll();
          }, n.delayCheck), n.delayCheck >= 700 && (u.Panel.toggle.disabled = !0), da(this.checkAll, this.resetAll);
        }
      }));
    }, this.checkAll = async (s = n.checkRoot, r = n.readabilityRoot, i = n.fixedRoots) => {
      try {
        this.results = [], this.headingOutline = [], this.errorCount = 0, this.warningCount = 0, this.customChecksRunning = !1, u.initializeRoot(s, r, i), Hs(n), D.initializeElements(n), mr(this.results, n, this.headingOutline), Ar(this.results, n), gr(this.results, n), Er(this.results, n), Tr(this.results, n), Ir(this.results, n), n.embeddedContentPlugin && Lr(this.results, n), n.contrastPlugin && br(this.results, n), n.readabilityPlugin && P.getItem("sa11y-readability") === "On" && vr(this.results), this.imageResults = D.Found.Images.map((a) => {
      ...
      if ((s || n.externalDeveloperChecks === !0) && (this.results = this.results.filter((i) => i.developer !== !0)), s && (this.results = this.results.filter((i) => i.external !== !0)), this.results.forEach((i, a) => {
        const l = n.selectorPath ? zs(i.element) : "", d = i.element?.outerHTML.replace(/\s{2,}/g, " ").trim() || "";
        ...
        if (ba(a.error, a.warning), P.getItem("sa11y-panel") === "Opened") {
          ...
          this.results.forEach((p) => {
            ...
            rr(o, n);
          }), D.initializeAnnotations();
          const d = new Xn();
          document.body.appendChild(d), ea(this.results, this.dismissed, this.checkAll, this.resetAll), ha(this.dismissedPageResults, this.headingOutline, n), n.showImageOutline && ma(this.dismissedPageResults, this.imageResults, n), Aa(i.dismissCount, a.error, a.warning), fr(this.results), n.exportResultsPlugin && la(this.results, i.dismissedResults), ht(u.Panel.pageIssuesList, u.Panel.pageIssuesContent);
        }
      ...
      for (u.Global.html.removeAttribute("data-sa11y-active"), es(
        [
          "sa11y-annotation",
          "sa11y-heading-label",
          "sa11y-heading-anchor",
        ...
        "document"
      ), is() && X("[data-sa11y-error], [data-sa11y-warning], [data-sa11y-good]", "document").forEach(
        (r) => {
    ...
    }, this.find = (s, r, i) => X(s, r, i), this.prepareDismissal = (s) => N(s), this.sanitizeHTML = (s) => Y(s), this.truncateString = (s, r) => xe(s, r), this.initialize();
  }
}
export {
  f as Lang,
